# Ethics and Responsible Use - seed/NextVersionPlan/Claude_V2
...
**In this directory (`seed/NextVersionPlan/Claude_V2`), the following ethical rules apply:**
...
Before committing work in `seed/NextVersionPlan/Claude_V2`:
