# Governance Policy - seed/NextVersionPlan/Claude_V2
...
2. **Parent Context** (`seed/NextVersionPlan/POLICY.md`)
...
This policy governs all work in `seed/NextVersionPlan/Claude_V2` and its subdirectories.
...
1. **Document**: Create incident report in `seed/NextVersionPlan/Claude_V2/.governance/incidents/`
