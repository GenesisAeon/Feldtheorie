# Ethics and Responsible Use - seed/NextVersionPlan
...
**In this directory (`seed/NextVersionPlan`), the following ethical rules apply:**
...
Before committing work in `seed/NextVersionPlan`:
