# Governance Policy - seed/NextVersionPlan
...
This policy governs all work in `seed/NextVersionPlan` and its subdirectories.
...
1. **Document**: Create incident report in `seed/NextVersionPlan/.governance/incidents/`
