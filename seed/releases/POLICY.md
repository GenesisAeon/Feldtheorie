# Governance Policy - seed/releases
...
This policy governs all work in `seed/releases` and its subdirectories.
...
1. **Document**: Create incident report in `seed/releases/.governance/incidents/`
