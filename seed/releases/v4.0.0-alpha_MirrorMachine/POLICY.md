# Governance Policy - seed/releases/v4.0.0-alpha_MirrorMachine
...
2. **Parent Context** (`seed/releases/POLICY.md`)
...
This policy governs all work in `seed/releases/v4.0.0-alpha_MirrorMachine` and its subdirectories.
...
1. **Document**: Create incident report in `seed/releases/v4.0.0-alpha_MirrorMachine/.governance/incidents/`
