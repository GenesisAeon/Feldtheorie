# Agents Charter - seed/releases/v4.0.0-alpha_MirrorMachine/simulation
...
**This directory (`seed/releases/v4.0.0-alpha_MirrorMachine/simulation`) is specialized for:**
...
1. Check the parent governance: `seed/releases/v4.0.0-alpha_MirrorMachine/AGENTS.md`
