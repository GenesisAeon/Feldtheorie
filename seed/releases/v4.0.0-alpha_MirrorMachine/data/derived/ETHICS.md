# Ethics and Responsible Use - seed/releases/v4.0.0-alpha_MirrorMachine/data/derived
...
**In this directory (`seed/releases/v4.0.0-alpha_MirrorMachine/data/derived`), the following ethical rules apply:**
...
Before committing work in `seed/releases/v4.0.0-alpha_MirrorMachine/data/derived`:
