# Agents Charter - seed/releases/v4.0.0-alpha_MirrorMachine/data/derived
...
**This directory (`seed/releases/v4.0.0-alpha_MirrorMachine/data/derived`) is specialized for:**
...
1. Check the parent governance: `seed/releases/v4.0.0-alpha_MirrorMachine/data/AGENTS.md`
