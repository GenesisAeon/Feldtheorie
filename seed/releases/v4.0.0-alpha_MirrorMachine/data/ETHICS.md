# Ethics and Responsible Use - seed/releases/v4.0.0-alpha_MirrorMachine/data
...
**In this directory (`seed/releases/v4.0.0-alpha_MirrorMachine/data`), the following ethical rules apply:**
...
Before committing work in `seed/releases/v4.0.0-alpha_MirrorMachine/data`:
