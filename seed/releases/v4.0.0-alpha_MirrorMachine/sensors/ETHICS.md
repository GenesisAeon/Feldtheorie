# Ethics and Responsible Use - seed/releases/v4.0.0-alpha_MirrorMachine/sensors
...
**In this directory (`seed/releases/v4.0.0-alpha_MirrorMachine/sensors`), the following ethical rules apply:**
...
Before committing work in `seed/releases/v4.0.0-alpha_MirrorMachine/sensors`:
