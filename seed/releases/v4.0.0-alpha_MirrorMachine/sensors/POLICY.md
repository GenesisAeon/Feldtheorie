# Governance Policy - seed/releases/v4.0.0-alpha_MirrorMachine/sensors
...
2. **Parent Context** (`seed/releases/v4.0.0-alpha_MirrorMachine/POLICY.md`)
...
This policy governs all work in `seed/releases/v4.0.0-alpha_MirrorMachine/sensors` and its subdirectories.
...
1. **Document**: Create incident report in `seed/releases/v4.0.0-alpha_MirrorMachine/sensors/.governance/incidents/`
