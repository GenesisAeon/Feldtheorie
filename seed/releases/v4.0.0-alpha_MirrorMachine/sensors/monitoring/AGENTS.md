# Agents Charter - seed/releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring
...
**This directory (`seed/releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring`) is specialized for:**
...
1. Check the parent governance: `seed/releases/v4.0.0-alpha_MirrorMachine/sensors/AGENTS.md`
