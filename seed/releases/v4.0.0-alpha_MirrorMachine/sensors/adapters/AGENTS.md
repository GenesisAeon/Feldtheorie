# Agents Charter - seed/releases/v4.0.0-alpha_MirrorMachine/sensors/adapters
...
**This directory (`seed/releases/v4.0.0-alpha_MirrorMachine/sensors/adapters`) is specialized for:**
