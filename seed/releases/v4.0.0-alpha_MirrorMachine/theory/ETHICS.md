# Ethics and Responsible Use - seed/releases/v4.0.0-alpha_MirrorMachine/theory
...
**In this directory (`seed/releases/v4.0.0-alpha_MirrorMachine/theory`), the following ethical rules apply:**
...
Before committing work in `seed/releases/v4.0.0-alpha_MirrorMachine/theory`:
