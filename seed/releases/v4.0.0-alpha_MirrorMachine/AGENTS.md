# Agents Charter - seed/releases/v4.0.0-alpha_MirrorMachine
...
**This directory (`seed/releases/v4.0.0-alpha_MirrorMachine`) is specialized for:**
...
1. Check the parent governance: `seed/releases/AGENTS.md`
