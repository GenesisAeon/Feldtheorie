...
This policy governs all work in `seed/ethics` and its subdirectories.
...
1. **Document**: Create incident report in `seed/ethics/.governance/incidents/`
