# Governance Policy - seed/shadow_sigillin/metaquest/wissenschaftsprojekt/lanterns
...
2. **Parent Context** (`seed/shadow_sigillin/metaquest/wissenschaftsprojekt/POLICY.md`)
...
This policy governs all work in `seed/shadow_sigillin/metaquest/wissenschaftsprojekt/lanterns` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/metaquest/wissenschaftsprojekt/lanterns/.governance/incidents/`
