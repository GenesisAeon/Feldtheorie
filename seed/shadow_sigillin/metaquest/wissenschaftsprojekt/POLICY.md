# Governance Policy - seed/shadow_sigillin/metaquest/wissenschaftsprojekt
...
2. **Parent Context** (`seed/shadow_sigillin/metaquest/POLICY.md`)
...
This policy governs all work in `seed/shadow_sigillin/metaquest/wissenschaftsprojekt` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/metaquest/wissenschaftsprojekt/.governance/incidents/`
