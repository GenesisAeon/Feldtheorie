# Governance Policy - seed/shadow_sigillin/metaquest
...
This policy governs all work in `seed/shadow_sigillin/metaquest` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/metaquest/.governance/incidents/`
