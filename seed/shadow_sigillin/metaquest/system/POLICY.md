# Governance Policy - seed/shadow_sigillin/metaquest/system
...
This policy governs all work in `seed/shadow_sigillin/metaquest/system` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/metaquest/system/.governance/incidents/`
