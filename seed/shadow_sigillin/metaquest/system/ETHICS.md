# Ethics and Responsible Use - seed/shadow_sigillin/metaquest/system
...
**In this directory (`seed/shadow_sigillin/metaquest/system`), the following ethical rules apply:**
...
Before committing work in `seed/shadow_sigillin/metaquest/system`:
