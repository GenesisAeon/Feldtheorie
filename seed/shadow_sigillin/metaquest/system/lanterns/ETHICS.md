# Ethics and Responsible Use - seed/shadow_sigillin/metaquest/system/lanterns
...
**In this directory (`seed/shadow_sigillin/metaquest/system/lanterns`), the following ethical rules apply:**
...
Before committing work in `seed/shadow_sigillin/metaquest/system/lanterns`:
