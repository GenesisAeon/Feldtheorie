# Governance Policy - seed/shadow_sigillin/metaquest/system/lanterns
...
2. **Parent Context** (`seed/shadow_sigillin/metaquest/system/POLICY.md`)
...
This policy governs all work in `seed/shadow_sigillin/metaquest/system/lanterns` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/metaquest/system/lanterns/.governance/incidents/`
