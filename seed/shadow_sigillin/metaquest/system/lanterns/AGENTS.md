# Agents Charter - seed/shadow_sigillin/metaquest/system/lanterns
...
**This directory (`seed/shadow_sigillin/metaquest/system/lanterns`) is specialized for:**
...
1. Check the parent governance: `seed/shadow_sigillin/metaquest/system/AGENTS.md`
