# Governance Policy - seed/shadow_sigillin/v3
...
This policy governs all work in `seed/shadow_sigillin/v3` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/v3/.governance/incidents/`
