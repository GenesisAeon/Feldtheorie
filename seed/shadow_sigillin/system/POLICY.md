# Governance Policy - seed/shadow_sigillin/system
...
This policy governs all work in `seed/shadow_sigillin/system` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/system/.governance/incidents/`
