# Governance Policy - seed/shadow_sigillin/system/metaquest
...
2. **Parent Context** (`seed/shadow_sigillin/system/POLICY.md`)
...
This policy governs all work in `seed/shadow_sigillin/system/metaquest` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/system/metaquest/.governance/incidents/`
