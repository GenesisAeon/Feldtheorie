# Ethics and Responsible Use - seed/shadow_sigillin/system/metaquest
...
**In this directory (`seed/shadow_sigillin/system/metaquest`), the following ethical rules apply:**
...
Before committing work in `seed/shadow_sigillin/system/metaquest`:
