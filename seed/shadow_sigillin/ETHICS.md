# Ethics and Responsible Use - seed/shadow_sigillin
...
**In this directory (`seed/shadow_sigillin`), the following ethical rules apply:**
...
Before committing work in `seed/shadow_sigillin`:
