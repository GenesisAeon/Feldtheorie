# Agents Charter - seed/shadow_sigillin/wissenschaftsprojekt
...
**This directory (`seed/shadow_sigillin/wissenschaftsprojekt`) is specialized for:**
...
1. Check the parent governance: `seed/shadow_sigillin/AGENTS.md`
