# Governance Policy - seed/shadow_sigillin/wissenschaftsprojekt
...
2. **Parent Context** (`seed/shadow_sigillin/POLICY.md`)
...
This policy governs all work in `seed/shadow_sigillin/wissenschaftsprojekt` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/wissenschaftsprojekt/.governance/incidents/`
