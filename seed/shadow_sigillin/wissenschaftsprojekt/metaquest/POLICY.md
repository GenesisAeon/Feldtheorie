# Governance Policy - seed/shadow_sigillin/wissenschaftsprojekt/metaquest
...
2. **Parent Context** (`seed/shadow_sigillin/wissenschaftsprojekt/POLICY.md`)
...
This policy governs all work in `seed/shadow_sigillin/wissenschaftsprojekt/metaquest` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/wissenschaftsprojekt/metaquest/.governance/incidents/`
