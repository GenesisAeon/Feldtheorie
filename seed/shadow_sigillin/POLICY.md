# Governance Policy - seed/shadow_sigillin
...
This policy governs all work in `seed/shadow_sigillin` and its subdirectories.
...
1. **Document**: Create incident report in `seed/shadow_sigillin/.governance/incidents/`
