# Ethics and Responsible Use - seed/validation
...
**In this directory (`seed/validation`), the following ethical rules apply:**
...
Before committing work in `seed/validation`:
