# Governance Policy - seed/validation
...
This policy governs all work in `seed/validation` and its subdirectories.
...
1. **Document**: Create incident report in `seed/validation/.governance/incidents/`
