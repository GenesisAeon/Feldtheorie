# Governance Policy - seed/arxiv_submission
...
This policy governs all work in `seed/arxiv_submission` and its subdirectories.
...
1. **Document**: Create incident report in `seed/arxiv_submission/.governance/incidents/`
