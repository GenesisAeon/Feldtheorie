# Ethics and Responsible Use - seed/arxiv_submission
...
**In this directory (`seed/arxiv_submission`), the following ethical rules apply:**
...
Before committing work in `seed/arxiv_submission`:
