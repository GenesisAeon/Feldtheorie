# Ethics and Responsible Use - seed/bedeutungssigillin
...
**In this directory (`seed/bedeutungssigillin`), the following ethical rules apply:**
...
Before committing work in `seed/bedeutungssigillin`:
