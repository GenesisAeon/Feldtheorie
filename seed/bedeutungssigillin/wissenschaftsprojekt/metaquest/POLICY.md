# Governance Policy - seed/bedeutungssigillin/wissenschaftsprojekt/metaquest
...
2. **Parent Context** (`seed/bedeutungssigillin/wissenschaftsprojekt/POLICY.md`)
...
This policy governs all work in `seed/bedeutungssigillin/wissenschaftsprojekt/metaquest` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/wissenschaftsprojekt/metaquest/.governance/incidents/`
