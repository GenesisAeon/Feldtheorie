# Governance Policy - seed/bedeutungssigillin/wissenschaftsprojekt/metaquest/lanterns
...
2. **Parent Context** (`seed/bedeutungssigillin/wissenschaftsprojekt/metaquest/POLICY.md`)
...
This policy governs all work in `seed/bedeutungssigillin/wissenschaftsprojekt/metaquest/lanterns` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/wissenschaftsprojekt/metaquest/lanterns/.governance/incidents/`
...
<<<<<<< HEAD
- 2026-06-17 07:12:20 UTC: Initial governance deployment (v1.0.0)
=======
- 2026-06-17 07:00:00 UTC: Initial governance deployment (v1.0.0)
>>>>>>> origin/main
