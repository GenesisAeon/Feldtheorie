# Governance Policy - seed/bedeutungssigillin/wissenschaftsprojekt
...
2. **Parent Context** (`seed/bedeutungssigillin/POLICY.md`)
...
This policy governs all work in `seed/bedeutungssigillin/wissenschaftsprojekt` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/wissenschaftsprojekt/.governance/incidents/`
