# Governance Policy - seed/bedeutungssigillin
...
This policy governs all work in `seed/bedeutungssigillin` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/.governance/incidents/`
