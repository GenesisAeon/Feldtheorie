# Ethics and Responsible Use - seed/bedeutungssigillin/metaquest
...
**In this directory (`seed/bedeutungssigillin/metaquest`), the following ethical rules apply:**
...
Before committing work in `seed/bedeutungssigillin/metaquest`:
