# Governance Policy - seed/bedeutungssigillin/metaquest/wissenschaftsprojekt
...
2. **Parent Context** (`seed/bedeutungssigillin/metaquest/POLICY.md`)
...
This policy governs all work in `seed/bedeutungssigillin/metaquest/wissenschaftsprojekt` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/metaquest/wissenschaftsprojekt/.governance/incidents/`
