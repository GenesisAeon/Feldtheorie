# Governance Policy - seed/bedeutungssigillin/metaquest
...
This policy governs all work in `seed/bedeutungssigillin/metaquest` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/metaquest/.governance/incidents/`
