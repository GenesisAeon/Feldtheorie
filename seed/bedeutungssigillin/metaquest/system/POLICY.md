# Governance Policy - seed/bedeutungssigillin/metaquest/system
...
This policy governs all work in `seed/bedeutungssigillin/metaquest/system` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/metaquest/system/.governance/incidents/`
