# Ethics and Responsible Use - seed/bedeutungssigillin/metaquest/system
...
**In this directory (`seed/bedeutungssigillin/metaquest/system`), the following ethical rules apply:**
...
Before committing work in `seed/bedeutungssigillin/metaquest/system`:
