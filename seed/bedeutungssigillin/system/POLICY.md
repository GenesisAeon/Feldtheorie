# Governance Policy - seed/bedeutungssigillin/system
...
This policy governs all work in `seed/bedeutungssigillin/system` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/system/.governance/incidents/`
