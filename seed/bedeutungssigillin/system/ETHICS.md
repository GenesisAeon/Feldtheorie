# Ethics and Responsible Use - seed/bedeutungssigillin/system
...
**In this directory (`seed/bedeutungssigillin/system`), the following ethical rules apply:**
...
Before committing work in `seed/bedeutungssigillin/system`:
