# Governance Policy - seed/bedeutungssigillin/system/metaquest
...
2. **Parent Context** (`seed/bedeutungssigillin/system/POLICY.md`)
...
This policy governs all work in `seed/bedeutungssigillin/system/metaquest` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/system/metaquest/.governance/incidents/`
