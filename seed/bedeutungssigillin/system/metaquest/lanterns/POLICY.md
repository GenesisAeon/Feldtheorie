# Governance Policy - seed/bedeutungssigillin/system/metaquest/lanterns
...
2. **Parent Context** (`seed/bedeutungssigillin/system/metaquest/POLICY.md`)
...
This policy governs all work in `seed/bedeutungssigillin/system/metaquest/lanterns` and its subdirectories.
...
1. **Document**: Create incident report in `seed/bedeutungssigillin/system/metaquest/lanterns/.governance/incidents/`
