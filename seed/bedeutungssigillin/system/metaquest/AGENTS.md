# Agents Charter - seed/bedeutungssigillin/system/metaquest
...
**This directory (`seed/bedeutungssigillin/system/metaquest`) is specialized for:**
...
1. Check the parent governance: `seed/bedeutungssigillin/system/AGENTS.md`
