# Ethics and Responsible Use - seed/bedeutungssigillin/system/metaquest
...
**In this directory (`seed/bedeutungssigillin/system/metaquest`), the following ethical rules apply:**
...
Before committing work in `seed/bedeutungssigillin/system/metaquest`:
