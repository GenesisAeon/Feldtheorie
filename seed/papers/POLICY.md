...
This policy governs all work in `seed/papers` and its subdirectories.
...
1. **Document**: Create incident report in `seed/papers/.governance/incidents/`
