# Governance Policy - seed/papers/supplementary
...
2. **Parent Context** (`seed/papers/POLICY.md`)
...
This policy governs all work in `seed/papers/supplementary` and its subdirectories.
...
1. **Document**: Create incident report in `seed/papers/supplementary/.governance/incidents/`
