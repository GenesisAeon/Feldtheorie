# Agents Charter - seed/papers/supplementary
...
**This directory (`seed/papers/supplementary`) is specialized for:**
...
1. Check the parent governance: `seed/papers/AGENTS.md`
