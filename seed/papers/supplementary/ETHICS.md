# Ethics and Responsible Use - seed/papers/supplementary
...
**In this directory (`seed/papers/supplementary`), the following ethical rules apply:**
...
Before committing work in `seed/papers/supplementary`:
