# Ethics and Responsible Use - seed/papers/submission
...
**In this directory (`seed/papers/submission`), the following ethical rules apply:**
...
Before committing work in `seed/papers/submission`:
