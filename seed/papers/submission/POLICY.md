# Governance Policy - seed/papers/submission
...
This policy governs all work in `seed/papers/submission` and its subdirectories.
...
1. **Document**: Create incident report in `seed/papers/submission/.governance/incidents/`
