# Ethics and Responsible Use - seed/sigillin/examples
...
**In this directory (`seed/sigillin/examples`), the following ethical rules apply:**
...
Before committing work in `seed/sigillin/examples`:
