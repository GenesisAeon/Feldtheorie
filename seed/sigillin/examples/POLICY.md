# Governance Policy - seed/sigillin/examples
...
2. **Parent Context** (`seed/sigillin/POLICY.md`)
...
This policy governs all work in `seed/sigillin/examples` and its subdirectories.
...
1. **Document**: Create incident report in `seed/sigillin/examples/.governance/incidents/`
