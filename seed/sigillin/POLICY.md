# Governance Policy - seed/sigillin
...
This policy governs all work in `seed/sigillin` and its subdirectories.
...
1. **Document**: Create incident report in `seed/sigillin/.governance/incidents/`
