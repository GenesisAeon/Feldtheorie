# Governance Policy - seed/submission/figures
...
This policy governs all work in `seed/submission/figures` and its subdirectories.
...
1. **Document**: Create incident report in `seed/submission/figures/.governance/incidents/`
