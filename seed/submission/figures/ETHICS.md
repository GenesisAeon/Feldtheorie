# Ethics and Responsible Use - seed/submission/figures
...
**In this directory (`seed/submission/figures`), the following ethical rules apply:**
...
Before committing work in `seed/submission/figures`:
