# Governance Policy - seed/submission/supplementary
...
2. **Parent Context** (`seed/submission/POLICY.md`)
...
This policy governs all work in `seed/submission/supplementary` and its subdirectories.
...
1. **Document**: Create incident report in `seed/submission/supplementary/.governance/incidents/`
