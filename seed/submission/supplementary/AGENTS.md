# Agents Charter - seed/submission/supplementary
...
**This directory (`seed/submission/supplementary`) is specialized for:**
...
1. Check the parent governance: `seed/submission/AGENTS.md`
