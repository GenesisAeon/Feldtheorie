# Ethics and Responsible Use - seed/submission/supplementary
...
**In this directory (`seed/submission/supplementary`), the following ethical rules apply:**
...
Before committing work in `seed/submission/supplementary`:
