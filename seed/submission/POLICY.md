# Governance Policy - seed/submission
...
This policy governs all work in `seed/submission` and its subdirectories.
...
1. **Document**: Create incident report in `seed/submission/.governance/incidents/`
