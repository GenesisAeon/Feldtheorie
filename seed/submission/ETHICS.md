# Ethics and Responsible Use - seed/submission
...
**In this directory (`seed/submission`), the following ethical rules apply:**
...
Before committing work in `seed/submission`:
