# Governance Policy - seed/biology
...
This policy governs all work in `seed/biology` and its subdirectories.
...
1. **Document**: Create incident report in `seed/biology/.governance/incidents/`
