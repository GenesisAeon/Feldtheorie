# Ethics and Responsible Use - seed/V4-Grundlagen/abstractZenodoMaterial
...
**In this directory (`seed/V4-Grundlagen/abstractZenodoMaterial`), the following ethical rules apply:**
...
Before committing work in `seed/V4-Grundlagen/abstractZenodoMaterial`:
