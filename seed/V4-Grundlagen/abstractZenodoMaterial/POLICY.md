# Governance Policy - seed/V4-Grundlagen/abstractZenodoMaterial
...
2. **Parent Context** (`seed/V4-Grundlagen/POLICY.md`)
...
This policy governs all work in `seed/V4-Grundlagen/abstractZenodoMaterial` and its subdirectories.
...
1. **Document**: Create incident report in `seed/V4-Grundlagen/abstractZenodoMaterial/.governance/incidents/`
