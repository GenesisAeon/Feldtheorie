# Agents Charter - seed/V4-Grundlagen/abstractZenodoMaterial
...
**This directory (`seed/V4-Grundlagen/abstractZenodoMaterial`) is specialized for:**
...
1. Check the parent governance: `seed/V4-Grundlagen/AGENTS.md`
