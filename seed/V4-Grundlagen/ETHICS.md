# Ethics and Responsible Use - seed/V4-Grundlagen
...
**In this directory (`seed/V4-Grundlagen`), the following ethical rules apply:**
...
Before committing work in `seed/V4-Grundlagen`:
