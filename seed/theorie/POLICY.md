# Governance Policy - seed/theorie
...
This policy governs all work in `seed/theorie` and its subdirectories.
...
1. **Document**: Create incident report in `seed/theorie/.governance/incidents/`
