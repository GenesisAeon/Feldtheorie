...
This policy governs all work in `seed/theory` and its subdirectories.
...
1. **Document**: Create incident report in `seed/theory/.governance/incidents/`
