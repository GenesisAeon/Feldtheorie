# Ethics and Responsible Use - seed/theory/hypothese_quantum_aliasing
...
**In this directory (`seed/theory/hypothese_quantum_aliasing`), the following ethical rules apply:**
...
Before committing work in `seed/theory/hypothese_quantum_aliasing`:
