# Governance Policy - seed/theory/concept_the_mirror_machine
...
This policy governs all work in `seed/theory/concept_the_mirror_machine` and its subdirectories.
...
1. **Document**: Create incident report in `seed/theory/concept_the_mirror_machine/.governance/incidents/`
