# Ethics and Responsible Use - seed/theory/concept_the_mirror_machine
...
**In this directory (`seed/theory/concept_the_mirror_machine`), the following ethical rules apply:**
...
Before committing work in `seed/theory/concept_the_mirror_machine`:
