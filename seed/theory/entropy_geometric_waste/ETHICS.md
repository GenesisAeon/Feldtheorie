# Ethics and Responsible Use - seed/theory/entropy_geometric_waste
...
**In this directory (`seed/theory/entropy_geometric_waste`), the following ethical rules apply:**
...
Before committing work in `seed/theory/entropy_geometric_waste`:
