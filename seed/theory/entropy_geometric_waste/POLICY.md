# Governance Policy - seed/theory/entropy_geometric_waste
...
This policy governs all work in `seed/theory/entropy_geometric_waste` and its subdirectories.
...
1. **Document**: Create incident report in `seed/theory/entropy_geometric_waste/.governance/incidents/`
