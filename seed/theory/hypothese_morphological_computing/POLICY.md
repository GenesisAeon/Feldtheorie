# Governance Policy - seed/theory/hypothese_morphological_computing
...
2. **Parent Context** (`seed/theory/POLICY.md`)
...
This policy governs all work in `seed/theory/hypothese_morphological_computing` and its subdirectories.
...
1. **Document**: Create incident report in `seed/theory/hypothese_morphological_computing/.governance/incidents/`
