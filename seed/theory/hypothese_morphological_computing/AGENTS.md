# Agents Charter - seed/theory/hypothese_morphological_computing
...
**This directory (`seed/theory/hypothese_morphological_computing`) is specialized for:**
...
1. Check the parent governance: `seed/theory/AGENTS.md`
