# Ethics and Responsible Use - seed/socio_ecology
...
**In this directory (`seed/socio_ecology`), the following ethical rules apply:**
...
Before committing work in `seed/socio_ecology`:
