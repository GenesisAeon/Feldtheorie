# Governance Policy - seed/socio_ecology
...
This policy governs all work in `seed/socio_ecology` and its subdirectories.
...
1. **Document**: Create incident report in `seed/socio_ecology/.governance/incidents/`
