# Ethics and Responsible Use - seed/geophysics
...
**In this directory (`seed/geophysics`), the following ethical rules apply:**
...
Before committing work in `seed/geophysics`:
