# Governance Policy - seed/geophysics
...
This policy governs all work in `seed/geophysics` and its subdirectories.
...
1. **Document**: Create incident report in `seed/geophysics/.governance/incidents/`
