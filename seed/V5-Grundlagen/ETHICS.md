# Ethics and Responsible Use - seed/V5-Grundlagen
...
**In this directory (`seed/V5-Grundlagen`), the following ethical rules apply:**
...
Before committing work in `seed/V5-Grundlagen`:
