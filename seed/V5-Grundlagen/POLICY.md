# Governance Policy - seed/V5-Grundlagen
...
This policy governs all work in `seed/V5-Grundlagen` and its subdirectories.
...
1. **Document**: Create incident report in `seed/V5-Grundlagen/.governance/incidents/`
