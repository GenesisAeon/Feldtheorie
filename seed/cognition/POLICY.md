# Governance Policy - seed/cognition
...
This policy governs all work in `seed/cognition` and its subdirectories.
...
1. **Document**: Create incident report in `seed/cognition/.governance/incidents/`
