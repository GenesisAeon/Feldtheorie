# Ethics and Responsible Use - seed/BreakPointAnalyse
...
**In this directory (`seed/BreakPointAnalyse`), the following ethical rules apply:**
...
Before committing work in `seed/BreakPointAnalyse`:
