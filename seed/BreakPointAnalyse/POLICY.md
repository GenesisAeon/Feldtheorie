# Governance Policy - seed/BreakPointAnalyse
...
This policy governs all work in `seed/BreakPointAnalyse` and its subdirectories.
...
1. **Document**: Create incident report in `seed/BreakPointAnalyse/.governance/incidents/`
