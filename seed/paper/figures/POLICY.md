# Governance Policy - seed/paper/figures
...
2. **Parent Context** (`seed/paper/POLICY.md`)
...
This policy governs all work in `seed/paper/figures` and its subdirectories.
...
1. **Document**: Create incident report in `seed/paper/figures/.governance/incidents/`
