# Ethics and Responsible Use - seed/paper/figures
...
**In this directory (`seed/paper/figures`), the following ethical rules apply:**
...
Before committing work in `seed/paper/figures`:
