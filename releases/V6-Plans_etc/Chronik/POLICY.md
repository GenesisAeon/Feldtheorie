# Governance Policy - releases/V6-Plans_etc/Chronik
...
This policy governs all work in `releases/V6-Plans_etc/Chronik` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/Chronik/.governance/incidents/`
