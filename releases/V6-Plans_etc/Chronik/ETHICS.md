# Ethics and Responsible Use - releases/V6-Plans_etc/Chronik
...
**In this directory (`releases/V6-Plans_etc/Chronik`), the following ethical rules apply:**
...
Before committing work in `releases/V6-Plans_etc/Chronik`:
