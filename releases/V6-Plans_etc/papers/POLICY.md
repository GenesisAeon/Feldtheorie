# Governance Policy - releases/V6-Plans_etc/papers
...
This policy governs all work in `releases/V6-Plans_etc/papers` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/papers/.governance/incidents/`
