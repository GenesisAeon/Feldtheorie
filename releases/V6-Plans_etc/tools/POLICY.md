# Governance Policy - releases/V6-Plans_etc/tools
...
This policy governs all work in `releases/V6-Plans_etc/tools` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/tools/.governance/incidents/`
