# Governance Policy - releases/V6-Plans_etc/archievedToDos
...
2. **Parent Context** (`releases/V6-Plans_etc/POLICY.md`)
...
This policy governs all work in `releases/V6-Plans_etc/archievedToDos` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/archievedToDos/.governance/incidents/`
