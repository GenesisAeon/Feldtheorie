# Agents Charter - releases/V6-Plans_etc/archievedToDos
...
**This directory (`releases/V6-Plans_etc/archievedToDos`) is specialized for:**
...
1. Check the parent governance: `releases/V6-Plans_etc/AGENTS.md`
