# Ethics and Responsible Use - releases/V6-Plans_etc/Finalize/papers
...
**In this directory (`releases/V6-Plans_etc/Finalize/papers`), the following ethical rules apply:**
...
Before committing work in `releases/V6-Plans_etc/Finalize/papers`:
