# Governance Policy - releases/V6-Plans_etc/Finalize/research
...
This policy governs all work in `releases/V6-Plans_etc/Finalize/research` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/Finalize/research/.governance/incidents/`
