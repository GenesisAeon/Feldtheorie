...
def _extract_numeric(source: Mapping[str, Any] | Any, keys: tuple[str, ...], default: float = 0.0) -> float:
...
def check_mental_health(beta_fit: Mapping[str, Any] | Any, audit_result: Mapping[str, Any] | None = None) -> None:
    ...
    metrics = {
        ...
        "entropy": _extract_numeric(audit_result, ("entropy", "entropy_measure", "delta_AIC", "delta_aic"), default=0.0),
        "crep_score": _extract_numeric(audit_result, ("crep_score", "ethics_score", "compliance"), default=0.0),
