# Agents Charter - releases/V6-Plans_etc/Finalize/V7_wird noch verlergt
...
**This directory (`releases/V6-Plans_etc/Finalize/V7_wird noch verlergt`) is specialized for:**
...
1. Check the parent governance: `releases/V6-Plans_etc/Finalize/AGENTS.md`
