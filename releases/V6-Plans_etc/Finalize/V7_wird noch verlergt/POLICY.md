# Governance Policy - releases/V6-Plans_etc/Finalize/V7_wird noch verlergt
...
2. **Parent Context** (`releases/V6-Plans_etc/Finalize/POLICY.md`)
...
This policy governs all work in `releases/V6-Plans_etc/Finalize/V7_wird noch verlergt` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/Finalize/V7_wird noch verlergt/.governance/incidents/`
