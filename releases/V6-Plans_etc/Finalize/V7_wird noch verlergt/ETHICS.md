# Ethics and Responsible Use - releases/V6-Plans_etc/Finalize/V7_wird noch verlergt
...
**In this directory (`releases/V6-Plans_etc/Finalize/V7_wird noch verlergt`), the following ethical rules apply:**
...
Before committing work in `releases/V6-Plans_etc/Finalize/V7_wird noch verlergt`:
