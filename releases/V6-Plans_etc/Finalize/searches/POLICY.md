# Governance Policy - releases/V6-Plans_etc/Finalize/searches
...
This policy governs all work in `releases/V6-Plans_etc/Finalize/searches` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/Finalize/searches/.governance/incidents/`
