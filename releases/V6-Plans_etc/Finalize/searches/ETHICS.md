# Ethics and Responsible Use - releases/V6-Plans_etc/Finalize/searches
...
**In this directory (`releases/V6-Plans_etc/Finalize/searches`), the following ethical rules apply:**
...
Before committing work in `releases/V6-Plans_etc/Finalize/searches`:
