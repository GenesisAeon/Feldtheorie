# Governance Policy - releases/V6-Plans_etc/Finalize/architecture
...
This policy governs all work in `releases/V6-Plans_etc/Finalize/architecture` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/Finalize/architecture/.governance/incidents/`
