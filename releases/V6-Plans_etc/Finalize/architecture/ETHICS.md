# Ethics and Responsible Use - releases/V6-Plans_etc/Finalize/architecture
...
**In this directory (`releases/V6-Plans_etc/Finalize/architecture`), the following ethical rules apply:**
...
Before committing work in `releases/V6-Plans_etc/Finalize/architecture`:
