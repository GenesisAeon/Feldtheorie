# Governance Policy - releases/V6-Plans_etc/Finalize/archive
...
This policy governs all work in `releases/V6-Plans_etc/Finalize/archive` and its subdirectories.
...
1. **Document**: Create incident report in `releases/V6-Plans_etc/Finalize/archive/.governance/incidents/`
