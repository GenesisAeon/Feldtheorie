# Governance Policy - releases/v12.0.0
...
This policy governs all work in `releases/v12.0.0` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v12.0.0/.governance/incidents/`
