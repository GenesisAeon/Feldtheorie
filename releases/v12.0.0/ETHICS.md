# Ethics and Responsible Use - releases/v12.0.0
...
**In this directory (`releases/v12.0.0`), the following ethical rules apply:**
...
Before committing work in `releases/v12.0.0`:
