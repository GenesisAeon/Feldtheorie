# Governance Policy - releases/v10.0
...
This policy governs all work in `releases/v10.0` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v10.0/.governance/incidents/`
