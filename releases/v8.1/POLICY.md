# Governance Policy - releases/v8.1
...
This policy governs all work in `releases/v8.1` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v8.1/.governance/incidents/`
