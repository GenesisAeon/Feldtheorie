# Governance Policy - releases/v7.0
...
This policy governs all work in `releases/v7.0` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v7.0/.governance/incidents/`
