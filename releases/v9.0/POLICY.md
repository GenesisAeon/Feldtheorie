# Governance Policy - releases/v9.0
...
This policy governs all work in `releases/v9.0` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v9.0/.governance/incidents/`
