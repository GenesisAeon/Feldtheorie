# Governance Policy - releases/v4.0.0-alpha_MirrorMachine/theory
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine/theory` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/theory/.governance/incidents/`
