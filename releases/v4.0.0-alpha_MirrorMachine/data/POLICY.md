# Governance Policy - releases/v4.0.0-alpha_MirrorMachine/data
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine/data` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/data/.governance/incidents/`
