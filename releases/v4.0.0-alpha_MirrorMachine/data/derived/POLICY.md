# Governance Policy - releases/v4.0.0-alpha_MirrorMachine/data/derived
...
2. **Parent Context** (`releases/v4.0.0-alpha_MirrorMachine/data/POLICY.md`)
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine/data/derived` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/data/derived/.governance/incidents/`
