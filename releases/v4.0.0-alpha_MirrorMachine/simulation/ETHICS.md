# Ethics and Responsible Use - releases/v4.0.0-alpha_MirrorMachine/simulation
...
**In this directory (`releases/v4.0.0-alpha_MirrorMachine/simulation`), the following ethical rules apply:**
...
Before committing work in `releases/v4.0.0-alpha_MirrorMachine/simulation`:
