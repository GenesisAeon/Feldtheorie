# Governance Policy - releases/v4.0.0-alpha_MirrorMachine/simulation
...
2. **Parent Context** (`releases/v4.0.0-alpha_MirrorMachine/POLICY.md`)
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine/simulation` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/simulation/.governance/incidents/`
