# Governance Policy - releases/v4.0.0-alpha_MirrorMachine
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/.governance/incidents/`
