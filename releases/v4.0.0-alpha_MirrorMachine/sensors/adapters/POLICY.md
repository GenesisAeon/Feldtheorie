# Governance Policy - releases/v4.0.0-alpha_MirrorMachine/sensors/adapters
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine/sensors/adapters` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/sensors/adapters/.governance/incidents/`
