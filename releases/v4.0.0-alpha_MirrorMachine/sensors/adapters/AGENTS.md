# Agents Charter - releases/v4.0.0-alpha_MirrorMachine/sensors/adapters
...
**This directory (`releases/v4.0.0-alpha_MirrorMachine/sensors/adapters`) is specialized for:**
