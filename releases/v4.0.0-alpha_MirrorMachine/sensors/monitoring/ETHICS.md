# Ethics and Responsible Use - releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring
...
**In this directory (`releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring`), the following ethical rules apply:**
...
Before committing work in `releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring`:
