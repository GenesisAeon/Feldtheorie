# Agents Charter - releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring
...
**This directory (`releases/v4.0.0-alpha_MirrorMachine/sensors/monitoring`) is specialized for:**
...
1. Check the parent governance: `releases/v4.0.0-alpha_MirrorMachine/sensors/AGENTS.md`
