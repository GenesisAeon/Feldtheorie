# Governance Policy - releases/v4.0.0-alpha_MirrorMachine/sensors
...
This policy governs all work in `releases/v4.0.0-alpha_MirrorMachine/sensors` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v4.0.0-alpha_MirrorMachine/sensors/.governance/incidents/`
