# Governance Policy - releases/v8.0
...
This policy governs all work in `releases/v8.0` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v8.0/.governance/incidents/`
