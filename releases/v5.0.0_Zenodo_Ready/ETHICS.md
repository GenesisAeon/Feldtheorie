# Ethics and Responsible Use - releases/v5.0.0_Zenodo_Ready
...
**In this directory (`releases/v5.0.0_Zenodo_Ready`), the following ethical rules apply:**
...
Before committing work in `releases/v5.0.0_Zenodo_Ready`:
