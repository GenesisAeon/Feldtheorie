# Governance Policy - releases/v5.0.0_Zenodo_Ready
...
This policy governs all work in `releases/v5.0.0_Zenodo_Ready` and its subdirectories.
...
1. **Document**: Create incident report in `releases/v5.0.0_Zenodo_Ready/.governance/incidents/`
