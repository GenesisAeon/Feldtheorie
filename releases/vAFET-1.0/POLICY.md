# Governance Policy - releases/vAFET-1.0
...
This policy governs all work in `releases/vAFET-1.0` and its subdirectories.
...
1. **Document**: Create incident report in `releases/vAFET-1.0/.governance/incidents/`
