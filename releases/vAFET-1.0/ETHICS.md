# Ethics and Responsible Use - releases/vAFET-1.0
...
**In this directory (`releases/vAFET-1.0`), the following ethical rules apply:**
...
Before committing work in `releases/vAFET-1.0`:
