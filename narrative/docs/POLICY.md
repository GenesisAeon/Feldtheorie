# Governance Policy - narrative/docs
...
This policy governs all work in `narrative/docs` and its subdirectories.
...
1. **Document**: Create incident report in `narrative/docs/.governance/incidents/`
