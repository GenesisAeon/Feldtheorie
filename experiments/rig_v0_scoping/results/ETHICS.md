# Ethics and Responsible Use - experiments/rig_v0_scoping/results
...
**In this directory (`experiments/rig_v0_scoping/results`), the following ethical rules apply:**
...
Before committing work in `experiments/rig_v0_scoping/results`:
