# Governance Policy - experiments/rig_v0_scoping/results
...
This policy governs all work in `experiments/rig_v0_scoping/results` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/rig_v0_scoping/results/.governance/incidents/`
