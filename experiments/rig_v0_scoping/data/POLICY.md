# Governance Policy - experiments/rig_v0_scoping/data
...
This policy governs all work in `experiments/rig_v0_scoping/data` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/rig_v0_scoping/data/.governance/incidents/`
