# Ethics and Responsible Use - experiments/rig_v0_scoping/data
...
**In this directory (`experiments/rig_v0_scoping/data`), the following ethical rules apply:**
...
Before committing work in `experiments/rig_v0_scoping/data`:
