# Governance Policy - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/analysis
...
This policy governs all work in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/analysis` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/analysis/.governance/incidents/`
