# Agents Charter - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/analysis
...
**This directory (`experiments/Phaethon_Geminiden_Bennu/NeuroProfile/analysis`) is specialized for:**
