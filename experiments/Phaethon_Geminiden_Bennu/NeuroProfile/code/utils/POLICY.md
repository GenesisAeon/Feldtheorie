# Governance Policy - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils
...
This policy governs all work in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils/.governance/incidents/`
