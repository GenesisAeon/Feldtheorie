# Ethics and Responsible Use - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils
...
**In this directory (`experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils`), the following ethical rules apply:**
...
Before committing work in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils`:
