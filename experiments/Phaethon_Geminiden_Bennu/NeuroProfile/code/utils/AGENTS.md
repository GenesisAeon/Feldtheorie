# Agents Charter - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils
...
**This directory (`experiments/Phaethon_Geminiden_Bennu/NeuroProfile/code/utils`) is specialized for:**
