# Agents Charter - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs
...
**This directory (`experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs`) is specialized for:**
