# Ethics and Responsible Use - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs
...
**In this directory (`experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs`), the following ethical rules apply:**
...
Before committing work in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs`:
