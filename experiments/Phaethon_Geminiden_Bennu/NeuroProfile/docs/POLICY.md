# Governance Policy - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs
...
This policy governs all work in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/docs/.governance/incidents/`
