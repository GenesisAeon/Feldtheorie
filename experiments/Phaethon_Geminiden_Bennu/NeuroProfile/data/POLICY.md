# Governance Policy - experiments/Phaethon_Geminiden_Bennu/NeuroProfile/data
...
This policy governs all work in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/data` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/Phaethon_Geminiden_Bennu/NeuroProfile/data/.governance/incidents/`
