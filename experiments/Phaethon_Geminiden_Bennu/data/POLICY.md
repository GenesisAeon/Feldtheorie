# Governance Policy - experiments/Phaethon_Geminiden_Bennu/data
...
This policy governs all work in `experiments/Phaethon_Geminiden_Bennu/data` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/Phaethon_Geminiden_Bennu/data/.governance/incidents/`
