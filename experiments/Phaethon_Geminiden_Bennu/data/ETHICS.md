# Ethics and Responsible Use - experiments/Phaethon_Geminiden_Bennu/data
...
**In this directory (`experiments/Phaethon_Geminiden_Bennu/data`), the following ethical rules apply:**
...
Before committing work in `experiments/Phaethon_Geminiden_Bennu/data`:
