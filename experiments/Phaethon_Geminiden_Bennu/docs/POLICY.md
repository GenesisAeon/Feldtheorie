# Governance Policy - experiments/Phaethon_Geminiden_Bennu/docs
...
This policy governs all work in `experiments/Phaethon_Geminiden_Bennu/docs` and its subdirectories.
...
1. **Document**: Create incident report in `experiments/Phaethon_Geminiden_Bennu/docs/.governance/incidents/`
