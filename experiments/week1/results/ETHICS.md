# Ethics and Responsible Use - experiments/week1/results
...
**In this directory (`experiments/week1/results`), the following ethical rules apply:**
...
Before committing work in `experiments/week1/results`:
