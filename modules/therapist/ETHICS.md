# Ethics and Responsible Use - modules/therapist
...
**In this directory (`modules/therapist`), the following ethical rules apply:**
...
Before committing work in `modules/therapist`:
