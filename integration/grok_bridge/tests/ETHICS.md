# Ethics and Responsible Use - integration/grok_bridge/tests
...
**In this directory (`integration/grok_bridge/tests`), the following ethical rules apply:**
...
Before committing work in `integration/grok_bridge/tests`:
