# Governance Policy - docs/reviews
...
This policy governs all work in `docs/reviews` and its subdirectories.
...
1. **Document**: Create incident report in `docs/reviews/.governance/incidents/`
