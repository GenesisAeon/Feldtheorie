# Governance Policy - docs/emergence
...
This policy governs all work in `docs/emergence` and its subdirectories.
...
1. **Document**: Create incident report in `docs/emergence/.governance/incidents/`
