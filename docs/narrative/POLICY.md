# Governance Policy - docs/narrative
...
This policy governs all work in `docs/narrative` and its subdirectories.
...
1. **Document**: Create incident report in `docs/narrative/.governance/incidents/`
