# Governance Policy - docs/narrative/parity_briefs
...
This policy governs all work in `docs/narrative/parity_briefs` and its subdirectories.
...
1. **Document**: Create incident report in `docs/narrative/parity_briefs/.governance/incidents/`
