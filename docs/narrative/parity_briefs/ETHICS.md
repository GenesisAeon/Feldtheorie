# Ethics and Responsible Use - docs/narrative/parity_briefs
...
**In this directory (`docs/narrative/parity_briefs`), the following ethical rules apply:**
...
Before committing work in `docs/narrative/parity_briefs`:
