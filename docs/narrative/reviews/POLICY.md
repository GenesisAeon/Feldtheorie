# Governance Policy - docs/narrative/reviews
...
This policy governs all work in `docs/narrative/reviews` and its subdirectories.
...
1. **Document**: Create incident report in `docs/narrative/reviews/.governance/incidents/`
