# Governance Policy - docs/narrative/meta
...
This policy governs all work in `docs/narrative/meta` and its subdirectories.
...
1. **Document**: Create incident report in `docs/narrative/meta/.governance/incidents/`
