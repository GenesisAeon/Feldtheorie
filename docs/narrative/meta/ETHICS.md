# Ethics and Responsible Use - docs/narrative/meta
...
**In this directory (`docs/narrative/meta`), the following ethical rules apply:**
...
Before committing work in `docs/narrative/meta`:
