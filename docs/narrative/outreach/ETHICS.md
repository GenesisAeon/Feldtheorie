# Ethics and Responsible Use - docs/narrative/outreach
...
**In this directory (`docs/narrative/outreach`), the following ethical rules apply:**
...
Before committing work in `docs/narrative/outreach`:
