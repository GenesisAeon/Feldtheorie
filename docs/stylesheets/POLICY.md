# Governance Policy - docs/stylesheets
...
This policy governs all work in `docs/stylesheets` and its subdirectories.
...
1. **Document**: Create incident report in `docs/stylesheets/.governance/incidents/`
