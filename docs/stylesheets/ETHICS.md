# Ethics and Responsible Use - docs/stylesheets
...
**In this directory (`docs/stylesheets`), the following ethical rules apply:**
...
Before committing work in `docs/stylesheets`:
