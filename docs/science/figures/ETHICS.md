# Ethics and Responsible Use - docs/science/figures
...
**In this directory (`docs/science/figures`), the following ethical rules apply:**
...
Before committing work in `docs/science/figures`:
