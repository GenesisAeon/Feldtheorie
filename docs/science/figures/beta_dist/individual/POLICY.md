# Governance Policy - docs/science/figures/beta_dist/individual
...
2. **Parent Context** (`docs/science/figures/beta_dist/POLICY.md`)
...
This policy governs all work in `docs/science/figures/beta_dist/individual` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/figures/beta_dist/individual/.governance/incidents/`
