# Agents Charter - docs/science/figures/beta_dist/individual
...
**This directory (`docs/science/figures/beta_dist/individual`) is specialized for:**
...
1. Check the parent governance: `docs/science/figures/beta_dist/AGENTS.md`
