# Ethics and Responsible Use - docs/science/figures/beta_dist
...
**In this directory (`docs/science/figures/beta_dist`), the following ethical rules apply:**
...
Before committing work in `docs/science/figures/beta_dist`:
