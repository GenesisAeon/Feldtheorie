# Governance Policy - docs/science/figures/beta_dist
...
This policy governs all work in `docs/science/figures/beta_dist` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/figures/beta_dist/.governance/incidents/`
