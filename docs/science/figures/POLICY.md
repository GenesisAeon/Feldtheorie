# Governance Policy - docs/science/figures
...
This policy governs all work in `docs/science/figures` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/figures/.governance/incidents/`
