# Agents Charter - docs/science/figures/wavefunction
...
**This directory (`docs/science/figures/wavefunction`) is specialized for:**
...
1. Check the parent governance: `docs/science/figures/AGENTS.md`
