# Ethics and Responsible Use - docs/science/figures/wavefunction
...
**In this directory (`docs/science/figures/wavefunction`), the following ethical rules apply:**
...
Before committing work in `docs/science/figures/wavefunction`:
