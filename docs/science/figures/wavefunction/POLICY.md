# Governance Policy - docs/science/figures/wavefunction
...
2. **Parent Context** (`docs/science/figures/POLICY.md`)
...
This policy governs all work in `docs/science/figures/wavefunction` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/figures/wavefunction/.governance/incidents/`
