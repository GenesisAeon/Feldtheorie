# Governance Policy - docs/science/theoretical_extensions
...
2. **Parent Context** (`docs/science/POLICY.md`)
...
This policy governs all work in `docs/science/theoretical_extensions` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/theoretical_extensions/.governance/incidents/`
