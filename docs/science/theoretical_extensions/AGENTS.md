# Agents Charter - docs/science/theoretical_extensions
...
**This directory (`docs/science/theoretical_extensions`) is specialized for:**
...
1. Check the parent governance: `docs/science/AGENTS.md`
