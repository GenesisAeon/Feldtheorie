# Governance Policy - docs/science
...
This policy governs all work in `docs/science` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/.governance/incidents/`
