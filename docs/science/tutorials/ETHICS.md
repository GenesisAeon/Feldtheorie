# Ethics and Responsible Use - docs/science/tutorials
...
**In this directory (`docs/science/tutorials`), the following ethical rules apply:**
...
Before committing work in `docs/science/tutorials`:
