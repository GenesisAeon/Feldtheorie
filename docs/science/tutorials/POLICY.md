# Governance Policy - docs/science/tutorials
...
This policy governs all work in `docs/science/tutorials` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/tutorials/.governance/incidents/`
