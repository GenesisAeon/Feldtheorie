# Governance Policy - docs/science/ethics
...
This policy governs all work in `docs/science/ethics` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/ethics/.governance/incidents/`
