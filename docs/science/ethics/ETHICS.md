# Ethics and Responsible Use - docs/science/ethics
...
**In this directory (`docs/science/ethics`), the following ethical rules apply:**
...
Before committing work in `docs/science/ethics`:
