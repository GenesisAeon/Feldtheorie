# Governance Policy - docs/science/appendices
...
This policy governs all work in `docs/science/appendices` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/appendices/.governance/incidents/`
