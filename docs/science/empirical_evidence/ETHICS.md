# Ethics and Responsible Use - docs/science/empirical_evidence
...
**In this directory (`docs/science/empirical_evidence`), the following ethical rules apply:**
...
Before committing work in `docs/science/empirical_evidence`:
