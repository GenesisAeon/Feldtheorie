# Governance Policy - docs/science/empirical_evidence
...
This policy governs all work in `docs/science/empirical_evidence` and its subdirectories.
...
1. **Document**: Create incident report in `docs/science/empirical_evidence/.governance/incidents/`
