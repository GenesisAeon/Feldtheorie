# Governance Policy - docs/NeueForschungenAFET
...
This policy governs all work in `docs/NeueForschungenAFET` and its subdirectories.
...
1. **Document**: Create incident report in `docs/NeueForschungenAFET/.governance/incidents/`
