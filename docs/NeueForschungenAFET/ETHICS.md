# Ethics and Responsible Use - docs/NeueForschungenAFET
...
**In this directory (`docs/NeueForschungenAFET`), the following ethical rules apply:**
...
Before committing work in `docs/NeueForschungenAFET`:
