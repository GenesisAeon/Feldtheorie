# Governance Policy - docs/appendices
...
This policy governs all work in `docs/appendices` and its subdirectories.
...
1. **Document**: Create incident report in `docs/appendices/.governance/incidents/`
