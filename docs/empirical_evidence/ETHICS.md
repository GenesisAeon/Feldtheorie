# Ethics and Responsible Use - docs/empirical_evidence
...
**In this directory (`docs/empirical_evidence`), the following ethical rules apply:**
...
Before committing work in `docs/empirical_evidence`:
