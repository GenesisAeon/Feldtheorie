# Governance Policy - docs/empirical_evidence
...
This policy governs all work in `docs/empirical_evidence` and its subdirectories.
...
1. **Document**: Create incident report in `docs/empirical_evidence/.governance/incidents/`
