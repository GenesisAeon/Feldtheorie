...
| ---- | ---------------- | -------------- | -------------- |
| Safety-Delay τ* modelling | `simulation/`, `analysis/`, `simulator/`, `data/safety_delay/` | ✅ `analysis/safety_delay_sweep.py` + `analysis/results/safety_delay_sweep_20251107T211928Z.json` + `simulator/cli.py safety-delay` exporting `data/safety_delay/safety_delay_delta_aic_20251107T211928Z.*` | Compare against baseline logistic sweep, surface dataset in simulator presets & docs |
