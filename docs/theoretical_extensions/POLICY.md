# Governance Policy - docs/theoretical_extensions
...
This policy governs all work in `docs/theoretical_extensions` and its subdirectories.
...
1. **Document**: Create incident report in `docs/theoretical_extensions/.governance/incidents/`
