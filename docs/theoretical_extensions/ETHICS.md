# Ethics and Responsible Use - docs/theoretical_extensions
...
**In this directory (`docs/theoretical_extensions`), the following ethical rules apply:**
...
Before committing work in `docs/theoretical_extensions`:
