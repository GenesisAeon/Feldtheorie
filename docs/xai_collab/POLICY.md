# Governance Policy - docs/xai_collab
...
This policy governs all work in `docs/xai_collab` and its subdirectories.
...
1. **Document**: Create incident report in `docs/xai_collab/.governance/incidents/`
