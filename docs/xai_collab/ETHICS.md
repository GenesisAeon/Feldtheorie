# Ethics and Responsible Use - docs/xai_collab
...
**In this directory (`docs/xai_collab`), the following ethical rules apply:**
...
Before committing work in `docs/xai_collab`:
