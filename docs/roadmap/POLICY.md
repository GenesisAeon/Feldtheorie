# Governance Policy - docs/roadmap
...
This policy governs all work in `docs/roadmap` and its subdirectories.
...
1. **Document**: Create incident report in `docs/roadmap/.governance/incidents/`
