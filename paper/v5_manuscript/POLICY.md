# Governance Policy - paper/v5_manuscript
...
2. **Parent Context** (`paper/POLICY.md`)
...
This policy governs all work in `paper/v5_manuscript` and its subdirectories.
...
1. **Document**: Create incident report in `paper/v5_manuscript/.governance/incidents/`
