# Ethics and Responsible Use - paper/v5_manuscript
...
**In this directory (`paper/v5_manuscript`), the following ethical rules apply:**
...
Before committing work in `paper/v5_manuscript`:
