# Ethics and Responsible Use - tests/experiments
...
**In this directory (`tests/experiments`), the following ethical rules apply:**
...
Before committing work in `tests/experiments`:
