# Governance Policy - tests/fixtures
...
This policy governs all work in `tests/fixtures` and its subdirectories.
...
1. **Document**: Create incident report in `tests/fixtures/.governance/incidents/`
