# Governance Policy - pipelines/wavefunction
...
This policy governs all work in `pipelines/wavefunction` and its subdirectories.
...
1. **Document**: Create incident report in `pipelines/wavefunction/.governance/incidents/`
