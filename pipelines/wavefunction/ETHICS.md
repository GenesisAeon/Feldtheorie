# Ethics and Responsible Use - pipelines/wavefunction
...
**In this directory (`pipelines/wavefunction`), the following ethical rules apply:**
...
Before committing work in `pipelines/wavefunction`:
