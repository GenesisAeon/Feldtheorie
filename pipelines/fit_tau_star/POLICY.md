# Governance Policy - pipelines/fit_tau_star
...
2. **Parent Context** (`pipelines/POLICY.md`)
...
This policy governs all work in `pipelines/fit_tau_star` and its subdirectories.
...
1. **Document**: Create incident report in `pipelines/fit_tau_star/.governance/incidents/`
