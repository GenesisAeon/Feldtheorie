# Ethics and Responsible Use - pipelines/fit_tau_star
...
**In this directory (`pipelines/fit_tau_star`), the following ethical rules apply:**
...
Before committing work in `pipelines/fit_tau_star`:
