# Ethics and Responsible Use - pipelines/ocf_sources
...
**In this directory (`pipelines/ocf_sources`), the following ethical rules apply:**
...
Before committing work in `pipelines/ocf_sources`:
