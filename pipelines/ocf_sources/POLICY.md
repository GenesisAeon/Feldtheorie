# Governance Policy - pipelines/ocf_sources
...
This policy governs all work in `pipelines/ocf_sources` and its subdirectories.
...
1. **Document**: Create incident report in `pipelines/ocf_sources/.governance/incidents/`
