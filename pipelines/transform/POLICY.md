# Governance Policy - pipelines/transform
...
This policy governs all work in `pipelines/transform` and its subdirectories.
...
1. **Document**: Create incident report in `pipelines/transform/.governance/incidents/`
