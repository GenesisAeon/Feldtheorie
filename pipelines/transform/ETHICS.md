# Ethics and Responsible Use - pipelines/transform
...
**In this directory (`pipelines/transform`), the following ethical rules apply:**
...
Before committing work in `pipelines/transform`:
