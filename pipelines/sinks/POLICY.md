# Governance Policy - pipelines/sinks
...
This policy governs all work in `pipelines/sinks` and its subdirectories.
...
1. **Document**: Create incident report in `pipelines/sinks/.governance/incidents/`
