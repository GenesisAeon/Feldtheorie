# Ethics and Responsible Use - pipelines/sinks
...
**In this directory (`pipelines/sinks`), the following ethical rules apply:**
...
Before committing work in `pipelines/sinks`:
