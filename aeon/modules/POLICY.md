# Governance Policy - narrative/aeon/modules
...
This policy governs all work in `narrative/aeon/modules` and its subdirectories.
...
1. **Document**: Create incident report in `narrative/aeon/modules/.governance/incidents/`
