# Ethics and Responsible Use - narrative/aeon/modules
...
**In this directory (`narrative/aeon/modules`), the following ethical rules apply:**
...
Before committing work in `narrative/aeon/modules`:
