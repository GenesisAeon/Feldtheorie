# Governance Policy - data/implosion
...
This policy governs all work in `data/implosion` and its subdirectories.
...
1. **Document**: Create incident report in `data/implosion/.governance/incidents/`
