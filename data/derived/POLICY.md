# Governance Policy - data/derived
...
This policy governs all work in `data/derived` and its subdirectories.
...
1. **Document**: Create incident report in `data/derived/.governance/incidents/`
