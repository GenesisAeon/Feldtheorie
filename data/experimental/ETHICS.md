# Ethics and Responsible Use - data/experimental
...
**In this directory (`data/experimental`), the following ethical rules apply:**
...
Before committing work in `data/experimental`:
