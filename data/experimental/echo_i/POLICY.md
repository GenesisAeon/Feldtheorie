# Governance Policy - data/experimental/echo_i
...
This policy governs all work in `data/experimental/echo_i` and its subdirectories.
...
1. **Document**: Create incident report in `data/experimental/echo_i/.governance/incidents/`
