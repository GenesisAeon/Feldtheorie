# Ethics and Responsible Use - data/experimental/echo_i
...
**In this directory (`data/experimental/echo_i`), the following ethical rules apply:**
...
Before committing work in `data/experimental/echo_i`:
