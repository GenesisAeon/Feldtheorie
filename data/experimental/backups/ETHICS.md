# Ethics and Responsible Use - data/experimental/backups
...
**In this directory (`data/experimental/backups`), the following ethical rules apply:**
...
Before committing work in `data/experimental/backups`:
