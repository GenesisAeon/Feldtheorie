# Governance Policy - data/experimental
...
This policy governs all work in `data/experimental` and its subdirectories.
...
1. **Document**: Create incident report in `data/experimental/.governance/incidents/`
