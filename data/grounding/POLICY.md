# Governance Policy - data/grounding
...
This policy governs all work in `data/grounding` and its subdirectories.
...
1. **Document**: Create incident report in `data/grounding/.governance/incidents/`
