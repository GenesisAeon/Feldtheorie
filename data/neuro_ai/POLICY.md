# Governance Policy - data/neuro_ai
...
This policy governs all work in `data/neuro_ai` and its subdirectories.
...
1. **Document**: Create incident report in `data/neuro_ai/.governance/incidents/`
