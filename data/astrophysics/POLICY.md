# Governance Policy - data/astrophysics
...
This policy governs all work in `data/astrophysics` and its subdirectories.
...
1. **Document**: Create incident report in `data/astrophysics/.governance/incidents/`
