# Ethics and Responsible Use - data/astrophysics
...
**In this directory (`data/astrophysics`), the following ethical rules apply:**
...
Before committing work in `data/astrophysics`:
