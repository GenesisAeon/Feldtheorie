# Governance Policy - data/cognition
...
This policy governs all work in `data/cognition` and its subdirectories.
...
1. **Document**: Create incident report in `data/cognition/.governance/incidents/`
