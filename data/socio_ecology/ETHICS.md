# Ethics and Responsible Use - data/socio_ecology
...
**In this directory (`data/socio_ecology`), the following ethical rules apply:**
...
Before committing work in `data/socio_ecology`:
