# Governance Policy - data/socio_ecology
...
2. **Parent Context** (`data/POLICY.md`)
...
This policy governs all work in `data/socio_ecology` and its subdirectories.
...
1. **Document**: Create incident report in `data/socio_ecology/.governance/incidents/`
