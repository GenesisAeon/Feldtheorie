# Ethics and Responsible Use - data/socio_ecology/urban_heat
...
**In this directory (`data/socio_ecology/urban_heat`), the following ethical rules apply:**
...
Before committing work in `data/socio_ecology/urban_heat`:
