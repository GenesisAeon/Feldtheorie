# Governance Policy - data/socio_ecology/urban_heat
...
2. **Parent Context** (`data/socio_ecology/POLICY.md`)
...
This policy governs all work in `data/socio_ecology/urban_heat` and its subdirectories.
...
1. **Document**: Create incident report in `data/socio_ecology/urban_heat/.governance/incidents/`
