# Governance Policy - data/climate
...
This policy governs all work in `data/climate` and its subdirectories.
...
1. **Document**: Create incident report in `data/climate/.governance/incidents/`
