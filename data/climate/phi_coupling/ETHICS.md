# Ethics and Responsible Use - data/climate/phi_coupling
...
**In this directory (`data/climate/phi_coupling`), the following ethical rules apply:**
...
Before committing work in `data/climate/phi_coupling`:
