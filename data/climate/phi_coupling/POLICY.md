# Governance Policy - data/climate/phi_coupling
...
2. **Parent Context** (`data/climate/POLICY.md`)
...
This policy governs all work in `data/climate/phi_coupling` and its subdirectories.
...
1. **Document**: Create incident report in `data/climate/phi_coupling/.governance/incidents/`
