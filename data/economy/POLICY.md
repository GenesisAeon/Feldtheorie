# Governance Policy - data/economy
...
This policy governs all work in `data/economy` and its subdirectories.
...
1. **Document**: Create incident report in `data/economy/.governance/incidents/`
