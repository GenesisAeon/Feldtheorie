# Governance Policy - data/biology
...
This policy governs all work in `data/biology` and its subdirectories.
...
1. **Document**: Create incident report in `data/biology/.governance/incidents/`
