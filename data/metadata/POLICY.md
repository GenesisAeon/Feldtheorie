# Governance Policy - data/metadata
...
This policy governs all work in `data/metadata` and its subdirectories.
...
1. **Document**: Create incident report in `data/metadata/.governance/incidents/`
