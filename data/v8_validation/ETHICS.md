# Ethics and Responsible Use - data/v8_validation
...
**In this directory (`data/v8_validation`), the following ethical rules apply:**
...
Before committing work in `data/v8_validation`:
