# Governance Policy - data/geophysics
...
This policy governs all work in `data/geophysics` and its subdirectories.
...
1. **Document**: Create incident report in `data/geophysics/.governance/incidents/`
