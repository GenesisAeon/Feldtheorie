# Ethics and Responsible Use - data/geophysics
...
**In this directory (`data/geophysics`), the following ethical rules apply:**
...
Before committing work in `data/geophysics`:
