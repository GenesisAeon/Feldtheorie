# Ethics and Responsible Use - data/safety_delay
...
**In this directory (`data/safety_delay`), the following ethical rules apply:**
...
Before committing work in `data/safety_delay`:
