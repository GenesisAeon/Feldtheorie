# Governance Policy - data/safety_delay
...
This policy governs all work in `data/safety_delay` and its subdirectories.
...
1. **Document**: Create incident report in `data/safety_delay/.governance/incidents/`
