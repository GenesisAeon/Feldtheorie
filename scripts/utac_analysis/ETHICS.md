# Ethics and Responsible Use - scripts/utac_analysis
...
**In this directory (`scripts/utac_analysis`), the following ethical rules apply:**
...
Before committing work in `scripts/utac_analysis`:
