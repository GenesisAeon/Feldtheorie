# Governance Policy - scripts/utac_analysis
...
2. **Parent Context** (`scripts/POLICY.md`)
...
This policy governs all work in `scripts/utac_analysis` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/utac_analysis/.governance/incidents/`
