# Ethics and Responsible Use - scripts/adapters
...
**In this directory (`scripts/adapters`), the following ethical rules apply:**
...
Before committing work in `scripts/adapters`:
