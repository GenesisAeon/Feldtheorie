# Governance Policy - scripts/adapters
...
This policy governs all work in `scripts/adapters` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/adapters/.governance/incidents/`
