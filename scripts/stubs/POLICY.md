# Governance Policy - scripts/stubs
...
This policy governs all work in `scripts/stubs` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/stubs/.governance/incidents/`
