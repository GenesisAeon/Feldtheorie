# Governance Policy - scripts/validation
...
This policy governs all work in `scripts/validation` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/validation/.governance/incidents/`
