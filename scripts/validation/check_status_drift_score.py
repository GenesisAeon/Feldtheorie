...
def compute_status_drift(report: dict[str, Any], *, max_age_days: int | None) -> dict[str, Any]:
    ...
    status_drift_score = mismatch_count + missing_docs + stale_penalty
    return {
...
def main() -> int:
    ...
    try:
        ...
        summary = compute_status_drift(report, max_age_days=max_age_days)
    ...
    print(
        ...
        "readiness_age_days={age}, stale_penalty={stale})".format(
