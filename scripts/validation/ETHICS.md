# Ethics and Responsible Use - scripts/validation
...
**In this directory (`scripts/validation`), the following ethical rules apply:**
...
Before committing work in `scripts/validation`:
