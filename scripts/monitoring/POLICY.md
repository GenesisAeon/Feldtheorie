# Governance Policy - scripts/monitoring
...
This policy governs all work in `scripts/monitoring` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/monitoring/.governance/incidents/`
