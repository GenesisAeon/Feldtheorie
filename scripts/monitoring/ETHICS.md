# Ethics and Responsible Use - scripts/monitoring
...
**In this directory (`scripts/monitoring`), the following ethical rules apply:**
...
Before committing work in `scripts/monitoring`:
