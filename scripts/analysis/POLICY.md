# Governance Policy - scripts/analysis
...
This policy governs all work in `scripts/analysis` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/analysis/.governance/incidents/`
