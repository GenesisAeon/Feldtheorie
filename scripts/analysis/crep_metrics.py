...
class CREPAnalyzer:
    ...
    def compute_coherence(self, system: str) -> dict:
        ...
        trend_alignment = (
            1.0 if (both_positive and both_significant) else (0.5 if both_positive else 0.0)
        )
        ...
        magnitude_consistency = (
            1.0
            if (var_increasing and ar1_increasing)
            else (0.3 if (var_increasing or ar1_increasing) else 0.0)
        )
        ...
        coherence_score = (
            0.40 * trend_alignment + 0.35 * magnitude_consistency + 0.25 * tau_correlation
        )
    ...
    def compute_resonance(self, system: str) -> dict:
        ...
        # Overall resonance
        resonance_score = (
            0.35 * avg_coupling + 0.45 * cascade_potential + 0.20 * bidirectional_score
        )
...
def main():
    ...
    if args.system == "all":
        ...
        for system, metrics in results.items():
            ...
            print("─" * 70)
            print(
                f"   Coherence (C):  {metrics['coherence']['score']:.3f} - {metrics['coherence']['interpretation']}"
            )
            print(
                f"   Resonance (R):  {metrics['resonance']['score']:.3f} - {metrics['resonance']['interpretation']}"
            )
            print(
                f"   Emergence (E):  {metrics['emergence']['score']:.3f} - {metrics['emergence']['interpretation']}"
            )
            print(
                f"   Poetics (P):    {metrics['poetics']['score']:.3f} - {metrics['poetics']['interpretation']}"
            )
