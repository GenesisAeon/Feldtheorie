# Governance Policy - scripts/grounding
...
This policy governs all work in `scripts/grounding` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/grounding/.governance/incidents/`
