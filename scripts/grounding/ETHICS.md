# Ethics and Responsible Use - scripts/grounding
...
**In this directory (`scripts/grounding`), the following ethical rules apply:**
...
Before committing work in `scripts/grounding`:
