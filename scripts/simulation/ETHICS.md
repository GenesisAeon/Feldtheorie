# Ethics and Responsible Use - scripts/simulation
...
**In this directory (`scripts/simulation`), the following ethical rules apply:**
...
Before committing work in `scripts/simulation`:
