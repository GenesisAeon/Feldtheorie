# Governance Policy - scripts/simulation
...
This policy governs all work in `scripts/simulation` and its subdirectories.
...
1. **Document**: Create incident report in `scripts/simulation/.governance/incidents/`
