...
def supplementary_figures(output_dir: pathlib.Path, fmt="pdf"):
    ...
    positions = [1, 2, 3]
    bp = ax_s1.boxplot(
        noise_data.values(), positions=positions, widths=0.6, patch_artist=True, showmeans=True
    )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate all figures for Emergent Steepness paper"
    )
    parser.add_argument(
        "--output", type=str, default="figures", help="Output directory for figures"
    )
    parser.add_argument(
