# Governance Policy - science/docs
...
This policy governs all work in `science/docs` and its subdirectories.
...
1. **Document**: Create incident report in `science/docs/.governance/incidents/`
