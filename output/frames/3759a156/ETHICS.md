# Ethics and Responsible Use - output/frames/3759a156
...
**In this directory (`output/frames/3759a156`), the following ethical rules apply:**
...
Before committing work in `output/frames/3759a156`:
