# Governance Policy - output/frames/3759a156
...
This policy governs all work in `output/frames/3759a156` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3759a156/.governance/incidents/`
