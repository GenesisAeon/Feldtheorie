# Governance Policy - output/frames/33b8194c
...
This policy governs all work in `output/frames/33b8194c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/33b8194c/.governance/incidents/`
