# Ethics and Responsible Use - output/frames/33b8194c
...
**In this directory (`output/frames/33b8194c`), the following ethical rules apply:**
...
Before committing work in `output/frames/33b8194c`:
