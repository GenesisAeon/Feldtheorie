# Ethics and Responsible Use - output/frames/0bcb87e1
...
**In this directory (`output/frames/0bcb87e1`), the following ethical rules apply:**
...
Before committing work in `output/frames/0bcb87e1`:
