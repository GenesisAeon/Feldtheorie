# Governance Policy - output/frames/0bcb87e1
...
This policy governs all work in `output/frames/0bcb87e1` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0bcb87e1/.governance/incidents/`
