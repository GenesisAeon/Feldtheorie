# Ethics and Responsible Use - output/frames/61117eab
...
**In this directory (`output/frames/61117eab`), the following ethical rules apply:**
...
Before committing work in `output/frames/61117eab`:
