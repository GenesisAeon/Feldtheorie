# Governance Policy - output/frames/61117eab
...
This policy governs all work in `output/frames/61117eab` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/61117eab/.governance/incidents/`
