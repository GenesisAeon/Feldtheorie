# Ethics and Responsible Use - output/frames/988c1ecd
...
**In this directory (`output/frames/988c1ecd`), the following ethical rules apply:**
...
Before committing work in `output/frames/988c1ecd`:
