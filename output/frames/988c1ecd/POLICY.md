# Governance Policy - output/frames/988c1ecd
...
This policy governs all work in `output/frames/988c1ecd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/988c1ecd/.governance/incidents/`
