# Governance Policy - output/frames/7bdfa262
...
This policy governs all work in `output/frames/7bdfa262` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7bdfa262/.governance/incidents/`
