# Ethics and Responsible Use - output/frames/7bdfa262
...
**In this directory (`output/frames/7bdfa262`), the following ethical rules apply:**
...
Before committing work in `output/frames/7bdfa262`:
