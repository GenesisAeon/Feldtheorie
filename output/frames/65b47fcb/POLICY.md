# Governance Policy - output/frames/65b47fcb
...
This policy governs all work in `output/frames/65b47fcb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/65b47fcb/.governance/incidents/`
