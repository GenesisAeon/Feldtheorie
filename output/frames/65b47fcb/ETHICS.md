# Ethics and Responsible Use - output/frames/65b47fcb
...
**In this directory (`output/frames/65b47fcb`), the following ethical rules apply:**
...
Before committing work in `output/frames/65b47fcb`:
