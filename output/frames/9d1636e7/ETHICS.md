# Ethics and Responsible Use - output/frames/9d1636e7
...
**In this directory (`output/frames/9d1636e7`), the following ethical rules apply:**
...
Before committing work in `output/frames/9d1636e7`:
