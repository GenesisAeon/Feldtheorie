# Governance Policy - output/frames/9d1636e7
...
This policy governs all work in `output/frames/9d1636e7` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9d1636e7/.governance/incidents/`
