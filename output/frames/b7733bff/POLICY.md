# Governance Policy - output/frames/b7733bff
...
This policy governs all work in `output/frames/b7733bff` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b7733bff/.governance/incidents/`
