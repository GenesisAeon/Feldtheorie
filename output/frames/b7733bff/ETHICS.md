# Ethics and Responsible Use - output/frames/b7733bff
...
**In this directory (`output/frames/b7733bff`), the following ethical rules apply:**
...
Before committing work in `output/frames/b7733bff`:
