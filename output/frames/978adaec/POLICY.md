# Governance Policy - output/frames/978adaec
...
This policy governs all work in `output/frames/978adaec` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/978adaec/.governance/incidents/`
