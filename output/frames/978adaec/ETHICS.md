# Ethics and Responsible Use - output/frames/978adaec
...
**In this directory (`output/frames/978adaec`), the following ethical rules apply:**
...
Before committing work in `output/frames/978adaec`:
