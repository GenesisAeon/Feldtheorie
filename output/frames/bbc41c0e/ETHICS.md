# Ethics and Responsible Use - output/frames/bbc41c0e
...
**In this directory (`output/frames/bbc41c0e`), the following ethical rules apply:**
...
Before committing work in `output/frames/bbc41c0e`:
