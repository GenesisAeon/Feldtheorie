# Governance Policy - output/frames/bbc41c0e
...
This policy governs all work in `output/frames/bbc41c0e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bbc41c0e/.governance/incidents/`
