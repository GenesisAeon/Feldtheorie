# Ethics and Responsible Use - output/frames/e0ae6413
...
**In this directory (`output/frames/e0ae6413`), the following ethical rules apply:**
...
Before committing work in `output/frames/e0ae6413`:
