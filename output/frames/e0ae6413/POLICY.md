# Governance Policy - output/frames/e0ae6413
...
This policy governs all work in `output/frames/e0ae6413` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e0ae6413/.governance/incidents/`
