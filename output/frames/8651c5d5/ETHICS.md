# Ethics and Responsible Use - output/frames/8651c5d5
...
**In this directory (`output/frames/8651c5d5`), the following ethical rules apply:**
...
Before committing work in `output/frames/8651c5d5`:
