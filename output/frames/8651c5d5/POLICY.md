# Governance Policy - output/frames/8651c5d5
...
This policy governs all work in `output/frames/8651c5d5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8651c5d5/.governance/incidents/`
