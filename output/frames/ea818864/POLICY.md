# Governance Policy - output/frames/ea818864
...
This policy governs all work in `output/frames/ea818864` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ea818864/.governance/incidents/`
