# Ethics and Responsible Use - output/frames/9a14a1de
...
**In this directory (`output/frames/9a14a1de`), the following ethical rules apply:**
...
Before committing work in `output/frames/9a14a1de`:
