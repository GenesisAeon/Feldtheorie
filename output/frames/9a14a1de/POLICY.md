# Governance Policy - output/frames/9a14a1de
...
This policy governs all work in `output/frames/9a14a1de` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9a14a1de/.governance/incidents/`
