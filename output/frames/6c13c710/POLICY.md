# Governance Policy - output/frames/6c13c710
...
This policy governs all work in `output/frames/6c13c710` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6c13c710/.governance/incidents/`
