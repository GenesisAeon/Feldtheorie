# Ethics and Responsible Use - output/frames/6c13c710
...
**In this directory (`output/frames/6c13c710`), the following ethical rules apply:**
...
Before committing work in `output/frames/6c13c710`:
