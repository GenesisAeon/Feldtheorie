# Governance Policy - output/frames/a14fd3f9
...
This policy governs all work in `output/frames/a14fd3f9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a14fd3f9/.governance/incidents/`
