# Ethics and Responsible Use - output/frames/a14fd3f9
...
**In this directory (`output/frames/a14fd3f9`), the following ethical rules apply:**
...
Before committing work in `output/frames/a14fd3f9`:
