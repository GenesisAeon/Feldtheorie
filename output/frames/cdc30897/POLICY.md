# Governance Policy - output/frames/cdc30897
...
This policy governs all work in `output/frames/cdc30897` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/cdc30897/.governance/incidents/`
