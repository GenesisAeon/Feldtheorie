# Ethics and Responsible Use - output/frames/cdc30897
...
**In this directory (`output/frames/cdc30897`), the following ethical rules apply:**
...
Before committing work in `output/frames/cdc30897`:
