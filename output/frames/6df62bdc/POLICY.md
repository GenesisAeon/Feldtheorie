# Governance Policy - output/frames/6df62bdc
...
This policy governs all work in `output/frames/6df62bdc` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6df62bdc/.governance/incidents/`
