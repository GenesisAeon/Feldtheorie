# Ethics and Responsible Use - output/frames/6df62bdc
...
**In this directory (`output/frames/6df62bdc`), the following ethical rules apply:**
...
Before committing work in `output/frames/6df62bdc`:
