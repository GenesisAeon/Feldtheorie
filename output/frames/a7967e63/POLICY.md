# Governance Policy - output/frames/a7967e63
...
This policy governs all work in `output/frames/a7967e63` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a7967e63/.governance/incidents/`
