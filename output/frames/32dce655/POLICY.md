# Governance Policy - output/frames/32dce655
...
This policy governs all work in `output/frames/32dce655` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/32dce655/.governance/incidents/`
