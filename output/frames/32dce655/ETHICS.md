# Ethics and Responsible Use - output/frames/32dce655
...
**In this directory (`output/frames/32dce655`), the following ethical rules apply:**
...
Before committing work in `output/frames/32dce655`:
