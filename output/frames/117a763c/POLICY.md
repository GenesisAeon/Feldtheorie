# Governance Policy - output/frames/117a763c
...
This policy governs all work in `output/frames/117a763c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/117a763c/.governance/incidents/`
