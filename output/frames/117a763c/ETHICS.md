# Ethics and Responsible Use - output/frames/117a763c
...
**In this directory (`output/frames/117a763c`), the following ethical rules apply:**
...
Before committing work in `output/frames/117a763c`:
