# Ethics and Responsible Use - output/frames/99f1444e
...
**In this directory (`output/frames/99f1444e`), the following ethical rules apply:**
...
Before committing work in `output/frames/99f1444e`:
