# Ethics and Responsible Use - output/frames/8f15fc99
...
**In this directory (`output/frames/8f15fc99`), the following ethical rules apply:**
...
Before committing work in `output/frames/8f15fc99`:
