# Governance Policy - output/frames/8f15fc99
...
This policy governs all work in `output/frames/8f15fc99` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8f15fc99/.governance/incidents/`
