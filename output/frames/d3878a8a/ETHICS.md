# Ethics and Responsible Use - output/frames/d3878a8a
...
**In this directory (`output/frames/d3878a8a`), the following ethical rules apply:**
...
Before committing work in `output/frames/d3878a8a`:
