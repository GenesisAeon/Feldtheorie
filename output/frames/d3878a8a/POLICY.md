# Governance Policy - output/frames/d3878a8a
...
This policy governs all work in `output/frames/d3878a8a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d3878a8a/.governance/incidents/`
