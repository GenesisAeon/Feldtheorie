# Governance Policy - output/frames/5a77d41a
...
This policy governs all work in `output/frames/5a77d41a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5a77d41a/.governance/incidents/`
