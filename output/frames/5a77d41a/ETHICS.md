# Ethics and Responsible Use - output/frames/5a77d41a
...
**In this directory (`output/frames/5a77d41a`), the following ethical rules apply:**
...
Before committing work in `output/frames/5a77d41a`:
