# Ethics and Responsible Use - output/frames/f0044873
...
**In this directory (`output/frames/f0044873`), the following ethical rules apply:**
...
Before committing work in `output/frames/f0044873`:
