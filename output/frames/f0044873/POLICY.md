# Governance Policy - output/frames/f0044873
...
This policy governs all work in `output/frames/f0044873` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f0044873/.governance/incidents/`
