# Governance Policy - output/frames/2f47a2d4
...
This policy governs all work in `output/frames/2f47a2d4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/2f47a2d4/.governance/incidents/`
