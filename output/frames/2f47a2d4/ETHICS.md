# Ethics and Responsible Use - output/frames/2f47a2d4
...
**In this directory (`output/frames/2f47a2d4`), the following ethical rules apply:**
...
Before committing work in `output/frames/2f47a2d4`:
