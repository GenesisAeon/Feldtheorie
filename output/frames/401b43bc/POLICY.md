# Governance Policy - output/frames/401b43bc
...
This policy governs all work in `output/frames/401b43bc` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/401b43bc/.governance/incidents/`
