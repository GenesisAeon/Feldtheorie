# Ethics and Responsible Use - output/frames/401b43bc
...
**In this directory (`output/frames/401b43bc`), the following ethical rules apply:**
...
Before committing work in `output/frames/401b43bc`:
