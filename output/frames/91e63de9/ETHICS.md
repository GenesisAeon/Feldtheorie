# Ethics and Responsible Use - output/frames/91e63de9
...
**In this directory (`output/frames/91e63de9`), the following ethical rules apply:**
...
Before committing work in `output/frames/91e63de9`:
