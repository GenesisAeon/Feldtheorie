# Governance Policy - output/frames/02151e38
...
This policy governs all work in `output/frames/02151e38` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/02151e38/.governance/incidents/`
