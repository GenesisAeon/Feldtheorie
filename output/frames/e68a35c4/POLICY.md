# Governance Policy - output/frames/e68a35c4
...
This policy governs all work in `output/frames/e68a35c4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e68a35c4/.governance/incidents/`
