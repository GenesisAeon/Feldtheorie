# Governance Policy - output/frames/1ddd04cc
...
This policy governs all work in `output/frames/1ddd04cc` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1ddd04cc/.governance/incidents/`
