# Ethics and Responsible Use - output/frames/1ddd04cc
...
**In this directory (`output/frames/1ddd04cc`), the following ethical rules apply:**
...
Before committing work in `output/frames/1ddd04cc`:
