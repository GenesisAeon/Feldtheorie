# Governance Policy - output/frames/a291f865
...
This policy governs all work in `output/frames/a291f865` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a291f865/.governance/incidents/`
