# Governance Policy - output/frames/c96e471d
...
This policy governs all work in `output/frames/c96e471d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c96e471d/.governance/incidents/`
