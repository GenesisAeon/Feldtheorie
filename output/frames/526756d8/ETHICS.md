# Ethics and Responsible Use - output/frames/526756d8
...
**In this directory (`output/frames/526756d8`), the following ethical rules apply:**
...
Before committing work in `output/frames/526756d8`:
