# Governance Policy - output/frames/526756d8
...
This policy governs all work in `output/frames/526756d8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/526756d8/.governance/incidents/`
