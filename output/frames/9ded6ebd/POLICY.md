# Governance Policy - output/frames/9ded6ebd
...
This policy governs all work in `output/frames/9ded6ebd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9ded6ebd/.governance/incidents/`
