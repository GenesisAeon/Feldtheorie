# Ethics and Responsible Use - output/frames/9ded6ebd
...
**In this directory (`output/frames/9ded6ebd`), the following ethical rules apply:**
...
Before committing work in `output/frames/9ded6ebd`:
