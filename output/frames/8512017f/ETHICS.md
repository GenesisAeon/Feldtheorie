# Ethics and Responsible Use - output/frames/8512017f
...
**In this directory (`output/frames/8512017f`), the following ethical rules apply:**
...
Before committing work in `output/frames/8512017f`:
