# Governance Policy - output/frames/8512017f
...
This policy governs all work in `output/frames/8512017f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8512017f/.governance/incidents/`
