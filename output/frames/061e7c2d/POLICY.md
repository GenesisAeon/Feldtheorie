# Governance Policy - output/frames/061e7c2d
...
This policy governs all work in `output/frames/061e7c2d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/061e7c2d/.governance/incidents/`
