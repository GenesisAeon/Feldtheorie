# Ethics and Responsible Use - output/frames/061e7c2d
...
**In this directory (`output/frames/061e7c2d`), the following ethical rules apply:**
...
Before committing work in `output/frames/061e7c2d`:
