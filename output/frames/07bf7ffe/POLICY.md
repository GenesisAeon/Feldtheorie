# Governance Policy - output/frames/07bf7ffe
...
This policy governs all work in `output/frames/07bf7ffe` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/07bf7ffe/.governance/incidents/`
