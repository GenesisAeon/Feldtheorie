# Ethics and Responsible Use - output/frames/07bf7ffe
...
**In this directory (`output/frames/07bf7ffe`), the following ethical rules apply:**
...
Before committing work in `output/frames/07bf7ffe`:
