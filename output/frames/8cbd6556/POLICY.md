# Governance Policy - output/frames/8cbd6556
...
This policy governs all work in `output/frames/8cbd6556` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8cbd6556/.governance/incidents/`
