# Ethics and Responsible Use - output/frames/8cbd6556
...
**In this directory (`output/frames/8cbd6556`), the following ethical rules apply:**
...
Before committing work in `output/frames/8cbd6556`:
