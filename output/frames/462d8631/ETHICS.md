# Ethics and Responsible Use - output/frames/462d8631
...
**In this directory (`output/frames/462d8631`), the following ethical rules apply:**
...
Before committing work in `output/frames/462d8631`:
