# Governance Policy - output/frames/462d8631
...
This policy governs all work in `output/frames/462d8631` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/462d8631/.governance/incidents/`
