# Ethics and Responsible Use - output/frames/6cb00bee
...
**In this directory (`output/frames/6cb00bee`), the following ethical rules apply:**
...
Before committing work in `output/frames/6cb00bee`:
