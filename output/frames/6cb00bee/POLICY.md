# Governance Policy - output/frames/6cb00bee
...
This policy governs all work in `output/frames/6cb00bee` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6cb00bee/.governance/incidents/`
