# Governance Policy - output/frames/58ec4dba
...
This policy governs all work in `output/frames/58ec4dba` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/58ec4dba/.governance/incidents/`
