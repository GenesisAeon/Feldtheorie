# Ethics and Responsible Use - output/frames/58ec4dba
...
**In this directory (`output/frames/58ec4dba`), the following ethical rules apply:**
...
Before committing work in `output/frames/58ec4dba`:
