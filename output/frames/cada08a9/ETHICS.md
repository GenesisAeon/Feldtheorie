# Ethics and Responsible Use - output/frames/cada08a9
...
**In this directory (`output/frames/cada08a9`), the following ethical rules apply:**
...
Before committing work in `output/frames/cada08a9`:
