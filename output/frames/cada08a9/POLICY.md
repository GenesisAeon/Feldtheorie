# Governance Policy - output/frames/cada08a9
...
This policy governs all work in `output/frames/cada08a9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/cada08a9/.governance/incidents/`
