# Governance Policy - output/frames/ab120474
...
This policy governs all work in `output/frames/ab120474` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ab120474/.governance/incidents/`
