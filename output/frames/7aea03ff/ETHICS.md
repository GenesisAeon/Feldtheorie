# Ethics and Responsible Use - output/frames/7aea03ff
...
**In this directory (`output/frames/7aea03ff`), the following ethical rules apply:**
...
Before committing work in `output/frames/7aea03ff`:
