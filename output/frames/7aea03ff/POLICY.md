# Governance Policy - output/frames/7aea03ff
...
This policy governs all work in `output/frames/7aea03ff` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7aea03ff/.governance/incidents/`
