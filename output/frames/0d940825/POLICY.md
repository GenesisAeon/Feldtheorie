# Governance Policy - output/frames/0d940825
...
This policy governs all work in `output/frames/0d940825` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0d940825/.governance/incidents/`
