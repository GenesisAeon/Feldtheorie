# Ethics and Responsible Use - output/frames/0d940825
...
**In this directory (`output/frames/0d940825`), the following ethical rules apply:**
...
Before committing work in `output/frames/0d940825`:
