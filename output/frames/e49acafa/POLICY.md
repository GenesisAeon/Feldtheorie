# Governance Policy - output/frames/e49acafa
...
This policy governs all work in `output/frames/e49acafa` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e49acafa/.governance/incidents/`
