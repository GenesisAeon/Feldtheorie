# Ethics and Responsible Use - output/frames/e49acafa
...
**In this directory (`output/frames/e49acafa`), the following ethical rules apply:**
...
Before committing work in `output/frames/e49acafa`:
