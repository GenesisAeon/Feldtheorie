# Ethics and Responsible Use - output/frames/e99177e8
...
**In this directory (`output/frames/e99177e8`), the following ethical rules apply:**
...
Before committing work in `output/frames/e99177e8`:
