# Governance Policy - output/frames/e99177e8
...
This policy governs all work in `output/frames/e99177e8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e99177e8/.governance/incidents/`
