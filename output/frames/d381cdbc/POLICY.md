# Governance Policy - output/frames/d381cdbc
...
This policy governs all work in `output/frames/d381cdbc` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d381cdbc/.governance/incidents/`
