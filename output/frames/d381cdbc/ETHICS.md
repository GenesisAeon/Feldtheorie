# Ethics and Responsible Use - output/frames/d381cdbc
...
**In this directory (`output/frames/d381cdbc`), the following ethical rules apply:**
...
Before committing work in `output/frames/d381cdbc`:
