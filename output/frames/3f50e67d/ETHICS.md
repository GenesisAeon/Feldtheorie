# Ethics and Responsible Use - output/frames/3f50e67d
...
**In this directory (`output/frames/3f50e67d`), the following ethical rules apply:**
...
Before committing work in `output/frames/3f50e67d`:
