# Governance Policy - output/frames/3f50e67d
...
This policy governs all work in `output/frames/3f50e67d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3f50e67d/.governance/incidents/`
