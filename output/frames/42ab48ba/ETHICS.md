# Ethics and Responsible Use - output/frames/42ab48ba
...
**In this directory (`output/frames/42ab48ba`), the following ethical rules apply:**
...
Before committing work in `output/frames/42ab48ba`:
