# Governance Policy - output/frames/42ab48ba
...
This policy governs all work in `output/frames/42ab48ba` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/42ab48ba/.governance/incidents/`
