# Ethics and Responsible Use - output/frames/5ce1cadd
...
**In this directory (`output/frames/5ce1cadd`), the following ethical rules apply:**
...
Before committing work in `output/frames/5ce1cadd`:
