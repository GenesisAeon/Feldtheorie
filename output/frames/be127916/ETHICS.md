# Ethics and Responsible Use - output/frames/be127916
...
**In this directory (`output/frames/be127916`), the following ethical rules apply:**
...
Before committing work in `output/frames/be127916`:
