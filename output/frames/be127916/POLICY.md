# Governance Policy - output/frames/be127916
...
This policy governs all work in `output/frames/be127916` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/be127916/.governance/incidents/`
