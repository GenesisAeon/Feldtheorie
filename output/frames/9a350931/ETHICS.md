# Ethics and Responsible Use - output/frames/9a350931
...
**In this directory (`output/frames/9a350931`), the following ethical rules apply:**
...
Before committing work in `output/frames/9a350931`:
