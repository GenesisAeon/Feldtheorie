# Governance Policy - output/frames/9a350931
...
This policy governs all work in `output/frames/9a350931` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9a350931/.governance/incidents/`
