# Governance Policy - output/frames/c9389b06
...
This policy governs all work in `output/frames/c9389b06` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c9389b06/.governance/incidents/`
