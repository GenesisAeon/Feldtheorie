# Ethics and Responsible Use - output/frames/be9310c5
...
**In this directory (`output/frames/be9310c5`), the following ethical rules apply:**
...
Before committing work in `output/frames/be9310c5`:
