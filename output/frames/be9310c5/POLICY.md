# Governance Policy - output/frames/be9310c5
...
This policy governs all work in `output/frames/be9310c5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/be9310c5/.governance/incidents/`
