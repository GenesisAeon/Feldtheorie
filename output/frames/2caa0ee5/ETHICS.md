# Ethics and Responsible Use - output/frames/2caa0ee5
...
**In this directory (`output/frames/2caa0ee5`), the following ethical rules apply:**
...
Before committing work in `output/frames/2caa0ee5`:
