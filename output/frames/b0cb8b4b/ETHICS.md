# Ethics and Responsible Use - output/frames/b0cb8b4b
...
**In this directory (`output/frames/b0cb8b4b`), the following ethical rules apply:**
...
Before committing work in `output/frames/b0cb8b4b`:
