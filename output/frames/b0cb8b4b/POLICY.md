# Governance Policy - output/frames/b0cb8b4b
...
This policy governs all work in `output/frames/b0cb8b4b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b0cb8b4b/.governance/incidents/`
