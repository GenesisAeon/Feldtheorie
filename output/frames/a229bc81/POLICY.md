# Governance Policy - output/frames/a229bc81
...
This policy governs all work in `output/frames/a229bc81` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a229bc81/.governance/incidents/`
