# Ethics and Responsible Use - output/frames/b281d2b3
...
**In this directory (`output/frames/b281d2b3`), the following ethical rules apply:**
...
Before committing work in `output/frames/b281d2b3`:
