# Governance Policy - output/frames/b281d2b3
...
This policy governs all work in `output/frames/b281d2b3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b281d2b3/.governance/incidents/`
