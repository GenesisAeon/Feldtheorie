# Ethics and Responsible Use - output/frames/63e9e9cd
...
**In this directory (`output/frames/63e9e9cd`), the following ethical rules apply:**
...
Before committing work in `output/frames/63e9e9cd`:
