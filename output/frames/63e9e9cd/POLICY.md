# Governance Policy - output/frames/63e9e9cd
...
This policy governs all work in `output/frames/63e9e9cd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/63e9e9cd/.governance/incidents/`
