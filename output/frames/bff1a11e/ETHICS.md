# Ethics and Responsible Use - output/frames/bff1a11e
...
**In this directory (`output/frames/bff1a11e`), the following ethical rules apply:**
...
Before committing work in `output/frames/bff1a11e`:
