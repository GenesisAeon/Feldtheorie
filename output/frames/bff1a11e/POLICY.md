# Governance Policy - output/frames/bff1a11e
...
This policy governs all work in `output/frames/bff1a11e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bff1a11e/.governance/incidents/`
