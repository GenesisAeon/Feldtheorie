# Ethics and Responsible Use - output/frames/5d0e4473
...
**In this directory (`output/frames/5d0e4473`), the following ethical rules apply:**
...
Before committing work in `output/frames/5d0e4473`:
