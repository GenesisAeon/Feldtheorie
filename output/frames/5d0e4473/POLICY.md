# Governance Policy - output/frames/5d0e4473
...
This policy governs all work in `output/frames/5d0e4473` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5d0e4473/.governance/incidents/`
