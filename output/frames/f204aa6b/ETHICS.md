# Ethics and Responsible Use - output/frames/f204aa6b
...
**In this directory (`output/frames/f204aa6b`), the following ethical rules apply:**
...
Before committing work in `output/frames/f204aa6b`:
