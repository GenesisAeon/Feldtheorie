# Governance Policy - output/frames/f204aa6b
...
This policy governs all work in `output/frames/f204aa6b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f204aa6b/.governance/incidents/`
