# Governance Policy - output/frames/26639185
...
This policy governs all work in `output/frames/26639185` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/26639185/.governance/incidents/`
