# Governance Policy - output/frames/4ee3441b
...
This policy governs all work in `output/frames/4ee3441b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4ee3441b/.governance/incidents/`
