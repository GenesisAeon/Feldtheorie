# Ethics and Responsible Use - output/frames/4ee3441b
...
**In this directory (`output/frames/4ee3441b`), the following ethical rules apply:**
...
Before committing work in `output/frames/4ee3441b`:
