# Governance Policy - output/frames/b2489874
...
This policy governs all work in `output/frames/b2489874` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b2489874/.governance/incidents/`
