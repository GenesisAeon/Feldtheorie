# Governance Policy - output/frames/bc2cc958
...
This policy governs all work in `output/frames/bc2cc958` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bc2cc958/.governance/incidents/`
