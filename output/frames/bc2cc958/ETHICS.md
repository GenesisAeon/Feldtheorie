# Ethics and Responsible Use - output/frames/bc2cc958
...
**In this directory (`output/frames/bc2cc958`), the following ethical rules apply:**
...
Before committing work in `output/frames/bc2cc958`:
