# Ethics and Responsible Use - output/frames/64ff52eb
...
**In this directory (`output/frames/64ff52eb`), the following ethical rules apply:**
...
Before committing work in `output/frames/64ff52eb`:
