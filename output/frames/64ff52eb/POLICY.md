# Governance Policy - output/frames/64ff52eb
...
This policy governs all work in `output/frames/64ff52eb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/64ff52eb/.governance/incidents/`
