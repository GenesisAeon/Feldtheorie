# Ethics and Responsible Use - output/frames/66992dcd
...
**In this directory (`output/frames/66992dcd`), the following ethical rules apply:**
...
Before committing work in `output/frames/66992dcd`:
