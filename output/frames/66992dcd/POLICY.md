# Governance Policy - output/frames/66992dcd
...
This policy governs all work in `output/frames/66992dcd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/66992dcd/.governance/incidents/`
