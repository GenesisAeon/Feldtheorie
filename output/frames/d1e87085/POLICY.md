# Governance Policy - output/frames/d1e87085
...
This policy governs all work in `output/frames/d1e87085` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d1e87085/.governance/incidents/`
