# Ethics and Responsible Use - output/frames/d1e87085
...
**In this directory (`output/frames/d1e87085`), the following ethical rules apply:**
...
Before committing work in `output/frames/d1e87085`:
