# Ethics and Responsible Use - output/frames/aa805de8
...
**In this directory (`output/frames/aa805de8`), the following ethical rules apply:**
...
Before committing work in `output/frames/aa805de8`:
