# Governance Policy - output/frames/aa805de8
...
This policy governs all work in `output/frames/aa805de8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/aa805de8/.governance/incidents/`
