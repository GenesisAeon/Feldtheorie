# Governance Policy - output/frames/d26b739a
...
This policy governs all work in `output/frames/d26b739a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d26b739a/.governance/incidents/`
