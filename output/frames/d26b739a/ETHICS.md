# Ethics and Responsible Use - output/frames/d26b739a
...
**In this directory (`output/frames/d26b739a`), the following ethical rules apply:**
...
Before committing work in `output/frames/d26b739a`:
