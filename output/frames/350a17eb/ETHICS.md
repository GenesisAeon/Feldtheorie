# Ethics and Responsible Use - output/frames/350a17eb
...
**In this directory (`output/frames/350a17eb`), the following ethical rules apply:**
...
Before committing work in `output/frames/350a17eb`:
