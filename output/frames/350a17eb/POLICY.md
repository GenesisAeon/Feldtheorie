# Governance Policy - output/frames/350a17eb
...
This policy governs all work in `output/frames/350a17eb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/350a17eb/.governance/incidents/`
