# Governance Policy - output/frames/fbadc354
...
This policy governs all work in `output/frames/fbadc354` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/fbadc354/.governance/incidents/`
