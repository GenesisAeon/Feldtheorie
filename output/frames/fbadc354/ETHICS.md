# Ethics and Responsible Use - output/frames/fbadc354
...
**In this directory (`output/frames/fbadc354`), the following ethical rules apply:**
...
Before committing work in `output/frames/fbadc354`:
