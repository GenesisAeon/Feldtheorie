# Ethics and Responsible Use - output/frames/f82b7ee9
...
**In this directory (`output/frames/f82b7ee9`), the following ethical rules apply:**
...
Before committing work in `output/frames/f82b7ee9`:
