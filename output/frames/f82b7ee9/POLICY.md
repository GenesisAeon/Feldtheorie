# Governance Policy - output/frames/f82b7ee9
...
This policy governs all work in `output/frames/f82b7ee9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f82b7ee9/.governance/incidents/`
