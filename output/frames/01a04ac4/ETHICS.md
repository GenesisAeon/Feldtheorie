# Ethics and Responsible Use - output/frames/01a04ac4
...
**In this directory (`output/frames/01a04ac4`), the following ethical rules apply:**
...
Before committing work in `output/frames/01a04ac4`:
