# Governance Policy - output/frames/01a04ac4
...
This policy governs all work in `output/frames/01a04ac4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/01a04ac4/.governance/incidents/`
