# Ethics and Responsible Use - output/frames/124b32a2
...
**In this directory (`output/frames/124b32a2`), the following ethical rules apply:**
...
Before committing work in `output/frames/124b32a2`:
