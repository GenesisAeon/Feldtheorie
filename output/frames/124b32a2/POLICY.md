# Governance Policy - output/frames/124b32a2
...
This policy governs all work in `output/frames/124b32a2` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/124b32a2/.governance/incidents/`
