# Ethics and Responsible Use - output/frames/de0caa7b
...
**In this directory (`output/frames/de0caa7b`), the following ethical rules apply:**
...
Before committing work in `output/frames/de0caa7b`:
