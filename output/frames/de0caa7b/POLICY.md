# Governance Policy - output/frames/de0caa7b
...
This policy governs all work in `output/frames/de0caa7b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/de0caa7b/.governance/incidents/`
