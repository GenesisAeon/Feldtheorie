# Governance Policy - output/frames/1931e24c
...
This policy governs all work in `output/frames/1931e24c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1931e24c/.governance/incidents/`
