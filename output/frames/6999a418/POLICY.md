# Governance Policy - output/frames/6999a418
...
This policy governs all work in `output/frames/6999a418` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6999a418/.governance/incidents/`
