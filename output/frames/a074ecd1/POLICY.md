# Governance Policy - output/frames/a074ecd1
...
This policy governs all work in `output/frames/a074ecd1` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a074ecd1/.governance/incidents/`
