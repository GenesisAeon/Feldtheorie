# Ethics and Responsible Use - output/frames/a074ecd1
...
**In this directory (`output/frames/a074ecd1`), the following ethical rules apply:**
...
Before committing work in `output/frames/a074ecd1`:
