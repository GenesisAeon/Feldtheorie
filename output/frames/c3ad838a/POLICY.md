# Governance Policy - output/frames/c3ad838a
...
This policy governs all work in `output/frames/c3ad838a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c3ad838a/.governance/incidents/`
