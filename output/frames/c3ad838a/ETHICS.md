# Ethics and Responsible Use - output/frames/c3ad838a
...
**In this directory (`output/frames/c3ad838a`), the following ethical rules apply:**
...
Before committing work in `output/frames/c3ad838a`:
