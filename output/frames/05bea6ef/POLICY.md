# Governance Policy - output/frames/05bea6ef
...
This policy governs all work in `output/frames/05bea6ef` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/05bea6ef/.governance/incidents/`
