# Ethics and Responsible Use - output/frames/05bea6ef
...
**In this directory (`output/frames/05bea6ef`), the following ethical rules apply:**
...
Before committing work in `output/frames/05bea6ef`:
