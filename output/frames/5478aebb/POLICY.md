# Governance Policy - output/frames/5478aebb
...
This policy governs all work in `output/frames/5478aebb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5478aebb/.governance/incidents/`
