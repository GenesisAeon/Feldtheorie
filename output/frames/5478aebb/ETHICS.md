# Ethics and Responsible Use - output/frames/5478aebb
...
**In this directory (`output/frames/5478aebb`), the following ethical rules apply:**
...
Before committing work in `output/frames/5478aebb`:
