# Ethics and Responsible Use - output/frames/5fa70b74
...
**In this directory (`output/frames/5fa70b74`), the following ethical rules apply:**
...
Before committing work in `output/frames/5fa70b74`:
