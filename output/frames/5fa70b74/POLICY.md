# Governance Policy - output/frames/5fa70b74
...
This policy governs all work in `output/frames/5fa70b74` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5fa70b74/.governance/incidents/`
