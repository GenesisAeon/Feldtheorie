# Governance Policy - output/frames/11967018
...
This policy governs all work in `output/frames/11967018` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/11967018/.governance/incidents/`
