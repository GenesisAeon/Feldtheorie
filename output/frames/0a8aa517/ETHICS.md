# Ethics and Responsible Use - output/frames/0a8aa517
...
**In this directory (`output/frames/0a8aa517`), the following ethical rules apply:**
...
Before committing work in `output/frames/0a8aa517`:
