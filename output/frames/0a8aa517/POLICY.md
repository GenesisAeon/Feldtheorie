# Governance Policy - output/frames/0a8aa517
...
This policy governs all work in `output/frames/0a8aa517` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0a8aa517/.governance/incidents/`
