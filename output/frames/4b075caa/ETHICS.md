# Ethics and Responsible Use - output/frames/4b075caa
...
**In this directory (`output/frames/4b075caa`), the following ethical rules apply:**
...
Before committing work in `output/frames/4b075caa`:
