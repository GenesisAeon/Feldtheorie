# Governance Policy - output/frames/4b075caa
...
This policy governs all work in `output/frames/4b075caa` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4b075caa/.governance/incidents/`
