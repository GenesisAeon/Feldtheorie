# Governance Policy - output/frames/c03a1f4a
...
This policy governs all work in `output/frames/c03a1f4a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c03a1f4a/.governance/incidents/`
