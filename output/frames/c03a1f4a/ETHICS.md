# Ethics and Responsible Use - output/frames/c03a1f4a
...
**In this directory (`output/frames/c03a1f4a`), the following ethical rules apply:**
...
Before committing work in `output/frames/c03a1f4a`:
