# Ethics and Responsible Use - output/frames/8a892347
...
**In this directory (`output/frames/8a892347`), the following ethical rules apply:**
...
Before committing work in `output/frames/8a892347`:
