# Governance Policy - output/frames/8a892347
...
This policy governs all work in `output/frames/8a892347` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8a892347/.governance/incidents/`
