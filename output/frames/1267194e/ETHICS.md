# Ethics and Responsible Use - output/frames/1267194e
...
**In this directory (`output/frames/1267194e`), the following ethical rules apply:**
...
Before committing work in `output/frames/1267194e`:
