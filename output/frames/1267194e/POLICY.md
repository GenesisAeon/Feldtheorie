# Governance Policy - output/frames/1267194e
...
This policy governs all work in `output/frames/1267194e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1267194e/.governance/incidents/`
