# Ethics and Responsible Use - output/frames/945ffc19
...
**In this directory (`output/frames/945ffc19`), the following ethical rules apply:**
...
Before committing work in `output/frames/945ffc19`:
