# Governance Policy - output/frames/945ffc19
...
This policy governs all work in `output/frames/945ffc19` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/945ffc19/.governance/incidents/`
