# Ethics and Responsible Use - output/frames/232b0488
...
**In this directory (`output/frames/232b0488`), the following ethical rules apply:**
...
Before committing work in `output/frames/232b0488`:
