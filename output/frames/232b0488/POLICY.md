# Governance Policy - output/frames/232b0488
...
This policy governs all work in `output/frames/232b0488` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/232b0488/.governance/incidents/`
