# Ethics and Responsible Use - output/frames/524fa774
...
**In this directory (`output/frames/524fa774`), the following ethical rules apply:**
...
Before committing work in `output/frames/524fa774`:
