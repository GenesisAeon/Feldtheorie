# Governance Policy - output/frames/524fa774
...
This policy governs all work in `output/frames/524fa774` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/524fa774/.governance/incidents/`
