# Ethics and Responsible Use - output/frames/dac00eb3
...
**In this directory (`output/frames/dac00eb3`), the following ethical rules apply:**
...
Before committing work in `output/frames/dac00eb3`:
