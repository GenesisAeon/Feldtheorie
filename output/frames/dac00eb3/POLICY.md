# Governance Policy - output/frames/dac00eb3
...
This policy governs all work in `output/frames/dac00eb3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/dac00eb3/.governance/incidents/`
