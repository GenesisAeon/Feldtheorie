# Ethics and Responsible Use - output/frames/b68e9bf8
...
**In this directory (`output/frames/b68e9bf8`), the following ethical rules apply:**
...
Before committing work in `output/frames/b68e9bf8`:
