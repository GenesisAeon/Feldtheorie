# Governance Policy - output/frames/b68e9bf8
...
This policy governs all work in `output/frames/b68e9bf8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b68e9bf8/.governance/incidents/`
