# Ethics and Responsible Use - output/frames/f135144e
...
**In this directory (`output/frames/f135144e`), the following ethical rules apply:**
...
Before committing work in `output/frames/f135144e`:
