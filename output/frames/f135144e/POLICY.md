# Governance Policy - output/frames/f135144e
...
This policy governs all work in `output/frames/f135144e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f135144e/.governance/incidents/`
