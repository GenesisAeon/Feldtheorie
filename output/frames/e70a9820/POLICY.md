# Governance Policy - output/frames/e70a9820
...
This policy governs all work in `output/frames/e70a9820` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e70a9820/.governance/incidents/`
