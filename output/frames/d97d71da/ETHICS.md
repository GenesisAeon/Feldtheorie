# Ethics and Responsible Use - output/frames/d97d71da
...
**In this directory (`output/frames/d97d71da`), the following ethical rules apply:**
...
Before committing work in `output/frames/d97d71da`:
