# Governance Policy - output/frames/d97d71da
...
This policy governs all work in `output/frames/d97d71da` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d97d71da/.governance/incidents/`
