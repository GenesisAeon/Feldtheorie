# Governance Policy - output/frames/88e94710
...
This policy governs all work in `output/frames/88e94710` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/88e94710/.governance/incidents/`
