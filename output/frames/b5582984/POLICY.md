# Governance Policy - output/frames/b5582984
...
This policy governs all work in `output/frames/b5582984` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b5582984/.governance/incidents/`
