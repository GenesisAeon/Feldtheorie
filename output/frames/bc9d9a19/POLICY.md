# Governance Policy - output/frames/bc9d9a19
...
This policy governs all work in `output/frames/bc9d9a19` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bc9d9a19/.governance/incidents/`
