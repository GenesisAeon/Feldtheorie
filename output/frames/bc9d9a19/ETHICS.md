# Ethics and Responsible Use - output/frames/bc9d9a19
...
**In this directory (`output/frames/bc9d9a19`), the following ethical rules apply:**
...
Before committing work in `output/frames/bc9d9a19`:
