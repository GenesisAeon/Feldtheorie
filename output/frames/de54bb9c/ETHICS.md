# Ethics and Responsible Use - output/frames/de54bb9c
...
**In this directory (`output/frames/de54bb9c`), the following ethical rules apply:**
...
Before committing work in `output/frames/de54bb9c`:
