# Governance Policy - output/frames/de54bb9c
...
This policy governs all work in `output/frames/de54bb9c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/de54bb9c/.governance/incidents/`
