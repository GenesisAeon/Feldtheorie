# Ethics and Responsible Use - output/frames/e7a132e9
...
**In this directory (`output/frames/e7a132e9`), the following ethical rules apply:**
...
Before committing work in `output/frames/e7a132e9`:
