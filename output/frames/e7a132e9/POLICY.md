# Governance Policy - output/frames/e7a132e9
...
This policy governs all work in `output/frames/e7a132e9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e7a132e9/.governance/incidents/`
