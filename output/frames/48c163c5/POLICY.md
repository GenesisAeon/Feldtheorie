# Governance Policy - output/frames/48c163c5
...
This policy governs all work in `output/frames/48c163c5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/48c163c5/.governance/incidents/`
