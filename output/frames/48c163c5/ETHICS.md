# Ethics and Responsible Use - output/frames/48c163c5
...
**In this directory (`output/frames/48c163c5`), the following ethical rules apply:**
...
Before committing work in `output/frames/48c163c5`:
