# Ethics and Responsible Use - output/frames/5d263a51
...
**In this directory (`output/frames/5d263a51`), the following ethical rules apply:**
...
Before committing work in `output/frames/5d263a51`:
