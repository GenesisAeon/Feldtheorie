# Governance Policy - output/frames/5d263a51
...
This policy governs all work in `output/frames/5d263a51` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5d263a51/.governance/incidents/`
