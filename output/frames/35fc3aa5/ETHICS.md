# Ethics and Responsible Use - output/frames/35fc3aa5
...
**In this directory (`output/frames/35fc3aa5`), the following ethical rules apply:**
...
Before committing work in `output/frames/35fc3aa5`:
