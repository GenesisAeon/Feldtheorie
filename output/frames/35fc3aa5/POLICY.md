# Governance Policy - output/frames/35fc3aa5
...
This policy governs all work in `output/frames/35fc3aa5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/35fc3aa5/.governance/incidents/`
