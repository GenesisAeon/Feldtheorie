# Governance Policy - output/frames/4982073d
...
This policy governs all work in `output/frames/4982073d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4982073d/.governance/incidents/`
