# Ethics and Responsible Use - output/frames/4982073d
...
**In this directory (`output/frames/4982073d`), the following ethical rules apply:**
...
Before committing work in `output/frames/4982073d`:
