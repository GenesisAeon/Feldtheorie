# Governance Policy - output/frames/13a51a80
...
This policy governs all work in `output/frames/13a51a80` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/13a51a80/.governance/incidents/`
