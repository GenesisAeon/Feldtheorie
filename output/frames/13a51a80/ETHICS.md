# Ethics and Responsible Use - output/frames/13a51a80
...
**In this directory (`output/frames/13a51a80`), the following ethical rules apply:**
...
Before committing work in `output/frames/13a51a80`:
