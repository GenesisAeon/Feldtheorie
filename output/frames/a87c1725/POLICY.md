# Governance Policy - output/frames/a87c1725
...
This policy governs all work in `output/frames/a87c1725` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a87c1725/.governance/incidents/`
