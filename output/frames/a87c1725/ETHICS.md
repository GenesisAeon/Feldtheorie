# Ethics and Responsible Use - output/frames/a87c1725
...
**In this directory (`output/frames/a87c1725`), the following ethical rules apply:**
...
Before committing work in `output/frames/a87c1725`:
