# Ethics and Responsible Use - output/frames/ec4f2e3e
...
**In this directory (`output/frames/ec4f2e3e`), the following ethical rules apply:**
...
Before committing work in `output/frames/ec4f2e3e`:
