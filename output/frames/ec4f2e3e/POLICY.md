# Governance Policy - output/frames/ec4f2e3e
...
This policy governs all work in `output/frames/ec4f2e3e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ec4f2e3e/.governance/incidents/`
