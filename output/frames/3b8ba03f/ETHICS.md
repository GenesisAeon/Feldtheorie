# Ethics and Responsible Use - output/frames/3b8ba03f
...
**In this directory (`output/frames/3b8ba03f`), the following ethical rules apply:**
...
Before committing work in `output/frames/3b8ba03f`:
