# Governance Policy - output/frames/3b8ba03f
...
This policy governs all work in `output/frames/3b8ba03f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3b8ba03f/.governance/incidents/`
