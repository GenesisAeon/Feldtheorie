# Ethics and Responsible Use - output/frames/80aad629
...
**In this directory (`output/frames/80aad629`), the following ethical rules apply:**
...
Before committing work in `output/frames/80aad629`:
