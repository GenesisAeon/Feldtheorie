# Governance Policy - output/frames/80aad629
...
This policy governs all work in `output/frames/80aad629` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/80aad629/.governance/incidents/`
