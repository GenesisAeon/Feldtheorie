# Governance Policy - output/frames/f3521140
...
This policy governs all work in `output/frames/f3521140` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f3521140/.governance/incidents/`
