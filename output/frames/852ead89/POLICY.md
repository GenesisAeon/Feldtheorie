# Governance Policy - output/frames/852ead89
...
This policy governs all work in `output/frames/852ead89` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/852ead89/.governance/incidents/`
