# Ethics and Responsible Use - output/frames/852ead89
...
**In this directory (`output/frames/852ead89`), the following ethical rules apply:**
...
Before committing work in `output/frames/852ead89`:
