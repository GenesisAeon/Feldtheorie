# Governance Policy - output/frames/fffac907
...
This policy governs all work in `output/frames/fffac907` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/fffac907/.governance/incidents/`
