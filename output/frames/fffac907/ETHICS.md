# Ethics and Responsible Use - output/frames/fffac907
...
**In this directory (`output/frames/fffac907`), the following ethical rules apply:**
...
Before committing work in `output/frames/fffac907`:
