# Ethics and Responsible Use - output/frames/2249eaff
...
**In this directory (`output/frames/2249eaff`), the following ethical rules apply:**
...
Before committing work in `output/frames/2249eaff`:
