# Governance Policy - output/frames/2249eaff
...
This policy governs all work in `output/frames/2249eaff` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/2249eaff/.governance/incidents/`
