# Ethics and Responsible Use - output/frames/642ff5f8
...
**In this directory (`output/frames/642ff5f8`), the following ethical rules apply:**
...
Before committing work in `output/frames/642ff5f8`:
