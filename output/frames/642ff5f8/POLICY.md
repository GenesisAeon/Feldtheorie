# Governance Policy - output/frames/642ff5f8
...
This policy governs all work in `output/frames/642ff5f8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/642ff5f8/.governance/incidents/`
