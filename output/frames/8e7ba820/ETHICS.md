# Ethics and Responsible Use - output/frames/8e7ba820
...
**In this directory (`output/frames/8e7ba820`), the following ethical rules apply:**
...
Before committing work in `output/frames/8e7ba820`:
