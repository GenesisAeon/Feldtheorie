# Governance Policy - output/frames/8e7ba820
...
This policy governs all work in `output/frames/8e7ba820` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8e7ba820/.governance/incidents/`
