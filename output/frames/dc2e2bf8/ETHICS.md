# Ethics and Responsible Use - output/frames/dc2e2bf8
...
**In this directory (`output/frames/dc2e2bf8`), the following ethical rules apply:**
...
Before committing work in `output/frames/dc2e2bf8`:
