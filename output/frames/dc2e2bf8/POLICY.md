# Governance Policy - output/frames/dc2e2bf8
...
This policy governs all work in `output/frames/dc2e2bf8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/dc2e2bf8/.governance/incidents/`
