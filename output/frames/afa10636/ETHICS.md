# Ethics and Responsible Use - output/frames/afa10636
...
**In this directory (`output/frames/afa10636`), the following ethical rules apply:**
...
Before committing work in `output/frames/afa10636`:
