# Governance Policy - output/frames/afa10636
...
This policy governs all work in `output/frames/afa10636` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/afa10636/.governance/incidents/`
