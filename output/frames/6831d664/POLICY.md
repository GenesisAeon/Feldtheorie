# Governance Policy - output/frames/6831d664
...
This policy governs all work in `output/frames/6831d664` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6831d664/.governance/incidents/`
