# Ethics and Responsible Use - output/frames/0f606c92
...
**In this directory (`output/frames/0f606c92`), the following ethical rules apply:**
...
Before committing work in `output/frames/0f606c92`:
