# Governance Policy - output/frames/0f606c92
...
This policy governs all work in `output/frames/0f606c92` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0f606c92/.governance/incidents/`
