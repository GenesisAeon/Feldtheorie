# Ethics and Responsible Use - output/frames/0001fe05
...
**In this directory (`output/frames/0001fe05`), the following ethical rules apply:**
...
Before committing work in `output/frames/0001fe05`:
