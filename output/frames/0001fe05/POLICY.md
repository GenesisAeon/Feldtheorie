# Governance Policy - output/frames/0001fe05
...
This policy governs all work in `output/frames/0001fe05` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0001fe05/.governance/incidents/`
