# Ethics and Responsible Use - output/frames/cbd7de0b
...
**In this directory (`output/frames/cbd7de0b`), the following ethical rules apply:**
...
Before committing work in `output/frames/cbd7de0b`:
