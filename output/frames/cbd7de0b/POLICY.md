# Governance Policy - output/frames/cbd7de0b
...
This policy governs all work in `output/frames/cbd7de0b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/cbd7de0b/.governance/incidents/`
