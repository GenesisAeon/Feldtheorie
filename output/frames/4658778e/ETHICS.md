# Ethics and Responsible Use - output/frames/4658778e
...
**In this directory (`output/frames/4658778e`), the following ethical rules apply:**
...
Before committing work in `output/frames/4658778e`:
