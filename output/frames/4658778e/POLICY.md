# Governance Policy - output/frames/4658778e
...
This policy governs all work in `output/frames/4658778e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4658778e/.governance/incidents/`
