# Governance Policy - output/frames/55d4219d
...
This policy governs all work in `output/frames/55d4219d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/55d4219d/.governance/incidents/`
