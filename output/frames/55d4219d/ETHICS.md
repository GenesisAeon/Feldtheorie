# Ethics and Responsible Use - output/frames/55d4219d
...
**In this directory (`output/frames/55d4219d`), the following ethical rules apply:**
...
Before committing work in `output/frames/55d4219d`:
