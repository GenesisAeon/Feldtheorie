# Governance Policy - output/frames/f1796099
...
This policy governs all work in `output/frames/f1796099` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f1796099/.governance/incidents/`
