# Governance Policy - output/frames/0dc9619f
...
This policy governs all work in `output/frames/0dc9619f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0dc9619f/.governance/incidents/`
