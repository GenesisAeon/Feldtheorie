# Ethics and Responsible Use - output/frames/0dc9619f
...
**In this directory (`output/frames/0dc9619f`), the following ethical rules apply:**
...
Before committing work in `output/frames/0dc9619f`:
