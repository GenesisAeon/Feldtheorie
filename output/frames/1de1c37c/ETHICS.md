# Ethics and Responsible Use - output/frames/1de1c37c
...
**In this directory (`output/frames/1de1c37c`), the following ethical rules apply:**
...
Before committing work in `output/frames/1de1c37c`:
