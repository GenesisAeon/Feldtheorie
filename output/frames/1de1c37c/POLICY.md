# Governance Policy - output/frames/1de1c37c
...
This policy governs all work in `output/frames/1de1c37c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1de1c37c/.governance/incidents/`
