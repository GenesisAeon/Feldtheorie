# Governance Policy - output/frames/5bbd69c0
...
This policy governs all work in `output/frames/5bbd69c0` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5bbd69c0/.governance/incidents/`
