# Ethics and Responsible Use - output/frames/5bbd69c0
...
**In this directory (`output/frames/5bbd69c0`), the following ethical rules apply:**
...
Before committing work in `output/frames/5bbd69c0`:
