# Governance Policy - output/frames/a373a733
...
This policy governs all work in `output/frames/a373a733` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a373a733/.governance/incidents/`
