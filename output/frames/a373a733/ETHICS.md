# Ethics and Responsible Use - output/frames/a373a733
...
**In this directory (`output/frames/a373a733`), the following ethical rules apply:**
...
Before committing work in `output/frames/a373a733`:
