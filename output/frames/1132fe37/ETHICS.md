# Ethics and Responsible Use - output/frames/1132fe37
...
**In this directory (`output/frames/1132fe37`), the following ethical rules apply:**
...
Before committing work in `output/frames/1132fe37`:
