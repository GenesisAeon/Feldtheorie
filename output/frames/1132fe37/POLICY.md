# Governance Policy - output/frames/1132fe37
...
This policy governs all work in `output/frames/1132fe37` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1132fe37/.governance/incidents/`
