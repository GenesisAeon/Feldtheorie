# Ethics and Responsible Use - output/frames/9959295f
...
**In this directory (`output/frames/9959295f`), the following ethical rules apply:**
...
Before committing work in `output/frames/9959295f`:
