# Governance Policy - output/frames/9959295f
...
This policy governs all work in `output/frames/9959295f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9959295f/.governance/incidents/`
