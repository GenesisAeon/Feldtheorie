# Governance Policy - output/frames/a5b968da
...
This policy governs all work in `output/frames/a5b968da` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a5b968da/.governance/incidents/`
