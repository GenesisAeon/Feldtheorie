# Ethics and Responsible Use - output/frames/a5b968da
...
**In this directory (`output/frames/a5b968da`), the following ethical rules apply:**
...
Before committing work in `output/frames/a5b968da`:
