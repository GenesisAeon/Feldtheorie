# Ethics and Responsible Use - output/frames/eb23160b
...
**In this directory (`output/frames/eb23160b`), the following ethical rules apply:**
...
Before committing work in `output/frames/eb23160b`:
