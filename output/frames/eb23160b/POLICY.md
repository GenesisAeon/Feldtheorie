# Governance Policy - output/frames/eb23160b
...
This policy governs all work in `output/frames/eb23160b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/eb23160b/.governance/incidents/`
