# Ethics and Responsible Use - output/frames/7957c8e8
...
**In this directory (`output/frames/7957c8e8`), the following ethical rules apply:**
...
Before committing work in `output/frames/7957c8e8`:
