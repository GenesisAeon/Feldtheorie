# Governance Policy - output/frames/19cae7b5
...
This policy governs all work in `output/frames/19cae7b5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/19cae7b5/.governance/incidents/`
