# Ethics and Responsible Use - output/frames/19cae7b5
...
**In this directory (`output/frames/19cae7b5`), the following ethical rules apply:**
...
Before committing work in `output/frames/19cae7b5`:
