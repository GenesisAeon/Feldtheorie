# Governance Policy - output/frames/b209546f
...
This policy governs all work in `output/frames/b209546f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b209546f/.governance/incidents/`
