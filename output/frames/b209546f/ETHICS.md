# Ethics and Responsible Use - output/frames/b209546f
...
**In this directory (`output/frames/b209546f`), the following ethical rules apply:**
...
Before committing work in `output/frames/b209546f`:
