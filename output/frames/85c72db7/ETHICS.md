# Ethics and Responsible Use - output/frames/85c72db7
...
**In this directory (`output/frames/85c72db7`), the following ethical rules apply:**
...
Before committing work in `output/frames/85c72db7`:
