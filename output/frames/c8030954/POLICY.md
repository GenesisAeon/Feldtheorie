# Governance Policy - output/frames/c8030954
...
This policy governs all work in `output/frames/c8030954` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c8030954/.governance/incidents/`
