# Ethics and Responsible Use - output/frames/9b2831ff
...
**In this directory (`output/frames/9b2831ff`), the following ethical rules apply:**
...
Before committing work in `output/frames/9b2831ff`:
