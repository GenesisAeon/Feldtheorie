# Governance Policy - output/frames/9b2831ff
...
This policy governs all work in `output/frames/9b2831ff` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9b2831ff/.governance/incidents/`
