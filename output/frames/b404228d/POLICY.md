# Governance Policy - output/frames/b404228d
...
This policy governs all work in `output/frames/b404228d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b404228d/.governance/incidents/`
