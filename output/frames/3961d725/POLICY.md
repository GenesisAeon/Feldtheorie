# Governance Policy - output/frames/3961d725
...
This policy governs all work in `output/frames/3961d725` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3961d725/.governance/incidents/`
