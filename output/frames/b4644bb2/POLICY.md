# Governance Policy - output/frames/b4644bb2
...
This policy governs all work in `output/frames/b4644bb2` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b4644bb2/.governance/incidents/`
