# Governance Policy - output/frames/3462dcd3
...
This policy governs all work in `output/frames/3462dcd3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3462dcd3/.governance/incidents/`
