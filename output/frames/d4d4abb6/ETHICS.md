# Ethics and Responsible Use - output/frames/d4d4abb6
...
**In this directory (`output/frames/d4d4abb6`), the following ethical rules apply:**
...
Before committing work in `output/frames/d4d4abb6`:
