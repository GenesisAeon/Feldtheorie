# Governance Policy - output/frames/d4d4abb6
...
This policy governs all work in `output/frames/d4d4abb6` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d4d4abb6/.governance/incidents/`
