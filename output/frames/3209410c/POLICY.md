# Governance Policy - output/frames/3209410c
...
This policy governs all work in `output/frames/3209410c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3209410c/.governance/incidents/`
