# Ethics and Responsible Use - output/frames/3209410c
...
**In this directory (`output/frames/3209410c`), the following ethical rules apply:**
...
Before committing work in `output/frames/3209410c`:
