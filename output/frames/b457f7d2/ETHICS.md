# Ethics and Responsible Use - output/frames/b457f7d2
...
**In this directory (`output/frames/b457f7d2`), the following ethical rules apply:**
...
Before committing work in `output/frames/b457f7d2`:
