# Governance Policy - output/frames/b457f7d2
...
This policy governs all work in `output/frames/b457f7d2` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b457f7d2/.governance/incidents/`
