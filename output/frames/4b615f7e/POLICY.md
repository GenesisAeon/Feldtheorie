# Governance Policy - output/frames/4b615f7e
...
This policy governs all work in `output/frames/4b615f7e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4b615f7e/.governance/incidents/`
