# Ethics and Responsible Use - output/frames/4b615f7e
...
**In this directory (`output/frames/4b615f7e`), the following ethical rules apply:**
...
Before committing work in `output/frames/4b615f7e`:
