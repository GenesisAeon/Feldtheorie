# Ethics and Responsible Use - output/frames/aae339c1
...
**In this directory (`output/frames/aae339c1`), the following ethical rules apply:**
...
Before committing work in `output/frames/aae339c1`:
