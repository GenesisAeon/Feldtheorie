# Governance Policy - output/frames/aae339c1
...
This policy governs all work in `output/frames/aae339c1` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/aae339c1/.governance/incidents/`
