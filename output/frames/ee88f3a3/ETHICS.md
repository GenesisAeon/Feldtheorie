# Ethics and Responsible Use - output/frames/ee88f3a3
...
**In this directory (`output/frames/ee88f3a3`), the following ethical rules apply:**
...
Before committing work in `output/frames/ee88f3a3`:
