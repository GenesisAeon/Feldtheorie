# Governance Policy - output/frames/ee88f3a3
...
This policy governs all work in `output/frames/ee88f3a3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ee88f3a3/.governance/incidents/`
