# Governance Policy - output/frames/f303b235
...
This policy governs all work in `output/frames/f303b235` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f303b235/.governance/incidents/`
