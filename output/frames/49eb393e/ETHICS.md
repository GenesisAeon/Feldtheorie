# Ethics and Responsible Use - output/frames/49eb393e
...
**In this directory (`output/frames/49eb393e`), the following ethical rules apply:**
...
Before committing work in `output/frames/49eb393e`:
