# Governance Policy - output/frames/49eb393e
...
This policy governs all work in `output/frames/49eb393e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/49eb393e/.governance/incidents/`
