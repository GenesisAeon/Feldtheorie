# Governance Policy - output/frames/8237d728
...
This policy governs all work in `output/frames/8237d728` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8237d728/.governance/incidents/`
