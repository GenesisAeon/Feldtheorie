# Governance Policy - output/frames/8ef0a9a8
...
This policy governs all work in `output/frames/8ef0a9a8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8ef0a9a8/.governance/incidents/`
