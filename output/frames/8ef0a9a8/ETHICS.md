# Ethics and Responsible Use - output/frames/8ef0a9a8
...
**In this directory (`output/frames/8ef0a9a8`), the following ethical rules apply:**
...
Before committing work in `output/frames/8ef0a9a8`:
