# Ethics and Responsible Use - output/frames/4c0be822
...
**In this directory (`output/frames/4c0be822`), the following ethical rules apply:**
...
Before committing work in `output/frames/4c0be822`:
