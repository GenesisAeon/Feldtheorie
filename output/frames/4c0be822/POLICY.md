# Governance Policy - output/frames/4c0be822
...
This policy governs all work in `output/frames/4c0be822` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4c0be822/.governance/incidents/`
