# Governance Policy - output/frames/50323254
...
This policy governs all work in `output/frames/50323254` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/50323254/.governance/incidents/`
