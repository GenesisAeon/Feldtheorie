# Ethics and Responsible Use - output/frames/50323254
...
**In this directory (`output/frames/50323254`), the following ethical rules apply:**
...
Before committing work in `output/frames/50323254`:
