# Ethics and Responsible Use - output/frames/1cf98628
...
**In this directory (`output/frames/1cf98628`), the following ethical rules apply:**
...
Before committing work in `output/frames/1cf98628`:
