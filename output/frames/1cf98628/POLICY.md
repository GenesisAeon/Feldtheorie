# Governance Policy - output/frames/1cf98628
...
This policy governs all work in `output/frames/1cf98628` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1cf98628/.governance/incidents/`
