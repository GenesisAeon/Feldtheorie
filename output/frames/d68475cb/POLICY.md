# Governance Policy - output/frames/d68475cb
...
This policy governs all work in `output/frames/d68475cb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d68475cb/.governance/incidents/`
