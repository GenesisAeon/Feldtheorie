# Ethics and Responsible Use - output/frames/d68475cb
...
**In this directory (`output/frames/d68475cb`), the following ethical rules apply:**
...
Before committing work in `output/frames/d68475cb`:
