# Governance Policy - output/frames/c5d1f512
...
This policy governs all work in `output/frames/c5d1f512` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c5d1f512/.governance/incidents/`
