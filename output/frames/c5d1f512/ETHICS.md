# Ethics and Responsible Use - output/frames/c5d1f512
...
**In this directory (`output/frames/c5d1f512`), the following ethical rules apply:**
...
Before committing work in `output/frames/c5d1f512`:
