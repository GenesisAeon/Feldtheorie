# Ethics and Responsible Use - output/frames/d177df2d
...
**In this directory (`output/frames/d177df2d`), the following ethical rules apply:**
...
Before committing work in `output/frames/d177df2d`:
