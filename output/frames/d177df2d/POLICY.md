# Governance Policy - output/frames/d177df2d
...
This policy governs all work in `output/frames/d177df2d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d177df2d/.governance/incidents/`
