# Governance Policy - output/frames/7ead4e98
...
This policy governs all work in `output/frames/7ead4e98` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7ead4e98/.governance/incidents/`
