# Ethics and Responsible Use - output/frames/7ead4e98
...
**In this directory (`output/frames/7ead4e98`), the following ethical rules apply:**
...
Before committing work in `output/frames/7ead4e98`:
