# Ethics and Responsible Use - output/frames/f945d3ff
...
**In this directory (`output/frames/f945d3ff`), the following ethical rules apply:**
...
Before committing work in `output/frames/f945d3ff`:
