# Governance Policy - output/frames/f945d3ff
...
This policy governs all work in `output/frames/f945d3ff` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f945d3ff/.governance/incidents/`
