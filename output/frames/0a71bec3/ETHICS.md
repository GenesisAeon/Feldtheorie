# Ethics and Responsible Use - output/frames/0a71bec3
...
**In this directory (`output/frames/0a71bec3`), the following ethical rules apply:**
...
Before committing work in `output/frames/0a71bec3`:
