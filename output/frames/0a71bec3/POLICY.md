# Governance Policy - output/frames/0a71bec3
...
This policy governs all work in `output/frames/0a71bec3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0a71bec3/.governance/incidents/`
