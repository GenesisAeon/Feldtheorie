# Ethics and Responsible Use - output/frames/ed85244e
...
**In this directory (`output/frames/ed85244e`), the following ethical rules apply:**
...
Before committing work in `output/frames/ed85244e`:
