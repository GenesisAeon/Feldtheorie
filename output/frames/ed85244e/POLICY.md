# Governance Policy - output/frames/ed85244e
...
This policy governs all work in `output/frames/ed85244e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ed85244e/.governance/incidents/`
