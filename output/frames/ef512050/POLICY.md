# Governance Policy - output/frames/ef512050
...
This policy governs all work in `output/frames/ef512050` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ef512050/.governance/incidents/`
