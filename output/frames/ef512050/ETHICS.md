# Ethics and Responsible Use - output/frames/ef512050
...
**In this directory (`output/frames/ef512050`), the following ethical rules apply:**
...
Before committing work in `output/frames/ef512050`:
