# Governance Policy - output/frames/f41cc31e
...
This policy governs all work in `output/frames/f41cc31e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f41cc31e/.governance/incidents/`
