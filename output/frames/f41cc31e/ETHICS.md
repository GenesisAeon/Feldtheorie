# Ethics and Responsible Use - output/frames/f41cc31e
...
**In this directory (`output/frames/f41cc31e`), the following ethical rules apply:**
...
Before committing work in `output/frames/f41cc31e`:
