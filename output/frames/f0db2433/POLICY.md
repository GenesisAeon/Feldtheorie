# Governance Policy - output/frames/f0db2433
...
This policy governs all work in `output/frames/f0db2433` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f0db2433/.governance/incidents/`
