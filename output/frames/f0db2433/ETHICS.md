# Ethics and Responsible Use - output/frames/f0db2433
...
**In this directory (`output/frames/f0db2433`), the following ethical rules apply:**
...
Before committing work in `output/frames/f0db2433`:
