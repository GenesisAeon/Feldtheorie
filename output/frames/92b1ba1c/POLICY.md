# Governance Policy - output/frames/92b1ba1c
...
This policy governs all work in `output/frames/92b1ba1c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/92b1ba1c/.governance/incidents/`
