# Ethics and Responsible Use - output/frames/92b1ba1c
...
**In this directory (`output/frames/92b1ba1c`), the following ethical rules apply:**
...
Before committing work in `output/frames/92b1ba1c`:
