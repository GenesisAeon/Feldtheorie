# Ethics and Responsible Use - output/frames/3da31fe7
...
**In this directory (`output/frames/3da31fe7`), the following ethical rules apply:**
...
Before committing work in `output/frames/3da31fe7`:
