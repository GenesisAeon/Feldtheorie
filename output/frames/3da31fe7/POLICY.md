# Governance Policy - output/frames/3da31fe7
...
This policy governs all work in `output/frames/3da31fe7` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3da31fe7/.governance/incidents/`
