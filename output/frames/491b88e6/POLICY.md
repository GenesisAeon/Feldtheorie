# Governance Policy - output/frames/491b88e6
...
This policy governs all work in `output/frames/491b88e6` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/491b88e6/.governance/incidents/`
