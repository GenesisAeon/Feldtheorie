# Ethics and Responsible Use - output/frames/963845a4
...
**In this directory (`output/frames/963845a4`), the following ethical rules apply:**
...
Before committing work in `output/frames/963845a4`:
