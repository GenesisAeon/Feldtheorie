# Governance Policy - output/frames/963845a4
...
This policy governs all work in `output/frames/963845a4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/963845a4/.governance/incidents/`
