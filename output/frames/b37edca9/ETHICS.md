# Ethics and Responsible Use - output/frames/b37edca9
...
**In this directory (`output/frames/b37edca9`), the following ethical rules apply:**
...
Before committing work in `output/frames/b37edca9`:
