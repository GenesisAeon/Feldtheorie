# Governance Policy - output/frames/b37edca9
...
This policy governs all work in `output/frames/b37edca9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b37edca9/.governance/incidents/`
