# Ethics and Responsible Use - output/frames/56498f1e
...
**In this directory (`output/frames/56498f1e`), the following ethical rules apply:**
...
Before committing work in `output/frames/56498f1e`:
