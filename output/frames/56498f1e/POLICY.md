# Governance Policy - output/frames/56498f1e
...
This policy governs all work in `output/frames/56498f1e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/56498f1e/.governance/incidents/`
