# Governance Policy - output/frames/8e1e918b
...
This policy governs all work in `output/frames/8e1e918b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8e1e918b/.governance/incidents/`
