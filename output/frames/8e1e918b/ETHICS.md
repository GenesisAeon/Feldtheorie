# Ethics and Responsible Use - output/frames/8e1e918b
...
**In this directory (`output/frames/8e1e918b`), the following ethical rules apply:**
...
Before committing work in `output/frames/8e1e918b`:
