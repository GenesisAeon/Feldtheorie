# Governance Policy - output/frames/624c6b90
...
This policy governs all work in `output/frames/624c6b90` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/624c6b90/.governance/incidents/`
