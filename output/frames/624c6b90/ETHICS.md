# Ethics and Responsible Use - output/frames/624c6b90
...
**In this directory (`output/frames/624c6b90`), the following ethical rules apply:**
...
Before committing work in `output/frames/624c6b90`:
