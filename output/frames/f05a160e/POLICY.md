# Governance Policy - output/frames/f05a160e
...
This policy governs all work in `output/frames/f05a160e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f05a160e/.governance/incidents/`
