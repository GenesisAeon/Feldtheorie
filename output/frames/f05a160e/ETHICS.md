# Ethics and Responsible Use - output/frames/f05a160e
...
**In this directory (`output/frames/f05a160e`), the following ethical rules apply:**
...
Before committing work in `output/frames/f05a160e`:
