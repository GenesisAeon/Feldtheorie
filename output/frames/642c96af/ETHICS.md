# Ethics and Responsible Use - output/frames/642c96af
...
**In this directory (`output/frames/642c96af`), the following ethical rules apply:**
...
Before committing work in `output/frames/642c96af`:
