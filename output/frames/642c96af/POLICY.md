# Governance Policy - output/frames/642c96af
...
This policy governs all work in `output/frames/642c96af` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/642c96af/.governance/incidents/`
