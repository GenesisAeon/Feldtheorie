# Governance Policy - output/frames/09740262
...
This policy governs all work in `output/frames/09740262` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/09740262/.governance/incidents/`
