# Ethics and Responsible Use - output/frames/34bdad45
...
**In this directory (`output/frames/34bdad45`), the following ethical rules apply:**
...
Before committing work in `output/frames/34bdad45`:
