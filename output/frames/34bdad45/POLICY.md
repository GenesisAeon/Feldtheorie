# Governance Policy - output/frames/34bdad45
...
This policy governs all work in `output/frames/34bdad45` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/34bdad45/.governance/incidents/`
