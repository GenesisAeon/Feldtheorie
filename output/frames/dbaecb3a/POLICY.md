# Governance Policy - output/frames/dbaecb3a
...
This policy governs all work in `output/frames/dbaecb3a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/dbaecb3a/.governance/incidents/`
