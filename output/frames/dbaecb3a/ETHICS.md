# Ethics and Responsible Use - output/frames/dbaecb3a
...
**In this directory (`output/frames/dbaecb3a`), the following ethical rules apply:**
...
Before committing work in `output/frames/dbaecb3a`:
