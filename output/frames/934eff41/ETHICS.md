# Ethics and Responsible Use - output/frames/934eff41
...
**In this directory (`output/frames/934eff41`), the following ethical rules apply:**
...
Before committing work in `output/frames/934eff41`:
