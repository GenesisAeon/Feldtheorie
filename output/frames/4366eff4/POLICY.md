# Governance Policy - output/frames/4366eff4
...
This policy governs all work in `output/frames/4366eff4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4366eff4/.governance/incidents/`
