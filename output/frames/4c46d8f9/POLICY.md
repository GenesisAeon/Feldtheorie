# Governance Policy - output/frames/4c46d8f9
...
This policy governs all work in `output/frames/4c46d8f9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4c46d8f9/.governance/incidents/`
