# Ethics and Responsible Use - output/frames/4c46d8f9
...
**In this directory (`output/frames/4c46d8f9`), the following ethical rules apply:**
...
Before committing work in `output/frames/4c46d8f9`:
