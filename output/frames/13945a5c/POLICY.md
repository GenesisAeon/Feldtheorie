# Governance Policy - output/frames/13945a5c
...
This policy governs all work in `output/frames/13945a5c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/13945a5c/.governance/incidents/`
