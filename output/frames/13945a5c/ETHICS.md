# Ethics and Responsible Use - output/frames/13945a5c
...
**In this directory (`output/frames/13945a5c`), the following ethical rules apply:**
...
Before committing work in `output/frames/13945a5c`:
