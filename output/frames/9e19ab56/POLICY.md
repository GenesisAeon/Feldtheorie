# Governance Policy - output/frames/9e19ab56
...
This policy governs all work in `output/frames/9e19ab56` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9e19ab56/.governance/incidents/`
