# Ethics and Responsible Use - output/frames/9e19ab56
...
**In this directory (`output/frames/9e19ab56`), the following ethical rules apply:**
...
Before committing work in `output/frames/9e19ab56`:
