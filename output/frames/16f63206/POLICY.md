# Governance Policy - output/frames/16f63206
...
This policy governs all work in `output/frames/16f63206` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/16f63206/.governance/incidents/`
