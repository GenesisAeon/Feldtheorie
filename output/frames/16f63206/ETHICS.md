# Ethics and Responsible Use - output/frames/16f63206
...
**In this directory (`output/frames/16f63206`), the following ethical rules apply:**
...
Before committing work in `output/frames/16f63206`:
