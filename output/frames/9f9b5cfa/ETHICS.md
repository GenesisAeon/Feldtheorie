# Ethics and Responsible Use - output/frames/9f9b5cfa
...
**In this directory (`output/frames/9f9b5cfa`), the following ethical rules apply:**
...
Before committing work in `output/frames/9f9b5cfa`:
