# Governance Policy - output/frames/9f9b5cfa
...
This policy governs all work in `output/frames/9f9b5cfa` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9f9b5cfa/.governance/incidents/`
