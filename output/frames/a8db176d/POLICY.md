# Governance Policy - output/frames/a8db176d
...
This policy governs all work in `output/frames/a8db176d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a8db176d/.governance/incidents/`
