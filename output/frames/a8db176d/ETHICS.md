# Ethics and Responsible Use - output/frames/a8db176d
...
**In this directory (`output/frames/a8db176d`), the following ethical rules apply:**
...
Before committing work in `output/frames/a8db176d`:
