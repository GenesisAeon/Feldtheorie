# Governance Policy - output/frames/1ab225b7
...
This policy governs all work in `output/frames/1ab225b7` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1ab225b7/.governance/incidents/`
