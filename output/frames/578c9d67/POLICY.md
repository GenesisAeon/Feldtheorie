# Governance Policy - output/frames/578c9d67
...
This policy governs all work in `output/frames/578c9d67` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/578c9d67/.governance/incidents/`
