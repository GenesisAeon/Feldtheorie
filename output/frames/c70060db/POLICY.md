# Governance Policy - output/frames/c70060db
...
This policy governs all work in `output/frames/c70060db` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c70060db/.governance/incidents/`
