# Ethics and Responsible Use - output/frames/c70060db
...
**In this directory (`output/frames/c70060db`), the following ethical rules apply:**
...
Before committing work in `output/frames/c70060db`:
