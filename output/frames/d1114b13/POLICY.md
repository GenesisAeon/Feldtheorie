# Governance Policy - output/frames/d1114b13
...
This policy governs all work in `output/frames/d1114b13` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d1114b13/.governance/incidents/`
