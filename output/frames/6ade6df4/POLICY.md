# Governance Policy - output/frames/6ade6df4
...
This policy governs all work in `output/frames/6ade6df4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6ade6df4/.governance/incidents/`
