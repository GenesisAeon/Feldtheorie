# Ethics and Responsible Use - output/frames/6ade6df4
...
**In this directory (`output/frames/6ade6df4`), the following ethical rules apply:**
...
Before committing work in `output/frames/6ade6df4`:
