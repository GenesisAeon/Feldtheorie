# Governance Policy - output/frames/9e4fe43b
...
This policy governs all work in `output/frames/9e4fe43b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9e4fe43b/.governance/incidents/`
