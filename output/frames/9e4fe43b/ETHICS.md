# Ethics and Responsible Use - output/frames/9e4fe43b
...
**In this directory (`output/frames/9e4fe43b`), the following ethical rules apply:**
...
Before committing work in `output/frames/9e4fe43b`:
