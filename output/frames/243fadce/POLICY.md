# Governance Policy - output/frames/243fadce
...
This policy governs all work in `output/frames/243fadce` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/243fadce/.governance/incidents/`
