# Ethics and Responsible Use - output/frames/243fadce
...
**In this directory (`output/frames/243fadce`), the following ethical rules apply:**
...
Before committing work in `output/frames/243fadce`:
