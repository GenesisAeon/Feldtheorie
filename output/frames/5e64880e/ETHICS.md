# Ethics and Responsible Use - output/frames/5e64880e
...
**In this directory (`output/frames/5e64880e`), the following ethical rules apply:**
...
Before committing work in `output/frames/5e64880e`:
