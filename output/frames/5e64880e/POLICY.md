# Governance Policy - output/frames/5e64880e
...
This policy governs all work in `output/frames/5e64880e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5e64880e/.governance/incidents/`
