# Governance Policy - output/frames/06e71897
...
This policy governs all work in `output/frames/06e71897` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/06e71897/.governance/incidents/`
