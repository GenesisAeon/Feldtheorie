# Ethics and Responsible Use - output/frames/65e9e860
...
**In this directory (`output/frames/65e9e860`), the following ethical rules apply:**
...
Before committing work in `output/frames/65e9e860`:
