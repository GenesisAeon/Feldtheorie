# Governance Policy - output/frames/65e9e860
...
This policy governs all work in `output/frames/65e9e860` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/65e9e860/.governance/incidents/`
