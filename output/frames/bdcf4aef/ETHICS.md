# Ethics and Responsible Use - output/frames/bdcf4aef
...
**In this directory (`output/frames/bdcf4aef`), the following ethical rules apply:**
...
Before committing work in `output/frames/bdcf4aef`:
