# Governance Policy - output/frames/bdcf4aef
...
This policy governs all work in `output/frames/bdcf4aef` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bdcf4aef/.governance/incidents/`
