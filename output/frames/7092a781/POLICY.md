# Governance Policy - output/frames/7092a781
...
This policy governs all work in `output/frames/7092a781` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7092a781/.governance/incidents/`
