# Ethics and Responsible Use - output/frames/5cf8953f
...
**In this directory (`output/frames/5cf8953f`), the following ethical rules apply:**
...
Before committing work in `output/frames/5cf8953f`:
