# Governance Policy - output/frames/5cf8953f
...
This policy governs all work in `output/frames/5cf8953f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/5cf8953f/.governance/incidents/`
