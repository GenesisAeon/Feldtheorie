# Governance Policy - output/frames/d3fac5a9
...
This policy governs all work in `output/frames/d3fac5a9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d3fac5a9/.governance/incidents/`
