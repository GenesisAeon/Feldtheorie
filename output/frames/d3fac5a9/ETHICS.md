# Ethics and Responsible Use - output/frames/d3fac5a9
...
**In this directory (`output/frames/d3fac5a9`), the following ethical rules apply:**
...
Before committing work in `output/frames/d3fac5a9`:
