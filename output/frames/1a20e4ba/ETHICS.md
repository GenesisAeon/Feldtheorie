# Ethics and Responsible Use - output/frames/1a20e4ba
...
**In this directory (`output/frames/1a20e4ba`), the following ethical rules apply:**
...
Before committing work in `output/frames/1a20e4ba`:
