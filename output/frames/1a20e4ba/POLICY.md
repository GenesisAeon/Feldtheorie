# Governance Policy - output/frames/1a20e4ba
...
This policy governs all work in `output/frames/1a20e4ba` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1a20e4ba/.governance/incidents/`
