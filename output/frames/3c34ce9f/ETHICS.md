# Ethics and Responsible Use - output/frames/3c34ce9f
...
**In this directory (`output/frames/3c34ce9f`), the following ethical rules apply:**
...
Before committing work in `output/frames/3c34ce9f`:
