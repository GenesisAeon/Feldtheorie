# Governance Policy - output/frames/3c34ce9f
...
This policy governs all work in `output/frames/3c34ce9f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3c34ce9f/.governance/incidents/`
