# Governance Policy - output/frames/8c921abd
...
This policy governs all work in `output/frames/8c921abd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8c921abd/.governance/incidents/`
