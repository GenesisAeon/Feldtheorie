# Ethics and Responsible Use - output/frames/8c921abd
...
**In this directory (`output/frames/8c921abd`), the following ethical rules apply:**
...
Before committing work in `output/frames/8c921abd`:
