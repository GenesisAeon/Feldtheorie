# Governance Policy - output/frames/4923a8ef
...
This policy governs all work in `output/frames/4923a8ef` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4923a8ef/.governance/incidents/`
