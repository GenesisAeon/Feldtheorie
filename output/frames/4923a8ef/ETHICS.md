# Ethics and Responsible Use - output/frames/4923a8ef
...
**In this directory (`output/frames/4923a8ef`), the following ethical rules apply:**
...
Before committing work in `output/frames/4923a8ef`:
