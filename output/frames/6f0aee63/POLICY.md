# Governance Policy - output/frames/6f0aee63
...
This policy governs all work in `output/frames/6f0aee63` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6f0aee63/.governance/incidents/`
