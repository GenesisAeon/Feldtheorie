# Ethics and Responsible Use - output/frames/6f0aee63
...
**In this directory (`output/frames/6f0aee63`), the following ethical rules apply:**
...
Before committing work in `output/frames/6f0aee63`:
