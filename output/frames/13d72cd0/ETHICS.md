# Ethics and Responsible Use - output/frames/13d72cd0
...
**In this directory (`output/frames/13d72cd0`), the following ethical rules apply:**
...
Before committing work in `output/frames/13d72cd0`:
