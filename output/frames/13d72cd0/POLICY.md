# Governance Policy - output/frames/13d72cd0
...
This policy governs all work in `output/frames/13d72cd0` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/13d72cd0/.governance/incidents/`
