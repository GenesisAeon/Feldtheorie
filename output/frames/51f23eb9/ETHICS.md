# Ethics and Responsible Use - output/frames/51f23eb9
...
**In this directory (`output/frames/51f23eb9`), the following ethical rules apply:**
...
Before committing work in `output/frames/51f23eb9`:
