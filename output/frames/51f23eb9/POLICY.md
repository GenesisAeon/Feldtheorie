# Governance Policy - output/frames/51f23eb9
...
This policy governs all work in `output/frames/51f23eb9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/51f23eb9/.governance/incidents/`
