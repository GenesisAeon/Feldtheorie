# Governance Policy - output/frames/bd76d909
...
This policy governs all work in `output/frames/bd76d909` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bd76d909/.governance/incidents/`
