# Ethics and Responsible Use - output/frames/bd76d909
...
**In this directory (`output/frames/bd76d909`), the following ethical rules apply:**
...
Before committing work in `output/frames/bd76d909`:
