# Ethics and Responsible Use - output/frames/6cabe23b
...
**In this directory (`output/frames/6cabe23b`), the following ethical rules apply:**
...
Before committing work in `output/frames/6cabe23b`:
