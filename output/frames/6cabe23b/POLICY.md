# Governance Policy - output/frames/6cabe23b
...
This policy governs all work in `output/frames/6cabe23b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6cabe23b/.governance/incidents/`
