# Ethics and Responsible Use - output/frames/0e8e63a8
...
**In this directory (`output/frames/0e8e63a8`), the following ethical rules apply:**
...
Before committing work in `output/frames/0e8e63a8`:
