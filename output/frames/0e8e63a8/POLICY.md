# Governance Policy - output/frames/0e8e63a8
...
This policy governs all work in `output/frames/0e8e63a8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0e8e63a8/.governance/incidents/`
