# Ethics and Responsible Use - output/frames/9b2465b5
...
**In this directory (`output/frames/9b2465b5`), the following ethical rules apply:**
...
Before committing work in `output/frames/9b2465b5`:
