# Governance Policy - output/frames/9b2465b5
...
This policy governs all work in `output/frames/9b2465b5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9b2465b5/.governance/incidents/`
