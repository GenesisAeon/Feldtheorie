# Governance Policy - output/frames/9a08b351
...
This policy governs all work in `output/frames/9a08b351` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9a08b351/.governance/incidents/`
