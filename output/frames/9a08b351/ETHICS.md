# Ethics and Responsible Use - output/frames/9a08b351
...
**In this directory (`output/frames/9a08b351`), the following ethical rules apply:**
...
Before committing work in `output/frames/9a08b351`:
