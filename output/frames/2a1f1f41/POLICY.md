# Governance Policy - output/frames/2a1f1f41
...
This policy governs all work in `output/frames/2a1f1f41` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/2a1f1f41/.governance/incidents/`
