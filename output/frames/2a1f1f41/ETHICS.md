# Ethics and Responsible Use - output/frames/2a1f1f41
...
**In this directory (`output/frames/2a1f1f41`), the following ethical rules apply:**
...
Before committing work in `output/frames/2a1f1f41`:
