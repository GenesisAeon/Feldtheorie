# Governance Policy - output/frames/4d3bbf25
...
This policy governs all work in `output/frames/4d3bbf25` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4d3bbf25/.governance/incidents/`
