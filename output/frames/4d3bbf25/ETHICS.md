# Ethics and Responsible Use - output/frames/4d3bbf25
...
**In this directory (`output/frames/4d3bbf25`), the following ethical rules apply:**
...
Before committing work in `output/frames/4d3bbf25`:
