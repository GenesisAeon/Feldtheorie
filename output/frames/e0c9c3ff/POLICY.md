# Governance Policy - output/frames/e0c9c3ff
...
This policy governs all work in `output/frames/e0c9c3ff` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e0c9c3ff/.governance/incidents/`
