# Ethics and Responsible Use - output/frames/e0c9c3ff
...
**In this directory (`output/frames/e0c9c3ff`), the following ethical rules apply:**
...
Before committing work in `output/frames/e0c9c3ff`:
