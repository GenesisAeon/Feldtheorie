# Governance Policy - output/frames
...
This policy governs all work in `output/frames` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/.governance/incidents/`
