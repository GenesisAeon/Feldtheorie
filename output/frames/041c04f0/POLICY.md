# Governance Policy - output/frames/041c04f0
...
This policy governs all work in `output/frames/041c04f0` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/041c04f0/.governance/incidents/`
