# Ethics and Responsible Use - output/frames/041c04f0
...
**In this directory (`output/frames/041c04f0`), the following ethical rules apply:**
...
Before committing work in `output/frames/041c04f0`:
