# Governance Policy - output/frames/eacd16d9
...
This policy governs all work in `output/frames/eacd16d9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/eacd16d9/.governance/incidents/`
