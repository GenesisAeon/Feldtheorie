# Ethics and Responsible Use - output/frames/eacd16d9
...
**In this directory (`output/frames/eacd16d9`), the following ethical rules apply:**
...
Before committing work in `output/frames/eacd16d9`:
