# Ethics and Responsible Use - output/frames/329daef6
...
**In this directory (`output/frames/329daef6`), the following ethical rules apply:**
...
Before committing work in `output/frames/329daef6`:
