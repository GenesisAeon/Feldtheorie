# Governance Policy - output/frames/329daef6
...
This policy governs all work in `output/frames/329daef6` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/329daef6/.governance/incidents/`
