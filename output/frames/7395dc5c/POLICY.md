# Governance Policy - output/frames/7395dc5c
...
This policy governs all work in `output/frames/7395dc5c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7395dc5c/.governance/incidents/`
