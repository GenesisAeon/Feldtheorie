# Ethics and Responsible Use - output/frames/79dcddd9
...
**In this directory (`output/frames/79dcddd9`), the following ethical rules apply:**
...
Before committing work in `output/frames/79dcddd9`:
