# Governance Policy - output/frames/79dcddd9
...
This policy governs all work in `output/frames/79dcddd9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/79dcddd9/.governance/incidents/`
