# Governance Policy - output/frames/e9e9fee0
...
This policy governs all work in `output/frames/e9e9fee0` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e9e9fee0/.governance/incidents/`
