# Ethics and Responsible Use - output/frames/e9e9fee0
...
**In this directory (`output/frames/e9e9fee0`), the following ethical rules apply:**
...
Before committing work in `output/frames/e9e9fee0`:
