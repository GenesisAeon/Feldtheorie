# Ethics and Responsible Use - output/frames/2860868d
...
**In this directory (`output/frames/2860868d`), the following ethical rules apply:**
...
Before committing work in `output/frames/2860868d`:
