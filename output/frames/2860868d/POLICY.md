# Governance Policy - output/frames/2860868d
...
This policy governs all work in `output/frames/2860868d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/2860868d/.governance/incidents/`
