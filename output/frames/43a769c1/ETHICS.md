# Ethics and Responsible Use - output/frames/43a769c1
...
**In this directory (`output/frames/43a769c1`), the following ethical rules apply:**
...
Before committing work in `output/frames/43a769c1`:
