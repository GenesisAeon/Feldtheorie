# Governance Policy - output/frames/43a769c1
...
This policy governs all work in `output/frames/43a769c1` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/43a769c1/.governance/incidents/`
