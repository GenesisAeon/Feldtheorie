# Governance Policy - output/frames/fab2b6c3
...
This policy governs all work in `output/frames/fab2b6c3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/fab2b6c3/.governance/incidents/`
