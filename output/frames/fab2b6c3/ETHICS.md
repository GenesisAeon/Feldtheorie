# Ethics and Responsible Use - output/frames/fab2b6c3
...
**In this directory (`output/frames/fab2b6c3`), the following ethical rules apply:**
...
Before committing work in `output/frames/fab2b6c3`:
