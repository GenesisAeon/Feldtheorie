# Ethics and Responsible Use - output/frames/c2134cf5
...
**In this directory (`output/frames/c2134cf5`), the following ethical rules apply:**
...
Before committing work in `output/frames/c2134cf5`:
