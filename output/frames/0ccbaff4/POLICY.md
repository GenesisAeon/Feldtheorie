# Governance Policy - output/frames/0ccbaff4
...
This policy governs all work in `output/frames/0ccbaff4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0ccbaff4/.governance/incidents/`
