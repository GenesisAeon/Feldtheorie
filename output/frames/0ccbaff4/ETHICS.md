# Ethics and Responsible Use - output/frames/0ccbaff4
...
**In this directory (`output/frames/0ccbaff4`), the following ethical rules apply:**
...
Before committing work in `output/frames/0ccbaff4`:
