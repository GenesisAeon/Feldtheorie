# Governance Policy - output/frames/e98d4f9c
...
This policy governs all work in `output/frames/e98d4f9c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e98d4f9c/.governance/incidents/`
