# Ethics and Responsible Use - output/frames/e98d4f9c
...
**In this directory (`output/frames/e98d4f9c`), the following ethical rules apply:**
...
Before committing work in `output/frames/e98d4f9c`:
