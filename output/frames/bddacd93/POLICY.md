# Governance Policy - output/frames/bddacd93
...
This policy governs all work in `output/frames/bddacd93` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bddacd93/.governance/incidents/`
