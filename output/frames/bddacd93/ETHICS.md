# Ethics and Responsible Use - output/frames/bddacd93
...
**In this directory (`output/frames/bddacd93`), the following ethical rules apply:**
...
Before committing work in `output/frames/bddacd93`:
