# Governance Policy - output/frames/cb8a9874
...
This policy governs all work in `output/frames/cb8a9874` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/cb8a9874/.governance/incidents/`
