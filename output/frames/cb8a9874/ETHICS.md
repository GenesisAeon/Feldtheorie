# Ethics and Responsible Use - output/frames/cb8a9874
...
**In this directory (`output/frames/cb8a9874`), the following ethical rules apply:**
...
Before committing work in `output/frames/cb8a9874`:
