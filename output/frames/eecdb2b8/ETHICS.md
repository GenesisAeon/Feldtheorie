# Ethics and Responsible Use - output/frames/eecdb2b8
...
**In this directory (`output/frames/eecdb2b8`), the following ethical rules apply:**
...
Before committing work in `output/frames/eecdb2b8`:
