# Governance Policy - output/frames/eecdb2b8
...
This policy governs all work in `output/frames/eecdb2b8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/eecdb2b8/.governance/incidents/`
