# Ethics and Responsible Use - output/frames/53f4cb8a
...
**In this directory (`output/frames/53f4cb8a`), the following ethical rules apply:**
...
Before committing work in `output/frames/53f4cb8a`:
