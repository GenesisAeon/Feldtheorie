# Ethics and Responsible Use - output/frames/18d56990
...
**In this directory (`output/frames/18d56990`), the following ethical rules apply:**
...
Before committing work in `output/frames/18d56990`:
