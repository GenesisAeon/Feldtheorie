# Governance Policy - output/frames/18d56990
...
This policy governs all work in `output/frames/18d56990` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/18d56990/.governance/incidents/`
