# Governance Policy - output/frames/278ac0de
...
This policy governs all work in `output/frames/278ac0de` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/278ac0de/.governance/incidents/`
