# Ethics and Responsible Use - output/frames/278ac0de
...
**In this directory (`output/frames/278ac0de`), the following ethical rules apply:**
...
Before committing work in `output/frames/278ac0de`:
