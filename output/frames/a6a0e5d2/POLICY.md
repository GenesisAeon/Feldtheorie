# Governance Policy - output/frames/a6a0e5d2
...
This policy governs all work in `output/frames/a6a0e5d2` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a6a0e5d2/.governance/incidents/`
