# Ethics and Responsible Use - output/frames/a6a0e5d2
...
**In this directory (`output/frames/a6a0e5d2`), the following ethical rules apply:**
...
Before committing work in `output/frames/a6a0e5d2`:
