# Governance Policy - output/frames/12ca42fd
...
This policy governs all work in `output/frames/12ca42fd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/12ca42fd/.governance/incidents/`
