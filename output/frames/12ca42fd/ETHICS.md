# Ethics and Responsible Use - output/frames/12ca42fd
...
**In this directory (`output/frames/12ca42fd`), the following ethical rules apply:**
...
Before committing work in `output/frames/12ca42fd`:
