# Ethics and Responsible Use - output/frames/a7f701cb
...
**In this directory (`output/frames/a7f701cb`), the following ethical rules apply:**
...
Before committing work in `output/frames/a7f701cb`:
