# Governance Policy - output/frames/a7f701cb
...
This policy governs all work in `output/frames/a7f701cb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a7f701cb/.governance/incidents/`
