# Governance Policy - output/frames/8d1b0cba
...
This policy governs all work in `output/frames/8d1b0cba` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8d1b0cba/.governance/incidents/`
