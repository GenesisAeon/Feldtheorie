# Ethics and Responsible Use - output/frames/8d1b0cba
...
**In this directory (`output/frames/8d1b0cba`), the following ethical rules apply:**
...
Before committing work in `output/frames/8d1b0cba`:
