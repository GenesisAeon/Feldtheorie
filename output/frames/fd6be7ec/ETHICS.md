# Ethics and Responsible Use - output/frames/fd6be7ec
...
**In this directory (`output/frames/fd6be7ec`), the following ethical rules apply:**
...
Before committing work in `output/frames/fd6be7ec`:
