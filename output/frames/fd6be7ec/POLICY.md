# Governance Policy - output/frames/fd6be7ec
...
This policy governs all work in `output/frames/fd6be7ec` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/fd6be7ec/.governance/incidents/`
