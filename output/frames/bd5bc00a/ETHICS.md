# Ethics and Responsible Use - output/frames/bd5bc00a
...
**In this directory (`output/frames/bd5bc00a`), the following ethical rules apply:**
...
Before committing work in `output/frames/bd5bc00a`:
