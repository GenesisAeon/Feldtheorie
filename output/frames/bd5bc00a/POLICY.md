# Governance Policy - output/frames/bd5bc00a
...
This policy governs all work in `output/frames/bd5bc00a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bd5bc00a/.governance/incidents/`
