# Governance Policy - output/frames/a2f75c06
...
This policy governs all work in `output/frames/a2f75c06` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a2f75c06/.governance/incidents/`
