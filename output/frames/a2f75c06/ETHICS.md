# Ethics and Responsible Use - output/frames/a2f75c06
...
**In this directory (`output/frames/a2f75c06`), the following ethical rules apply:**
...
Before committing work in `output/frames/a2f75c06`:
