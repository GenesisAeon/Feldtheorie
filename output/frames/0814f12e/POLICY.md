# Governance Policy - output/frames/0814f12e
...
This policy governs all work in `output/frames/0814f12e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0814f12e/.governance/incidents/`
