# Governance Policy - output/frames/3e7581f3
...
This policy governs all work in `output/frames/3e7581f3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3e7581f3/.governance/incidents/`
