# Ethics and Responsible Use - output/frames/3e7581f3
...
**In this directory (`output/frames/3e7581f3`), the following ethical rules apply:**
...
Before committing work in `output/frames/3e7581f3`:
