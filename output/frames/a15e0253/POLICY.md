# Governance Policy - output/frames/a15e0253
...
This policy governs all work in `output/frames/a15e0253` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a15e0253/.governance/incidents/`
