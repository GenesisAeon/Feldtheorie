# Governance Policy - output/frames/b112e892
...
This policy governs all work in `output/frames/b112e892` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b112e892/.governance/incidents/`
