# Governance Policy - output/frames/cc11d549
...
This policy governs all work in `output/frames/cc11d549` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/cc11d549/.governance/incidents/`
