# Ethics and Responsible Use - output/frames/cc11d549
...
**In this directory (`output/frames/cc11d549`), the following ethical rules apply:**
...
Before committing work in `output/frames/cc11d549`:
