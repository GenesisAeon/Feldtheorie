# Ethics and Responsible Use - output/frames/fa6555b4
...
**In this directory (`output/frames/fa6555b4`), the following ethical rules apply:**
...
Before committing work in `output/frames/fa6555b4`:
