# Governance Policy - output/frames/fa6555b4
...
This policy governs all work in `output/frames/fa6555b4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/fa6555b4/.governance/incidents/`
