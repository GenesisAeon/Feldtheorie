# Governance Policy - output/frames/45948f5b
...
This policy governs all work in `output/frames/45948f5b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/45948f5b/.governance/incidents/`
