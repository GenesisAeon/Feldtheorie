# Governance Policy - output/frames/36beb10b
...
This policy governs all work in `output/frames/36beb10b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/36beb10b/.governance/incidents/`
