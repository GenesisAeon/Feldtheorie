# Ethics and Responsible Use - output/frames/36beb10b
...
**In this directory (`output/frames/36beb10b`), the following ethical rules apply:**
...
Before committing work in `output/frames/36beb10b`:
