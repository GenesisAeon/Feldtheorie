# Ethics and Responsible Use - output/frames/4381cbed
...
**In this directory (`output/frames/4381cbed`), the following ethical rules apply:**
...
Before committing work in `output/frames/4381cbed`:
