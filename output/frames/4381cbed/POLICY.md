# Governance Policy - output/frames/4381cbed
...
This policy governs all work in `output/frames/4381cbed` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4381cbed/.governance/incidents/`
