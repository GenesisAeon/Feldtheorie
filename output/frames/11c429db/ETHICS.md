# Ethics and Responsible Use - output/frames/11c429db
...
**In this directory (`output/frames/11c429db`), the following ethical rules apply:**
...
Before committing work in `output/frames/11c429db`:
