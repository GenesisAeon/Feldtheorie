# Ethics and Responsible Use - output/frames/200ee7ee
...
**In this directory (`output/frames/200ee7ee`), the following ethical rules apply:**
...
Before committing work in `output/frames/200ee7ee`:
