# Governance Policy - output/frames/200ee7ee
...
This policy governs all work in `output/frames/200ee7ee` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/200ee7ee/.governance/incidents/`
