# Governance Policy - output/frames/b960cc93
...
This policy governs all work in `output/frames/b960cc93` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/b960cc93/.governance/incidents/`
