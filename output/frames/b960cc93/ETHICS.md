# Ethics and Responsible Use - output/frames/b960cc93
...
**In this directory (`output/frames/b960cc93`), the following ethical rules apply:**
...
Before committing work in `output/frames/b960cc93`:
