# Governance Policy - output/frames/6dfebe1b
...
This policy governs all work in `output/frames/6dfebe1b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/6dfebe1b/.governance/incidents/`
