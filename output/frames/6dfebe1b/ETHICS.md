# Ethics and Responsible Use - output/frames/6dfebe1b
...
**In this directory (`output/frames/6dfebe1b`), the following ethical rules apply:**
...
Before committing work in `output/frames/6dfebe1b`:
