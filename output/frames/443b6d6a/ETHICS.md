# Ethics and Responsible Use - output/frames/443b6d6a
...
**In this directory (`output/frames/443b6d6a`), the following ethical rules apply:**
...
Before committing work in `output/frames/443b6d6a`:
