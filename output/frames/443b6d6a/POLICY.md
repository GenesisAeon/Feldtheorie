# Governance Policy - output/frames/443b6d6a
...
This policy governs all work in `output/frames/443b6d6a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/443b6d6a/.governance/incidents/`
