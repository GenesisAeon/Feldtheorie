# Governance Policy - output/frames/9d077d6f
...
This policy governs all work in `output/frames/9d077d6f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9d077d6f/.governance/incidents/`
