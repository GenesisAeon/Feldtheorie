# Ethics and Responsible Use - output/frames/9d077d6f
...
**In this directory (`output/frames/9d077d6f`), the following ethical rules apply:**
...
Before committing work in `output/frames/9d077d6f`:
