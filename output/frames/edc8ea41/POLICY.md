# Governance Policy - output/frames/edc8ea41
...
This policy governs all work in `output/frames/edc8ea41` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/edc8ea41/.governance/incidents/`
