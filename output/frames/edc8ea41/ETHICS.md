# Ethics and Responsible Use - output/frames/edc8ea41
...
**In this directory (`output/frames/edc8ea41`), the following ethical rules apply:**
...
Before committing work in `output/frames/edc8ea41`:
