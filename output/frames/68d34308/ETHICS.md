# Ethics and Responsible Use - output/frames/68d34308
...
**In this directory (`output/frames/68d34308`), the following ethical rules apply:**
...
Before committing work in `output/frames/68d34308`:
