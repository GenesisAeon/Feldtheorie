# Governance Policy - output/frames/68d34308
...
This policy governs all work in `output/frames/68d34308` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/68d34308/.governance/incidents/`
