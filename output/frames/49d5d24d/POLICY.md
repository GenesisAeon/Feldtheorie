# Governance Policy - output/frames/49d5d24d
...
This policy governs all work in `output/frames/49d5d24d` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/49d5d24d/.governance/incidents/`
