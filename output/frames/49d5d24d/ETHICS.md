# Ethics and Responsible Use - output/frames/49d5d24d
...
**In this directory (`output/frames/49d5d24d`), the following ethical rules apply:**
...
Before committing work in `output/frames/49d5d24d`:
