# Ethics and Responsible Use - output/frames/f055b4d1
...
**In this directory (`output/frames/f055b4d1`), the following ethical rules apply:**
...
Before committing work in `output/frames/f055b4d1`:
