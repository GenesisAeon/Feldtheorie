# Governance Policy - output/frames/f055b4d1
...
This policy governs all work in `output/frames/f055b4d1` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f055b4d1/.governance/incidents/`
