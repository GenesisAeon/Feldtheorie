# Governance Policy - output/frames/343deb62
...
This policy governs all work in `output/frames/343deb62` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/343deb62/.governance/incidents/`
