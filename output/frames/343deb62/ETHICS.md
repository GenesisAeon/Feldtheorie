# Ethics and Responsible Use - output/frames/343deb62
...
**In this directory (`output/frames/343deb62`), the following ethical rules apply:**
...
Before committing work in `output/frames/343deb62`:
