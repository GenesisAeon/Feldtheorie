# Governance Policy - output/frames/3160cafc
...
This policy governs all work in `output/frames/3160cafc` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3160cafc/.governance/incidents/`
