# Ethics and Responsible Use - output/frames/3160cafc
...
**In this directory (`output/frames/3160cafc`), the following ethical rules apply:**
...
Before committing work in `output/frames/3160cafc`:
