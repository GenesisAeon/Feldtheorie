# Governance Policy - output/frames/adb4878c
...
This policy governs all work in `output/frames/adb4878c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/adb4878c/.governance/incidents/`
