# Ethics and Responsible Use - output/frames/adb4878c
...
**In this directory (`output/frames/adb4878c`), the following ethical rules apply:**
...
Before committing work in `output/frames/adb4878c`:
