# Ethics and Responsible Use - output/frames/8786c65f
...
**In this directory (`output/frames/8786c65f`), the following ethical rules apply:**
...
Before committing work in `output/frames/8786c65f`:
