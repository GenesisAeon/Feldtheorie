# Governance Policy - output/frames/8786c65f
...
This policy governs all work in `output/frames/8786c65f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8786c65f/.governance/incidents/`
