# Governance Policy - output/frames/09388daa
...
This policy governs all work in `output/frames/09388daa` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/09388daa/.governance/incidents/`
