# Ethics and Responsible Use - output/frames/c80cbb9e
...
**In this directory (`output/frames/c80cbb9e`), the following ethical rules apply:**
...
Before committing work in `output/frames/c80cbb9e`:
