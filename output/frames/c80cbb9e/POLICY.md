# Governance Policy - output/frames/c80cbb9e
...
This policy governs all work in `output/frames/c80cbb9e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c80cbb9e/.governance/incidents/`
