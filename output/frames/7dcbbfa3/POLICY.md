# Governance Policy - output/frames/7dcbbfa3
...
This policy governs all work in `output/frames/7dcbbfa3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7dcbbfa3/.governance/incidents/`
