# Ethics and Responsible Use - output/frames/7dcbbfa3
...
**In this directory (`output/frames/7dcbbfa3`), the following ethical rules apply:**
...
Before committing work in `output/frames/7dcbbfa3`:
