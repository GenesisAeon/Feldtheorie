# Governance Policy - output/frames/71545597
...
This policy governs all work in `output/frames/71545597` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/71545597/.governance/incidents/`
