# Governance Policy - output/frames/d0d53dc8
...
This policy governs all work in `output/frames/d0d53dc8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d0d53dc8/.governance/incidents/`
