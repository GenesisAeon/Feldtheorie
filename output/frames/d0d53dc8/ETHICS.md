# Ethics and Responsible Use - output/frames/d0d53dc8
...
**In this directory (`output/frames/d0d53dc8`), the following ethical rules apply:**
...
Before committing work in `output/frames/d0d53dc8`:
