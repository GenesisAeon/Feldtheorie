# Ethics and Responsible Use - output/frames/be3b00ac
...
**In this directory (`output/frames/be3b00ac`), the following ethical rules apply:**
...
Before committing work in `output/frames/be3b00ac`:
