# Governance Policy - output/frames/be3b00ac
...
This policy governs all work in `output/frames/be3b00ac` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/be3b00ac/.governance/incidents/`
