# Governance Policy - output/frames/d4657459
...
This policy governs all work in `output/frames/d4657459` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d4657459/.governance/incidents/`
