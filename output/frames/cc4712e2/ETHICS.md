# Ethics and Responsible Use - output/frames/cc4712e2
...
**In this directory (`output/frames/cc4712e2`), the following ethical rules apply:**
...
Before committing work in `output/frames/cc4712e2`:
