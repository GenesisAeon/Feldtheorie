# Governance Policy - output/frames/cc4712e2
...
This policy governs all work in `output/frames/cc4712e2` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/cc4712e2/.governance/incidents/`
