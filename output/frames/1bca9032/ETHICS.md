# Ethics and Responsible Use - output/frames/1bca9032
...
**In this directory (`output/frames/1bca9032`), the following ethical rules apply:**
...
Before committing work in `output/frames/1bca9032`:
