# Governance Policy - output/frames/1bca9032
...
This policy governs all work in `output/frames/1bca9032` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1bca9032/.governance/incidents/`
