# Governance Policy - output/frames/16604498
...
This policy governs all work in `output/frames/16604498` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/16604498/.governance/incidents/`
