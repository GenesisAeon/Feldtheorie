# Ethics and Responsible Use - output/frames/94f1311a
...
**In this directory (`output/frames/94f1311a`), the following ethical rules apply:**
...
Before committing work in `output/frames/94f1311a`:
