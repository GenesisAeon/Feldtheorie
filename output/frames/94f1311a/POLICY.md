# Governance Policy - output/frames/94f1311a
...
This policy governs all work in `output/frames/94f1311a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/94f1311a/.governance/incidents/`
