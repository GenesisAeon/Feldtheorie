# Ethics and Responsible Use - output/frames/eebfab3e
...
**In this directory (`output/frames/eebfab3e`), the following ethical rules apply:**
...
Before committing work in `output/frames/eebfab3e`:
