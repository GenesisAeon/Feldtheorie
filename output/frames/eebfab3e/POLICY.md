# Governance Policy - output/frames/eebfab3e
...
This policy governs all work in `output/frames/eebfab3e` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/eebfab3e/.governance/incidents/`
