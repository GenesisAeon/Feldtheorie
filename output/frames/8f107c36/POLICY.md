# Governance Policy - output/frames/8f107c36
...
This policy governs all work in `output/frames/8f107c36` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8f107c36/.governance/incidents/`
