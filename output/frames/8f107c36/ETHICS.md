# Ethics and Responsible Use - output/frames/8f107c36
...
**In this directory (`output/frames/8f107c36`), the following ethical rules apply:**
...
Before committing work in `output/frames/8f107c36`:
