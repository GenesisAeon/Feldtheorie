# Governance Policy - output/frames/c16eab76
...
This policy governs all work in `output/frames/c16eab76` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c16eab76/.governance/incidents/`
