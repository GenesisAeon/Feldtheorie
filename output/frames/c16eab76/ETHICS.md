# Ethics and Responsible Use - output/frames/c16eab76
...
**In this directory (`output/frames/c16eab76`), the following ethical rules apply:**
...
Before committing work in `output/frames/c16eab76`:
