# Governance Policy - output/frames/c19c0cc6
...
This policy governs all work in `output/frames/c19c0cc6` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c19c0cc6/.governance/incidents/`
