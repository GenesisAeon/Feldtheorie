# Ethics and Responsible Use - output/frames/c19c0cc6
...
**In this directory (`output/frames/c19c0cc6`), the following ethical rules apply:**
...
Before committing work in `output/frames/c19c0cc6`:
