# Governance Policy - output/frames/c235d15c
...
This policy governs all work in `output/frames/c235d15c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c235d15c/.governance/incidents/`
