# Ethics and Responsible Use - output/frames/09a06b0e
...
**In this directory (`output/frames/09a06b0e`), the following ethical rules apply:**
...
Before committing work in `output/frames/09a06b0e`:
