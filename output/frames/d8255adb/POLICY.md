# Governance Policy - output/frames/d8255adb
...
This policy governs all work in `output/frames/d8255adb` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d8255adb/.governance/incidents/`
