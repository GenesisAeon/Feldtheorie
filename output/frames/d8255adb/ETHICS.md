# Ethics and Responsible Use - output/frames/d8255adb
...
**In this directory (`output/frames/d8255adb`), the following ethical rules apply:**
...
Before committing work in `output/frames/d8255adb`:
