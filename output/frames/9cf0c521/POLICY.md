# Governance Policy - output/frames/9cf0c521
...
This policy governs all work in `output/frames/9cf0c521` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9cf0c521/.governance/incidents/`
