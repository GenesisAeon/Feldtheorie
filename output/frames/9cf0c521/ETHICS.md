# Ethics and Responsible Use - output/frames/9cf0c521
...
**In this directory (`output/frames/9cf0c521`), the following ethical rules apply:**
...
Before committing work in `output/frames/9cf0c521`:
