# Governance Policy - output/frames/8cb22707
...
This policy governs all work in `output/frames/8cb22707` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8cb22707/.governance/incidents/`
