# Ethics and Responsible Use - output/frames/8cb22707
...
**In this directory (`output/frames/8cb22707`), the following ethical rules apply:**
...
Before committing work in `output/frames/8cb22707`:
