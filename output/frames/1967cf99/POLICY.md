# Governance Policy - output/frames/1967cf99
...
This policy governs all work in `output/frames/1967cf99` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/1967cf99/.governance/incidents/`
