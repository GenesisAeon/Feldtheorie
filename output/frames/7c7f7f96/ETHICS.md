# Ethics and Responsible Use - output/frames/7c7f7f96
...
**In this directory (`output/frames/7c7f7f96`), the following ethical rules apply:**
...
Before committing work in `output/frames/7c7f7f96`:
