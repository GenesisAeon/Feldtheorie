# Governance Policy - output/frames/7c7f7f96
...
This policy governs all work in `output/frames/7c7f7f96` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/7c7f7f96/.governance/incidents/`
