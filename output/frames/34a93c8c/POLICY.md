# Governance Policy - output/frames/34a93c8c
...
This policy governs all work in `output/frames/34a93c8c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/34a93c8c/.governance/incidents/`
