# Ethics and Responsible Use - output/frames/34a93c8c
...
**In this directory (`output/frames/34a93c8c`), the following ethical rules apply:**
...
Before committing work in `output/frames/34a93c8c`:
