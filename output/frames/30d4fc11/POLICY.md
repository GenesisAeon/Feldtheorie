# Governance Policy - output/frames/30d4fc11
...
This policy governs all work in `output/frames/30d4fc11` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/30d4fc11/.governance/incidents/`
