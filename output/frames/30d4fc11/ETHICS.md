# Ethics and Responsible Use - output/frames/30d4fc11
...
**In this directory (`output/frames/30d4fc11`), the following ethical rules apply:**
...
Before committing work in `output/frames/30d4fc11`:
