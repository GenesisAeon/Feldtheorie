# Governance Policy - output/frames/42348894
...
This policy governs all work in `output/frames/42348894` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/42348894/.governance/incidents/`
