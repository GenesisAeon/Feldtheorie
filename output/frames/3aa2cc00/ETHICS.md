# Ethics and Responsible Use - output/frames/3aa2cc00
...
**In this directory (`output/frames/3aa2cc00`), the following ethical rules apply:**
...
Before committing work in `output/frames/3aa2cc00`:
