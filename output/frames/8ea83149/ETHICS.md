# Ethics and Responsible Use - output/frames/8ea83149
...
**In this directory (`output/frames/8ea83149`), the following ethical rules apply:**
...
Before committing work in `output/frames/8ea83149`:
