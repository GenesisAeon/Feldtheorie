# Governance Policy - output/frames/8ea83149
...
This policy governs all work in `output/frames/8ea83149` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8ea83149/.governance/incidents/`
