# Ethics and Responsible Use - output/frames/1ac98c90
...
**In this directory (`output/frames/1ac98c90`), the following ethical rules apply:**
...
Before committing work in `output/frames/1ac98c90`:
