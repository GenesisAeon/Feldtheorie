# Ethics and Responsible Use - output/frames/f79c688a
...
**In this directory (`output/frames/f79c688a`), the following ethical rules apply:**
...
Before committing work in `output/frames/f79c688a`:
