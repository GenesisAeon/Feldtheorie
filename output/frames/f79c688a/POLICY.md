# Governance Policy - output/frames/f79c688a
...
This policy governs all work in `output/frames/f79c688a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f79c688a/.governance/incidents/`
