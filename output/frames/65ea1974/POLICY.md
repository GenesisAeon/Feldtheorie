# Governance Policy - output/frames/65ea1974
...
This policy governs all work in `output/frames/65ea1974` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/65ea1974/.governance/incidents/`
