# Ethics and Responsible Use - output/frames/65ea1974
...
**In this directory (`output/frames/65ea1974`), the following ethical rules apply:**
...
Before committing work in `output/frames/65ea1974`:
