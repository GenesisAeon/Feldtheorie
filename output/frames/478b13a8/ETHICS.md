# Ethics and Responsible Use - output/frames/478b13a8
...
**In this directory (`output/frames/478b13a8`), the following ethical rules apply:**
...
Before committing work in `output/frames/478b13a8`:
