# Governance Policy - output/frames/478b13a8
...
This policy governs all work in `output/frames/478b13a8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/478b13a8/.governance/incidents/`
