# Governance Policy - output/frames/ca94fe74
...
This policy governs all work in `output/frames/ca94fe74` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ca94fe74/.governance/incidents/`
