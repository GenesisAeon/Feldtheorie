# Ethics and Responsible Use - output/frames/ca94fe74
...
**In this directory (`output/frames/ca94fe74`), the following ethical rules apply:**
...
Before committing work in `output/frames/ca94fe74`:
