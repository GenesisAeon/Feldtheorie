# Governance Policy - output/frames/e87b24a4
...
This policy governs all work in `output/frames/e87b24a4` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e87b24a4/.governance/incidents/`
