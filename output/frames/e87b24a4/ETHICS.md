# Ethics and Responsible Use - output/frames/e87b24a4
...
**In this directory (`output/frames/e87b24a4`), the following ethical rules apply:**
...
Before committing work in `output/frames/e87b24a4`:
