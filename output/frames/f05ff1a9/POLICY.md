# Governance Policy - output/frames/f05ff1a9
...
This policy governs all work in `output/frames/f05ff1a9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/f05ff1a9/.governance/incidents/`
