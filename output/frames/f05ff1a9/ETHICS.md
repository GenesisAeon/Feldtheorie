# Ethics and Responsible Use - output/frames/f05ff1a9
...
**In this directory (`output/frames/f05ff1a9`), the following ethical rules apply:**
...
Before committing work in `output/frames/f05ff1a9`:
