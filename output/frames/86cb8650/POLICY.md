# Governance Policy - output/frames/86cb8650
...
This policy governs all work in `output/frames/86cb8650` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/86cb8650/.governance/incidents/`
