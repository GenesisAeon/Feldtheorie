# Ethics and Responsible Use - output/frames/86cb8650
...
**In this directory (`output/frames/86cb8650`), the following ethical rules apply:**
...
Before committing work in `output/frames/86cb8650`:
