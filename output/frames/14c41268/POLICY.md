# Governance Policy - output/frames/14c41268
...
This policy governs all work in `output/frames/14c41268` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/14c41268/.governance/incidents/`
