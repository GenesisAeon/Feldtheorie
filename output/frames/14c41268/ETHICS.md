# Ethics and Responsible Use - output/frames/14c41268
...
**In this directory (`output/frames/14c41268`), the following ethical rules apply:**
...
Before committing work in `output/frames/14c41268`:
