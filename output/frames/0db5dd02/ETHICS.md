# Ethics and Responsible Use - output/frames/0db5dd02
...
**In this directory (`output/frames/0db5dd02`), the following ethical rules apply:**
...
Before committing work in `output/frames/0db5dd02`:
