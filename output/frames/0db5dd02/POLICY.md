# Governance Policy - output/frames/0db5dd02
...
This policy governs all work in `output/frames/0db5dd02` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0db5dd02/.governance/incidents/`
