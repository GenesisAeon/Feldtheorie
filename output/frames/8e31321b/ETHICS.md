# Ethics and Responsible Use - output/frames/8e31321b
...
**In this directory (`output/frames/8e31321b`), the following ethical rules apply:**
...
Before committing work in `output/frames/8e31321b`:
