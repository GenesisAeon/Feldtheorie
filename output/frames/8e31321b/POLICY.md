# Governance Policy - output/frames/8e31321b
...
This policy governs all work in `output/frames/8e31321b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8e31321b/.governance/incidents/`
