# Governance Policy - output/frames/95b15422
...
This policy governs all work in `output/frames/95b15422` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/95b15422/.governance/incidents/`
