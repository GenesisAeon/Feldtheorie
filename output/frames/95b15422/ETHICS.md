# Ethics and Responsible Use - output/frames/95b15422
...
**In this directory (`output/frames/95b15422`), the following ethical rules apply:**
...
Before committing work in `output/frames/95b15422`:
