# Governance Policy - output/frames/bdf05a92
...
This policy governs all work in `output/frames/bdf05a92` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bdf05a92/.governance/incidents/`
