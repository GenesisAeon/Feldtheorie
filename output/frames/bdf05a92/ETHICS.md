# Ethics and Responsible Use - output/frames/bdf05a92
...
**In this directory (`output/frames/bdf05a92`), the following ethical rules apply:**
...
Before committing work in `output/frames/bdf05a92`:
