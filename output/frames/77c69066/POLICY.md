# Governance Policy - output/frames/77c69066
...
This policy governs all work in `output/frames/77c69066` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/77c69066/.governance/incidents/`
