# Ethics and Responsible Use - output/frames/77c69066
...
**In this directory (`output/frames/77c69066`), the following ethical rules apply:**
...
Before committing work in `output/frames/77c69066`:
