# Governance Policy - output/frames/9867d747
...
This policy governs all work in `output/frames/9867d747` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9867d747/.governance/incidents/`
