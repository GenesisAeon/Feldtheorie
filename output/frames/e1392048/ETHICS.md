# Ethics and Responsible Use - output/frames/e1392048
...
**In this directory (`output/frames/e1392048`), the following ethical rules apply:**
...
Before committing work in `output/frames/e1392048`:
