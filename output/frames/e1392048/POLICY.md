# Governance Policy - output/frames/e1392048
...
This policy governs all work in `output/frames/e1392048` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e1392048/.governance/incidents/`
