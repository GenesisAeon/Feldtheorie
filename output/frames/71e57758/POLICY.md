# Governance Policy - output/frames/71e57758
...
This policy governs all work in `output/frames/71e57758` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/71e57758/.governance/incidents/`
