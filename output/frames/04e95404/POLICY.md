# Governance Policy - output/frames/04e95404
...
This policy governs all work in `output/frames/04e95404` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/04e95404/.governance/incidents/`
