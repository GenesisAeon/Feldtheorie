# Ethics and Responsible Use - output/frames/533a8694
...
**In this directory (`output/frames/533a8694`), the following ethical rules apply:**
...
Before committing work in `output/frames/533a8694`:
