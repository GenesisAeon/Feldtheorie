# Governance Policy - output/frames/533a8694
...
This policy governs all work in `output/frames/533a8694` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/533a8694/.governance/incidents/`
