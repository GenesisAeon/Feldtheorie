# Ethics and Responsible Use - output/frames/43ee50ab
...
**In this directory (`output/frames/43ee50ab`), the following ethical rules apply:**
...
Before committing work in `output/frames/43ee50ab`:
