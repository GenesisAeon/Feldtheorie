# Governance Policy - output/frames/43ee50ab
...
This policy governs all work in `output/frames/43ee50ab` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/43ee50ab/.governance/incidents/`
