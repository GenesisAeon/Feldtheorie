# Ethics and Responsible Use - output/frames/ac182c35
...
**In this directory (`output/frames/ac182c35`), the following ethical rules apply:**
...
Before committing work in `output/frames/ac182c35`:
