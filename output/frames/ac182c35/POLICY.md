# Governance Policy - output/frames/ac182c35
...
This policy governs all work in `output/frames/ac182c35` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ac182c35/.governance/incidents/`
