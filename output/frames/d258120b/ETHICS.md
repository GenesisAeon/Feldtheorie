# Ethics and Responsible Use - output/frames/d258120b
...
**In this directory (`output/frames/d258120b`), the following ethical rules apply:**
...
Before committing work in `output/frames/d258120b`:
