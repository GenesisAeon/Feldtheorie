# Governance Policy - output/frames/d258120b
...
This policy governs all work in `output/frames/d258120b` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d258120b/.governance/incidents/`
