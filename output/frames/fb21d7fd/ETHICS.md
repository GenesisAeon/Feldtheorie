# Ethics and Responsible Use - output/frames/fb21d7fd
...
**In this directory (`output/frames/fb21d7fd`), the following ethical rules apply:**
...
Before committing work in `output/frames/fb21d7fd`:
