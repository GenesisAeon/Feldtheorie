# Governance Policy - output/frames/fb21d7fd
...
This policy governs all work in `output/frames/fb21d7fd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/fb21d7fd/.governance/incidents/`
