# Governance Policy - output/frames/9b9905e8
...
This policy governs all work in `output/frames/9b9905e8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9b9905e8/.governance/incidents/`
