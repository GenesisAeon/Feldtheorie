# Ethics and Responsible Use - output/frames/9b9905e8
...
**In this directory (`output/frames/9b9905e8`), the following ethical rules apply:**
...
Before committing work in `output/frames/9b9905e8`:
