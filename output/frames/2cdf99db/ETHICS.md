# Ethics and Responsible Use - output/frames/2cdf99db
...
**In this directory (`output/frames/2cdf99db`), the following ethical rules apply:**
...
Before committing work in `output/frames/2cdf99db`:
