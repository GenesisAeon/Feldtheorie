# Governance Policy - output/frames/2cdf99db
...
This policy governs all work in `output/frames/2cdf99db` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/2cdf99db/.governance/incidents/`
