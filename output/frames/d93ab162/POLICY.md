# Governance Policy - output/frames/d93ab162
...
This policy governs all work in `output/frames/d93ab162` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d93ab162/.governance/incidents/`
