# Governance Policy - output/frames/67638cf0
...
This policy governs all work in `output/frames/67638cf0` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/67638cf0/.governance/incidents/`
