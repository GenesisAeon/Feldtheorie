# Ethics and Responsible Use - output/frames/67638cf0
...
**In this directory (`output/frames/67638cf0`), the following ethical rules apply:**
...
Before committing work in `output/frames/67638cf0`:
