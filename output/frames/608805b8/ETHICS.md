# Ethics and Responsible Use - output/frames/608805b8
...
**In this directory (`output/frames/608805b8`), the following ethical rules apply:**
...
Before committing work in `output/frames/608805b8`:
