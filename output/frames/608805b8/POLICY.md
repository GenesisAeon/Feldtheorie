# Governance Policy - output/frames/608805b8
...
This policy governs all work in `output/frames/608805b8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/608805b8/.governance/incidents/`
