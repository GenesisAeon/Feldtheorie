# Ethics and Responsible Use - output/frames/e29f764c
...
**In this directory (`output/frames/e29f764c`), the following ethical rules apply:**
...
Before committing work in `output/frames/e29f764c`:
