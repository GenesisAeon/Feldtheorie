# Governance Policy - output/frames/e29f764c
...
This policy governs all work in `output/frames/e29f764c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e29f764c/.governance/incidents/`
