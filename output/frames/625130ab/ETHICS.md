# Ethics and Responsible Use - output/frames/625130ab
...
**In this directory (`output/frames/625130ab`), the following ethical rules apply:**
...
Before committing work in `output/frames/625130ab`:
