# Governance Policy - output/frames/625130ab
...
This policy governs all work in `output/frames/625130ab` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/625130ab/.governance/incidents/`
