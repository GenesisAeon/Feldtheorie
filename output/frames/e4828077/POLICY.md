# Governance Policy - output/frames/e4828077
...
This policy governs all work in `output/frames/e4828077` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e4828077/.governance/incidents/`
