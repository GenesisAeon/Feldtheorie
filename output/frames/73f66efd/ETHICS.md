# Ethics and Responsible Use - output/frames/73f66efd
...
**In this directory (`output/frames/73f66efd`), the following ethical rules apply:**
...
Before committing work in `output/frames/73f66efd`:
