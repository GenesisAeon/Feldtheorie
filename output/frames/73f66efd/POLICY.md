# Governance Policy - output/frames/73f66efd
...
This policy governs all work in `output/frames/73f66efd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/73f66efd/.governance/incidents/`
