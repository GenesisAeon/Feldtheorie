# Governance Policy - output/frames/43d819d5
...
This policy governs all work in `output/frames/43d819d5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/43d819d5/.governance/incidents/`
