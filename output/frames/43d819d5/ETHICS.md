# Ethics and Responsible Use - output/frames/43d819d5
...
**In this directory (`output/frames/43d819d5`), the following ethical rules apply:**
...
Before committing work in `output/frames/43d819d5`:
