# Governance Policy - output/frames/0caf6c74
...
This policy governs all work in `output/frames/0caf6c74` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/0caf6c74/.governance/incidents/`
