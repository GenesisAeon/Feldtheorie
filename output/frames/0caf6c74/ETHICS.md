# Ethics and Responsible Use - output/frames/0caf6c74
...
**In this directory (`output/frames/0caf6c74`), the following ethical rules apply:**
...
Before committing work in `output/frames/0caf6c74`:
