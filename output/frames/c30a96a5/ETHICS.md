# Ethics and Responsible Use - output/frames/c30a96a5
...
**In this directory (`output/frames/c30a96a5`), the following ethical rules apply:**
...
Before committing work in `output/frames/c30a96a5`:
