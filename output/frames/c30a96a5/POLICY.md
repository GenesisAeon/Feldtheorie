# Governance Policy - output/frames/c30a96a5
...
This policy governs all work in `output/frames/c30a96a5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c30a96a5/.governance/incidents/`
