# Ethics and Responsible Use - output/frames/00cadfd5
...
**In this directory (`output/frames/00cadfd5`), the following ethical rules apply:**
...
Before committing work in `output/frames/00cadfd5`:
