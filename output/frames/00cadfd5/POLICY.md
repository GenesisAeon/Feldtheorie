# Governance Policy - output/frames/00cadfd5
...
This policy governs all work in `output/frames/00cadfd5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/00cadfd5/.governance/incidents/`
