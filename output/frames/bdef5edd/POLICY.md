# Governance Policy - output/frames/bdef5edd
...
This policy governs all work in `output/frames/bdef5edd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/bdef5edd/.governance/incidents/`
