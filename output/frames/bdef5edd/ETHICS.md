# Ethics and Responsible Use - output/frames/bdef5edd
...
**In this directory (`output/frames/bdef5edd`), the following ethical rules apply:**
...
Before committing work in `output/frames/bdef5edd`:
