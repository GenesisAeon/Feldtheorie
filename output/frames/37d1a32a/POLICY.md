# Governance Policy - output/frames/37d1a32a
...
This policy governs all work in `output/frames/37d1a32a` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/37d1a32a/.governance/incidents/`
