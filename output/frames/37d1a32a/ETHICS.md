# Ethics and Responsible Use - output/frames/37d1a32a
...
**In this directory (`output/frames/37d1a32a`), the following ethical rules apply:**
...
Before committing work in `output/frames/37d1a32a`:
