# Ethics and Responsible Use - output/frames/9e7c90f5
...
**In this directory (`output/frames/9e7c90f5`), the following ethical rules apply:**
...
Before committing work in `output/frames/9e7c90f5`:
