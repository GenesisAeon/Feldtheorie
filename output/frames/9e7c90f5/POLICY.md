# Governance Policy - output/frames/9e7c90f5
...
This policy governs all work in `output/frames/9e7c90f5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/9e7c90f5/.governance/incidents/`
