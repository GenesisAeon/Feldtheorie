# Ethics and Responsible Use - output/frames/c636494f
...
**In this directory (`output/frames/c636494f`), the following ethical rules apply:**
...
Before committing work in `output/frames/c636494f`:
