# Governance Policy - output/frames/c636494f
...
This policy governs all work in `output/frames/c636494f` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c636494f/.governance/incidents/`
