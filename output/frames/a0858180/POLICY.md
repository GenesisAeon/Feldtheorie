# Governance Policy - output/frames/a0858180
...
This policy governs all work in `output/frames/a0858180` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a0858180/.governance/incidents/`
