# Governance Policy - output/frames/33f3f7a2
...
This policy governs all work in `output/frames/33f3f7a2` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/33f3f7a2/.governance/incidents/`
