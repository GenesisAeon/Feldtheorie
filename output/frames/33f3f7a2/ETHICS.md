# Ethics and Responsible Use - output/frames/33f3f7a2
...
**In this directory (`output/frames/33f3f7a2`), the following ethical rules apply:**
...
Before committing work in `output/frames/33f3f7a2`:
