# Ethics and Responsible Use - output/frames/a9af1dbe
...
**In this directory (`output/frames/a9af1dbe`), the following ethical rules apply:**
...
Before committing work in `output/frames/a9af1dbe`:
