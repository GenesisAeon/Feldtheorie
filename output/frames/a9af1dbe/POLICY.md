# Governance Policy - output/frames/a9af1dbe
...
This policy governs all work in `output/frames/a9af1dbe` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/a9af1dbe/.governance/incidents/`
