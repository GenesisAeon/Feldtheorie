# Ethics and Responsible Use - output/frames/8ea3a096
...
**In this directory (`output/frames/8ea3a096`), the following ethical rules apply:**
...
Before committing work in `output/frames/8ea3a096`:
