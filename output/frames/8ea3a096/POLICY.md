# Governance Policy - output/frames/8ea3a096
...
This policy governs all work in `output/frames/8ea3a096` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/8ea3a096/.governance/incidents/`
