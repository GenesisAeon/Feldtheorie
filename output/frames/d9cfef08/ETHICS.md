# Ethics and Responsible Use - output/frames/d9cfef08
...
**In this directory (`output/frames/d9cfef08`), the following ethical rules apply:**
...
Before committing work in `output/frames/d9cfef08`:
