# Governance Policy - output/frames/d9cfef08
...
This policy governs all work in `output/frames/d9cfef08` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/d9cfef08/.governance/incidents/`
