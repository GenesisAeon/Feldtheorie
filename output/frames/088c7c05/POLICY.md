# Governance Policy - output/frames/088c7c05
...
This policy governs all work in `output/frames/088c7c05` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/088c7c05/.governance/incidents/`
