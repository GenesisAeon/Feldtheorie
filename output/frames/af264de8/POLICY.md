# Governance Policy - output/frames/af264de8
...
This policy governs all work in `output/frames/af264de8` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/af264de8/.governance/incidents/`
