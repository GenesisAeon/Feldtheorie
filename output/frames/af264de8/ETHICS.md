# Ethics and Responsible Use - output/frames/af264de8
...
**In this directory (`output/frames/af264de8`), the following ethical rules apply:**
...
Before committing work in `output/frames/af264de8`:
