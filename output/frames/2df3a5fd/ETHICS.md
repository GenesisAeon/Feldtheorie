# Ethics and Responsible Use - output/frames/2df3a5fd
...
**In this directory (`output/frames/2df3a5fd`), the following ethical rules apply:**
...
Before committing work in `output/frames/2df3a5fd`:
