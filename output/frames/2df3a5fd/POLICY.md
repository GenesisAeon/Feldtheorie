# Governance Policy - output/frames/2df3a5fd
...
This policy governs all work in `output/frames/2df3a5fd` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/2df3a5fd/.governance/incidents/`
