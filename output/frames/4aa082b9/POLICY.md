# Governance Policy - output/frames/4aa082b9
...
This policy governs all work in `output/frames/4aa082b9` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/4aa082b9/.governance/incidents/`
