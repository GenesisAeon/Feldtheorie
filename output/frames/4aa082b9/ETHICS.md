# Ethics and Responsible Use - output/frames/4aa082b9
...
**In this directory (`output/frames/4aa082b9`), the following ethical rules apply:**
...
Before committing work in `output/frames/4aa082b9`:
