# Governance Policy - output/frames/961d00fe
...
This policy governs all work in `output/frames/961d00fe` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/961d00fe/.governance/incidents/`
