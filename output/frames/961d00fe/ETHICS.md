# Ethics and Responsible Use - output/frames/961d00fe
...
**In this directory (`output/frames/961d00fe`), the following ethical rules apply:**
...
Before committing work in `output/frames/961d00fe`:
