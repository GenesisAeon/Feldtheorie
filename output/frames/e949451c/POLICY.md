# Governance Policy - output/frames/e949451c
...
This policy governs all work in `output/frames/e949451c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/e949451c/.governance/incidents/`
