# Governance Policy - output/frames/ecd0554c
...
This policy governs all work in `output/frames/ecd0554c` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ecd0554c/.governance/incidents/`
