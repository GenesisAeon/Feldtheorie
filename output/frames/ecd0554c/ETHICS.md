# Ethics and Responsible Use - output/frames/ecd0554c
...
**In this directory (`output/frames/ecd0554c`), the following ethical rules apply:**
...
Before committing work in `output/frames/ecd0554c`:
