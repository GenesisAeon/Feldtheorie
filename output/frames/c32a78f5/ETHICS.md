# Ethics and Responsible Use - output/frames/c32a78f5
...
**In this directory (`output/frames/c32a78f5`), the following ethical rules apply:**
...
Before committing work in `output/frames/c32a78f5`:
