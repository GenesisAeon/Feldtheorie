# Governance Policy - output/frames/c32a78f5
...
This policy governs all work in `output/frames/c32a78f5` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c32a78f5/.governance/incidents/`
