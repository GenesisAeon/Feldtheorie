# Governance Policy - output/frames/3d9ef2c3
...
This policy governs all work in `output/frames/3d9ef2c3` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/3d9ef2c3/.governance/incidents/`
