# Ethics and Responsible Use - output/frames/3d9ef2c3
...
**In this directory (`output/frames/3d9ef2c3`), the following ethical rules apply:**
...
Before committing work in `output/frames/3d9ef2c3`:
