# Governance Policy - output/frames/c6491694
...
This policy governs all work in `output/frames/c6491694` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/c6491694/.governance/incidents/`
