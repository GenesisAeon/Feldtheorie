# Governance Policy - output/frames/ff28e6a7
...
This policy governs all work in `output/frames/ff28e6a7` and its subdirectories.
...
1. **Document**: Create incident report in `output/frames/ff28e6a7/.governance/incidents/`
