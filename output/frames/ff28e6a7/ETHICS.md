# Ethics and Responsible Use - output/frames/ff28e6a7
...
**In this directory (`output/frames/ff28e6a7`), the following ethical rules apply:**
...
Before committing work in `output/frames/ff28e6a7`:
