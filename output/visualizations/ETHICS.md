# Ethics and Responsible Use - output/visualizations
...
**In this directory (`output/visualizations`), the following ethical rules apply:**
...
Before committing work in `output/visualizations`:
