# Agents Charter - output/visualizations/wavefunction
...
**This directory (`output/visualizations/wavefunction`) is specialized for:**
...
1. Check the parent governance: `output/visualizations/AGENTS.md`
