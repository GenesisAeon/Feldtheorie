# Ethics and Responsible Use - output/visualizations/wavefunction
...
**In this directory (`output/visualizations/wavefunction`), the following ethical rules apply:**
...
Before committing work in `output/visualizations/wavefunction`:
