# Governance Policy - output/visualizations/wavefunction
...
2. **Parent Context** (`output/visualizations/POLICY.md`)
...
This policy governs all work in `output/visualizations/wavefunction` and its subdirectories.
...
1. **Document**: Create incident report in `output/visualizations/wavefunction/.governance/incidents/`
