# Governance Policy - output/visualizations
...
2. **Parent Context** (`output/POLICY.md`)
...
This policy governs all work in `output/visualizations` and its subdirectories.
...
1. **Document**: Create incident report in `output/visualizations/.governance/incidents/`
