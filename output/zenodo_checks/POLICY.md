# Governance Policy - output/zenodo_checks
...
This policy governs all work in `output/zenodo_checks` and its subdirectories.
...
1. **Document**: Create incident report in `output/zenodo_checks/.governance/incidents/`
