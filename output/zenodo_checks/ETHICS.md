# Ethics and Responsible Use - output/zenodo_checks
...
**In this directory (`output/zenodo_checks`), the following ethical rules apply:**
...
Before committing work in `output/zenodo_checks`:
