# Governance Policy - v9_alpha/docs
...
This policy governs all work in `v9_alpha/docs` and its subdirectories.
...
1. **Document**: Create incident report in `v9_alpha/docs/.governance/incidents/`
