# Governance Policy - v9_alpha/models
...
This policy governs all work in `v9_alpha/models` and its subdirectories.
...
1. **Document**: Create incident report in `v9_alpha/models/.governance/incidents/`
