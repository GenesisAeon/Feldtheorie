# Ethics and Responsible Use - v9_alpha/models
...
**In this directory (`v9_alpha/models`), the following ethical rules apply:**
...
Before committing work in `v9_alpha/models`:
