# Governance Policy - config/pipelines
...
This policy governs all work in `config/pipelines` and its subdirectories.
...
1. **Document**: Create incident report in `config/pipelines/.governance/incidents/`
