# Ethics and Responsible Use - config/pipelines
...
**In this directory (`config/pipelines`), the following ethical rules apply:**
...
Before committing work in `config/pipelines`:
