# Governance Policy - v10_oracle/models
...
This policy governs all work in `v10_oracle/models` and its subdirectories.
...
1. **Document**: Create incident report in `v10_oracle/models/.governance/incidents/`
