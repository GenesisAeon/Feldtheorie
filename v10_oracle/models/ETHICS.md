# Ethics and Responsible Use - v10_oracle/models
...
**In this directory (`v10_oracle/models`), the following ethical rules apply:**
...
Before committing work in `v10_oracle/models`:
