...
def main():
    ...
    parser.add_argument(
        "--real", action="store_true", help="Use REAL NOAA data (default: synthetic)"
    )
    ...
    try:
        ...
        if args.plot:
            try:
                ...
                ax1.set_title(
                    f'NOAA OISST - {args.region.replace("_", " ").title()}',
                    fontsize=14,
                    fontweight="bold",
                )
                ax1.legend()
