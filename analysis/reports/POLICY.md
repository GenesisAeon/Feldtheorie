# Governance Policy - analysis/reports
...
This policy governs all work in `analysis/reports` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/reports/.governance/incidents/`
