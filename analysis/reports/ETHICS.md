# Ethics and Responsible Use - analysis/reports
...
**In this directory (`analysis/reports`), the following ethical rules apply:**
...
Before committing work in `analysis/reports`:
