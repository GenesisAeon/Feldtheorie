# Governance Policy - analysis/results/frequency_profiles
...
2. **Parent Context** (`analysis/results/POLICY.md`)
...
This policy governs all work in `analysis/results/frequency_profiles` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/results/frequency_profiles/.governance/incidents/`
