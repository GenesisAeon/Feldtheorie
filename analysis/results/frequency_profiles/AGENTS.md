# Agents Charter - analysis/results/frequency_profiles
...
**This directory (`analysis/results/frequency_profiles`) is specialized for:**
...
1. Check the parent governance: `analysis/results/AGENTS.md`
