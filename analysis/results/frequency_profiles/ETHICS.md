# Ethics and Responsible Use - analysis/results/frequency_profiles
...
**In this directory (`analysis/results/frequency_profiles`), the following ethical rules apply:**
...
Before committing work in `analysis/results/frequency_profiles`:
