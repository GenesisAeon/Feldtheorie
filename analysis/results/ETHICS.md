# Ethics and Responsible Use - analysis/results
...
**In this directory (`analysis/results`), the following ethical rules apply:**
...
Before committing work in `analysis/results`:
