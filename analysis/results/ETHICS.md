# Ethics and Responsible Use - science/analysis/results
...
**In this directory (`science/analysis/results`), the following ethical rules apply:**
...
Before committing work in `science/analysis/results`:
