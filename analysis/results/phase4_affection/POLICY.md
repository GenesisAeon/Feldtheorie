# Governance Policy - analysis/results/phase4_affection
...
This policy governs all work in `analysis/results/phase4_affection` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/results/phase4_affection/.governance/incidents/`
