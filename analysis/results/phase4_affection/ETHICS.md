# Ethics and Responsible Use - analysis/results/phase4_affection
...
**In this directory (`analysis/results/phase4_affection`), the following ethical rules apply:**
...
Before committing work in `analysis/results/phase4_affection`:
