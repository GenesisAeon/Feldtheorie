# Ethics and Responsible Use - analysis/results/figures
...
**In this directory (`analysis/results/figures`), the following ethical rules apply:**
...
Before committing work in `analysis/results/figures`:
