# Governance Policy - analysis/results/figures
...
This policy governs all work in `analysis/results/figures` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/results/figures/.governance/incidents/`
