# Governance Policy - analysis/results
...
This policy governs all work in `analysis/results` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/results/.governance/incidents/`
