# Governance Policy - analysis/sigillin_sync
...
2. **Parent Context** (`analysis/POLICY.md`)
...
This policy governs all work in `analysis/sigillin_sync` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/sigillin_sync/.governance/incidents/`
