# Ethics and Responsible Use - analysis/sigillin_sync
...
**In this directory (`analysis/sigillin_sync`), the following ethical rules apply:**
...
Before committing work in `analysis/sigillin_sync`:
