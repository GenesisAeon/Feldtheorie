# Governance Policy - science/analysis
...
This policy governs all work in `science/analysis` and its subdirectories.
...
1. **Document**: Create incident report in `science/analysis/.governance/incidents/`
