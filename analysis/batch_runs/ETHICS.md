# Ethics and Responsible Use - analysis/batch_runs
...
**In this directory (`analysis/batch_runs`), the following ethical rules apply:**
...
Before committing work in `analysis/batch_runs`:
