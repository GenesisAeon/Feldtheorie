# Governance Policy - analysis/batch_runs
...
This policy governs all work in `analysis/batch_runs` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/batch_runs/.governance/incidents/`
