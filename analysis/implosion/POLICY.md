# Governance Policy - analysis/implosion
...
This policy governs all work in `analysis/implosion` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/implosion/.governance/incidents/`
