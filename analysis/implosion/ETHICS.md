# Ethics and Responsible Use - analysis/implosion
...
**In this directory (`analysis/implosion`), the following ethical rules apply:**
...
Before committing work in `analysis/implosion`:
