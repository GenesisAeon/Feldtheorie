# Governance Policy - analysis/notes
...
This policy governs all work in `analysis/notes` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/notes/.governance/incidents/`
