# Ethics and Responsible Use - analysis/experiments
...
**In this directory (`analysis/experiments`), the following ethical rules apply:**
...
Before committing work in `analysis/experiments`:
