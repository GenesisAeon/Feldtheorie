# Governance Policy - analysis/plots
...
This policy governs all work in `analysis/plots` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/plots/.governance/incidents/`
