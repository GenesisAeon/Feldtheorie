# Ethics and Responsible Use - analysis/batch_configs
...
**In this directory (`analysis/batch_configs`), the following ethical rules apply:**
...
Before committing work in `analysis/batch_configs`:
