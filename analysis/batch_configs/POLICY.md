# Governance Policy - analysis/batch_configs
...
This policy governs all work in `analysis/batch_configs` and its subdirectories.
...
1. **Document**: Create incident report in `analysis/batch_configs/.governance/incidents/`
