# Governance Policy - api/dashboard
...
2. **Parent Context** (`api/POLICY.md`)
...
This policy governs all work in `api/dashboard` and its subdirectories.
...
1. **Document**: Create incident report in `api/dashboard/.governance/incidents/`
