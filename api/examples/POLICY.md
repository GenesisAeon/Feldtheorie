# Governance Policy - api/examples
...
This policy governs all work in `api/examples` and its subdirectories.
...
1. **Document**: Create incident report in `api/examples/.governance/incidents/`
