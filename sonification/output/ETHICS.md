# Ethics and Responsible Use - sonification/output
...
**In this directory (`sonification/output`), the following ethical rules apply:**
...
Before committing work in `sonification/output`:
