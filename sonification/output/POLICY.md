# Governance Policy - sonification/output
...
This policy governs all work in `sonification/output` and its subdirectories.
...
1. **Document**: Create incident report in `sonification/output/.governance/incidents/`
