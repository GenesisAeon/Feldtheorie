# Ethics and Responsible Use - simulator/src/utils
...
**In this directory (`simulator/src/utils`), the following ethical rules apply:**
...
Before committing work in `simulator/src/utils`:
