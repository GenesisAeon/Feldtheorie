# Governance Policy - simulator/src/components
...
2. **Parent Context** (`simulator/src/POLICY.md`)
...
This policy governs all work in `simulator/src/components` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/src/components/.governance/incidents/`
