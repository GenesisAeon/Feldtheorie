# Agents Charter - simulator/src/components
...
**This directory (`simulator/src/components`) is specialized for:**
...
1. Check the parent governance: `simulator/src/AGENTS.md`
