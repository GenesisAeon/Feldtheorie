# Ethics and Responsible Use - simulator/src/components
...
**In this directory (`simulator/src/components`), the following ethical rules apply:**
...
Before committing work in `simulator/src/components`:
