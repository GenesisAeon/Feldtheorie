# Ethics and Responsible Use - simulator/src/api
...
**In this directory (`simulator/src/api`), the following ethical rules apply:**
...
Before committing work in `simulator/src/api`:
