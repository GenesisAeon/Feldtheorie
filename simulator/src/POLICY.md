# Governance Policy - simulator/src
...
This policy governs all work in `simulator/src` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/src/.governance/incidents/`
