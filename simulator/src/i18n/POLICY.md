# Governance Policy - simulator/src/i18n
...
This policy governs all work in `simulator/src/i18n` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/src/i18n/.governance/incidents/`
