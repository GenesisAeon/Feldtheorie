# Ethics and Responsible Use - simulator/src/i18n
...
**In this directory (`simulator/src/i18n`), the following ethical rules apply:**
...
Before committing work in `simulator/src/i18n`:
