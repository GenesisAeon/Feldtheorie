# Governance Policy - simulator/src/hooks
...
This policy governs all work in `simulator/src/hooks` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/src/hooks/.governance/incidents/`
