# Ethics and Responsible Use - simulator/src/hooks
...
**In this directory (`simulator/src/hooks`), the following ethical rules apply:**
...
Before committing work in `simulator/src/hooks`:
