# Governance Policy - simulator/presets
...
2. **Parent Context** (`simulator/POLICY.md`)
...
This policy governs all work in `simulator/presets` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/presets/.governance/incidents/`
