# Ethics and Responsible Use - simulator/presets
...
**In this directory (`simulator/presets`), the following ethical rules apply:**
...
Before committing work in `simulator/presets`:
