# Governance Policy - simulator/docs
...
This policy governs all work in `simulator/docs` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/docs/.governance/incidents/`
