# Governance Policy - simulator/phase4
...
This policy governs all work in `simulator/phase4` and its subdirectories.
...
1. **Document**: Create incident report in `simulator/phase4/.governance/incidents/`
