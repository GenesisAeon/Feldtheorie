# Ethics and Responsible Use - simulator/phase4
...
**In this directory (`simulator/phase4`), the following ethical rules apply:**
...
Before committing work in `simulator/phase4`:
