# Governance Policy - archive/v3_ideas/NextVersionmaybe
...
2. **Parent Context** (`archive/v3_ideas/POLICY.md`)
...
This policy governs all work in `archive/v3_ideas/NextVersionmaybe` and its subdirectories.
...
1. **Document**: Create incident report in `archive/v3_ideas/NextVersionmaybe/.governance/incidents/`
