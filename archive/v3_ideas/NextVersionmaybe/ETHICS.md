# Ethics and Responsible Use - archive/v3_ideas/NextVersionmaybe
...
**In this directory (`archive/v3_ideas/NextVersionmaybe`), the following ethical rules apply:**
...
Before committing work in `archive/v3_ideas/NextVersionmaybe`:
