# Agents Charter - archive/v3_ideas/NextVersionmaybe
...
**This directory (`archive/v3_ideas/NextVersionmaybe`) is specialized for:**
...
1. Check the parent governance: `archive/v3_ideas/AGENTS.md`
