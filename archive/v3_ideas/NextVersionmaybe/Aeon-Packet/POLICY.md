# Governance Policy - archive/v3_ideas/NextVersionmaybe/Aeon-Packet
...
2. **Parent Context** (`archive/v3_ideas/NextVersionmaybe/POLICY.md`)
...
This policy governs all work in `archive/v3_ideas/NextVersionmaybe/Aeon-Packet` and its subdirectories.
...
1. **Document**: Create incident report in `archive/v3_ideas/NextVersionmaybe/Aeon-Packet/.governance/incidents/`
