# Ethics and Responsible Use - archive/v3_ideas/NextVersionmaybe/Aeon-Packet
...
**In this directory (`archive/v3_ideas/NextVersionmaybe/Aeon-Packet`), the following ethical rules apply:**
...
Before committing work in `archive/v3_ideas/NextVersionmaybe/Aeon-Packet`:
