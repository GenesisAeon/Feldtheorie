# Governance Policy - archive/v3_ideas
...
This policy governs all work in `archive/v3_ideas` and its subdirectories.
...
1. **Document**: Create incident report in `archive/v3_ideas/.governance/incidents/`
