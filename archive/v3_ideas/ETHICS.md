# Ethics and Responsible Use - archive/v3_ideas
...
**In this directory (`archive/v3_ideas`), the following ethical rules apply:**
...
Before committing work in `archive/v3_ideas`:
