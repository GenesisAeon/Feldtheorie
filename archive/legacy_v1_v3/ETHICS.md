# Ethics and Responsible Use - archive/legacy_v1_v3
...
**In this directory (`archive/legacy_v1_v3`), the following ethical rules apply:**
...
Before committing work in `archive/legacy_v1_v3`:
