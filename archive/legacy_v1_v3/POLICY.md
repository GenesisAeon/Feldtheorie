# Governance Policy - archive/legacy_v1_v3
...
2. **Parent Context** (`archive/POLICY.md`)
...
This policy governs all work in `archive/legacy_v1_v3` and its subdirectories.
...
1. **Document**: Create incident report in `archive/legacy_v1_v3/.governance/incidents/`
