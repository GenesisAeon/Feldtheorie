# Ethics and Responsible Use - seed/RoadToV.3/Claude-Datenpacket
...
**In this directory (`seed/RoadToV.3/Claude-Datenpacket`), the following ethical rules apply:**
...
Before committing work in `seed/RoadToV.3/Claude-Datenpacket`:
