# Ethics and Responsible Use - seed/RoadToV.3/UTAC Empirical Validation v2.0
...
**In this directory (`seed/RoadToV.3/UTAC Empirical Validation v2.0`), the following ethical rules apply:**
...
Before committing work in `seed/RoadToV.3/UTAC Empirical Validation v2.0`:
