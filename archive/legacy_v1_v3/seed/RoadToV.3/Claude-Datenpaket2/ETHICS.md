# Ethics and Responsible Use - seed/RoadToV.3/Claude-Datenpaket2
...
**In this directory (`seed/RoadToV.3/Claude-Datenpaket2`), the following ethical rules apply:**
...
Before committing work in `seed/RoadToV.3/Claude-Datenpaket2`:
