# Ethics and Responsible Use - seed/RoadToV.3/Action
...
**In this directory (`seed/RoadToV.3/Action`), the following ethical rules apply:**
...
Before committing work in `seed/RoadToV.3/Action`:
