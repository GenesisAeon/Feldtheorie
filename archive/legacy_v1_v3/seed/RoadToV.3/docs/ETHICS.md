# Ethics and Responsible Use - seed/RoadToV.3/docs
...
**In this directory (`seed/RoadToV.3/docs`), the following ethical rules apply:**
...
Before committing work in `seed/RoadToV.3/docs`:
