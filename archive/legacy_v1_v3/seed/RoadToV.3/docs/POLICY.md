# Governance Policy - seed/RoadToV.3/docs
...
This policy governs all work in `seed/RoadToV.3/docs` and its subdirectories.
...
1. **Document**: Create incident report in `seed/RoadToV.3/docs/.governance/incidents/`
