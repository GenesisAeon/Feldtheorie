# Ethics and Responsible Use - seed/FraktaltagebuchV2/entries
...
**In this directory (`seed/FraktaltagebuchV2/entries`), the following ethical rules apply:**
...
Before committing work in `seed/FraktaltagebuchV2/entries`:
