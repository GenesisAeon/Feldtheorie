# Governance Policy - seed/FraktaltagebuchV2/entries
...
2. **Parent Context** (`seed/FraktaltagebuchV2/POLICY.md`)
...
This policy governs all work in `seed/FraktaltagebuchV2/entries` and its subdirectories.
...
1. **Document**: Create incident report in `seed/FraktaltagebuchV2/entries/.governance/incidents/`
