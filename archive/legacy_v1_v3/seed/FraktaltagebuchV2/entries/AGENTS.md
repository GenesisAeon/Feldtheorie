# Agents Charter - seed/FraktaltagebuchV2/entries
...
**This directory (`seed/FraktaltagebuchV2/entries`) is specialized for:**
...
1. Check the parent governance: `seed/FraktaltagebuchV2/AGENTS.md`
