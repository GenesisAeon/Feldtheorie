# Governance Policy - seed/FraktaltagebuchV2
...
This policy governs all work in `seed/FraktaltagebuchV2` and its subdirectories.
...
1. **Document**: Create incident report in `seed/FraktaltagebuchV2/.governance/incidents/`
