# Ethics and Responsible Use - seed/FraktaltagebuchV2
...
**In this directory (`seed/FraktaltagebuchV2`), the following ethical rules apply:**
...
Before committing work in `seed/FraktaltagebuchV2`:
