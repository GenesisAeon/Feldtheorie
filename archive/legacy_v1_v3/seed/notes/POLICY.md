# Governance Policy - archive/legacy_v1_v3/seed/notes
...
2. **Parent Context** (`archive/legacy_v1_v3/seed/POLICY.md`)
...
This policy governs all work in `archive/legacy_v1_v3/seed/notes` and its subdirectories.
...
1. **Document**: Create incident report in `archive/legacy_v1_v3/seed/notes/.governance/incidents/`
