# Governance Policy - archive/legacy_v1_v3/seed
...
This policy governs all work in `archive/legacy_v1_v3/seed` and its subdirectories.
...
1. **Document**: Create incident report in `archive/legacy_v1_v3/seed/.governance/incidents/`
