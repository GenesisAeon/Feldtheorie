# Governance Policy - seed/FraktaltagebuchV3
...
This policy governs all work in `seed/FraktaltagebuchV3` and its subdirectories.
...
1. **Document**: Create incident report in `seed/FraktaltagebuchV3/.governance/incidents/`
