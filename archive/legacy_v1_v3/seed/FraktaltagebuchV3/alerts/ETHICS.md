# Ethics and Responsible Use - seed/FraktaltagebuchV3/alerts
...
**In this directory (`seed/FraktaltagebuchV3/alerts`), the following ethical rules apply:**
...
Before committing work in `seed/FraktaltagebuchV3/alerts`:
