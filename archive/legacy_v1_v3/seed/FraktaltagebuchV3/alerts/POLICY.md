# Governance Policy - seed/FraktaltagebuchV3/alerts
...
This policy governs all work in `seed/FraktaltagebuchV3/alerts` and its subdirectories.
...
1. **Document**: Create incident report in `seed/FraktaltagebuchV3/alerts/.governance/incidents/`
