# Ethics and Responsible Use - seed/FraktaltagebuchV3/systems
...
**In this directory (`seed/FraktaltagebuchV3/systems`), the following ethical rules apply:**
...
Before committing work in `seed/FraktaltagebuchV3/systems`:
