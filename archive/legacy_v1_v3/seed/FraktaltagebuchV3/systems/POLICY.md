# Governance Policy - seed/FraktaltagebuchV3/systems
...
2. **Parent Context** (`seed/FraktaltagebuchV3/POLICY.md`)
...
This policy governs all work in `seed/FraktaltagebuchV3/systems` and its subdirectories.
...
1. **Document**: Create incident report in `seed/FraktaltagebuchV3/systems/.governance/incidents/`
