# Ethics and Responsible Use - seed/FraktaltagebuchV3
...
**In this directory (`seed/FraktaltagebuchV3`), the following ethical rules apply:**
...
Before committing work in `seed/FraktaltagebuchV3`:
