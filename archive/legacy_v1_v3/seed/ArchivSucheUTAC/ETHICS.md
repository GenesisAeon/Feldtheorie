# Ethics and Responsible Use - seed/ArchivSucheUTAC
...
**In this directory (`seed/ArchivSucheUTAC`), the following ethical rules apply:**
...
Before committing work in `seed/ArchivSucheUTAC`:
