# Governance Policy - seed/ArchivSucheUTAC
...
This policy governs all work in `seed/ArchivSucheUTAC` and its subdirectories.
...
1. **Document**: Create incident report in `seed/ArchivSucheUTAC/.governance/incidents/`
