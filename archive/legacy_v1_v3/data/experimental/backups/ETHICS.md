# Ethics and Responsible Use - archive/legacy_v1_v3/data/experimental/backups
...
**In this directory (`archive/legacy_v1_v3/data/experimental/backups`), the following ethical rules apply:**
...
Before committing work in `archive/legacy_v1_v3/data/experimental/backups`:
