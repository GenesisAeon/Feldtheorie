# Agents Charter - archive/legacy_v1_v3/data/experimental
...
**This directory (`archive/legacy_v1_v3/data/experimental`) is specialized for:**
...
1. Check the parent governance: `archive/legacy_v1_v3/data/AGENTS.md`
