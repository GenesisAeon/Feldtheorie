# Governance Policy - archive/legacy_v1_v3/data
...
2. **Parent Context** (`archive/legacy_v1_v3/POLICY.md`)
...
This policy governs all work in `archive/legacy_v1_v3/data` and its subdirectories.
...
1. **Document**: Create incident report in `archive/legacy_v1_v3/data/.governance/incidents/`
