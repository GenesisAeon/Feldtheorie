# Governance Policy - src/analysis
...
This policy governs all work in `src/analysis` and its subdirectories.
...
1. **Document**: Create incident report in `src/analysis/.governance/incidents/`
