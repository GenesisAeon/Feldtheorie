# Ethics and Responsible Use - v11_gardener/docs
...
**In this directory (`v11_gardener/docs`), the following ethical rules apply:**
...
Before committing work in `v11_gardener/docs`:
