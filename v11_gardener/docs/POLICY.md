# Governance Policy - v11_gardener/docs
...
This policy governs all work in `v11_gardener/docs` and its subdirectories.
...
1. **Document**: Create incident report in `v11_gardener/docs/.governance/incidents/`
