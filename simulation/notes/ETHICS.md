# Ethics and Responsible Use - simulation/notes
...
**In this directory (`simulation/notes`), the following ethical rules apply:**
...
Before committing work in `simulation/notes`:
