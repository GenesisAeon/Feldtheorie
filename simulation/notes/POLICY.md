# Governance Policy - simulation/notes
...
This policy governs all work in `simulation/notes` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/notes/.governance/incidents/`
