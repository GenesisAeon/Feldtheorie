# Governance Policy - simulation/phase4
...
This policy governs all work in `simulation/phase4` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/phase4/.governance/incidents/`
