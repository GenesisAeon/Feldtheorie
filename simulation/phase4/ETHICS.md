# Ethics and Responsible Use - simulation/phase4
...
**In this directory (`simulation/phase4`), the following ethical rules apply:**
...
Before committing work in `simulation/phase4`:
