# Ethics and Responsible Use - simulation/v3_noosphere/spatial
...
**In this directory (`simulation/v3_noosphere/spatial`), the following ethical rules apply:**
...
Before committing work in `simulation/v3_noosphere/spatial`:
