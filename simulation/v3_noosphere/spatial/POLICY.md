# Governance Policy - simulation/v3_noosphere/spatial
...
This policy governs all work in `simulation/v3_noosphere/spatial` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v3_noosphere/spatial/.governance/incidents/`
