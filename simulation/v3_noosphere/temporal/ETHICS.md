# Ethics and Responsible Use - simulation/v3_noosphere/temporal
...
**In this directory (`simulation/v3_noosphere/temporal`), the following ethical rules apply:**
...
Before committing work in `simulation/v3_noosphere/temporal`:
