# Governance Policy - simulation/v3_noosphere/temporal
...
This policy governs all work in `simulation/v3_noosphere/temporal` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v3_noosphere/temporal/.governance/incidents/`
