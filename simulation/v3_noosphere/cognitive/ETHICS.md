# Ethics and Responsible Use - simulation/v3_noosphere/cognitive
...
**In this directory (`simulation/v3_noosphere/cognitive`), the following ethical rules apply:**
...
Before committing work in `simulation/v3_noosphere/cognitive`:
