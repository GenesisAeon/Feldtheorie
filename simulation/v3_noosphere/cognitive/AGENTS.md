# Agents Charter - simulation/v3_noosphere/cognitive
...
**This directory (`simulation/v3_noosphere/cognitive`) is specialized for:**
...
1. Check the parent governance: `simulation/v3_noosphere/AGENTS.md`
