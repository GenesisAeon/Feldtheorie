# Governance Policy - simulation/v3_noosphere/cognitive
...
2. **Parent Context** (`simulation/v3_noosphere/POLICY.md`)
...
This policy governs all work in `simulation/v3_noosphere/cognitive` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v3_noosphere/cognitive/.governance/incidents/`
