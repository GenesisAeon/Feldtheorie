# Ethics and Responsible Use - simulation/v3_noosphere
...
**In this directory (`simulation/v3_noosphere`), the following ethical rules apply:**
...
Before committing work in `simulation/v3_noosphere`:
