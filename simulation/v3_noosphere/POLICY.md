# Governance Policy - simulation/v3_noosphere
...
This policy governs all work in `simulation/v3_noosphere` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v3_noosphere/.governance/incidents/`
