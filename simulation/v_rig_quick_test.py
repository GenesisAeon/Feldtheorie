...
from simulation.v_rig_renderer import N_OPTIMAL, VRigRealityRenderer, plot_coherence_scan
...
N_coarse, coherence_coarse = renderer.scan_window_sizes(
    N_range=(10, 300), n_slices=n_slices, step=10
)
...
print(
    f"Deviation:              {abs(N_peak - N_OPTIMAL):.2f} "
...
plot_coherence_scan(N_coarse, coherence_coarse, save_path="results/v_rig_quick_test.png")

print("\nQuick test complete! ✓")
print("Results saved to results/v_rig_quick_test.png")
