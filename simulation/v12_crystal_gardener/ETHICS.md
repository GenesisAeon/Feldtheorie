# Ethics and Responsible Use - simulation/v12_crystal_gardener
...
**In this directory (`simulation/v12_crystal_gardener`), the following ethical rules apply:**
...
Before committing work in `simulation/v12_crystal_gardener`:
