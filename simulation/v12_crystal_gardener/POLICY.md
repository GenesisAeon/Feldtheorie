# Governance Policy - simulation/v12_crystal_gardener
...
2. **Parent Context** (`simulation/POLICY.md`)
...
This policy governs all work in `simulation/v12_crystal_gardener` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v12_crystal_gardener/.governance/incidents/`
