# Agents Charter - simulation/v12_crystal_gardener
...
**This directory (`simulation/v12_crystal_gardener`) is specialized for:**
...
1. Check the parent governance: `simulation/AGENTS.md`
