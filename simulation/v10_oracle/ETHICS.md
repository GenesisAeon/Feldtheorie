# Ethics and Responsible Use - simulation/v10_oracle
...
**In this directory (`simulation/v10_oracle`), the following ethical rules apply:**
...
Before committing work in `simulation/v10_oracle`:
