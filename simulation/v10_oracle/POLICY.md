# Governance Policy - simulation/v10_oracle
...
This policy governs all work in `simulation/v10_oracle` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v10_oracle/.governance/incidents/`
