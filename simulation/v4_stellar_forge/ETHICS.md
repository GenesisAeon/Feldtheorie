# Ethics and Responsible Use - simulation/v4_stellar_forge
...
**In this directory (`simulation/v4_stellar_forge`), the following ethical rules apply:**
...
Before committing work in `simulation/v4_stellar_forge`:
