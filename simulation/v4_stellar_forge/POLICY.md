# Governance Policy - simulation/v4_stellar_forge
...
This policy governs all work in `simulation/v4_stellar_forge` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v4_stellar_forge/.governance/incidents/`
