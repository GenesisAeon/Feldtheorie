# Governance Policy - simulation/v4_cosmos
...
This policy governs all work in `simulation/v4_cosmos` and its subdirectories.
...
1. **Document**: Create incident report in `simulation/v4_cosmos/.governance/incidents/`
