# Ethics and Responsible Use - simulation/v4_cosmos
...
**In this directory (`simulation/v4_cosmos`), the following ethical rules apply:**
...
Before committing work in `simulation/v4_cosmos`:
